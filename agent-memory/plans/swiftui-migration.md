...
|-----------|---------|:-----:|:-------:|---------|
| Sidebar session list | HarnessSidebarPanelVC | ~72KB | ★★★★ | ✅ ทำแล้ววันนี้ |
| Settings panel | SettingsViewController | ~40KB | ★★★ | ลด 60% code |
...
| 2 | Settings panel → SwiftUI Form | 3-4hr | High (40KB ลดเหลือ 10KB) |
| 3 | Command palette → SwiftUI | 2-3hr | Medium |
| 4 | Notifications inbox → SwiftUI | 1-2hr | Medium |
| 5 | Agent notch → SwiftUI | 1-2hr | Low |
| 6 | Terminal tab bar → SwiftUI pills | 3-4hr | Medium (RL-040 area) |
| 7 | Browser tab bar → SwiftUI | 2-3hr | Low |

## Definition of Done

- [ ] All Phase 1 components migrated to SwiftUI
...
- [ ] HarnessSidebarPanelVC reduced from 72KB to < 30KB
- [ ] SettingsViewController eliminated (replaced by SwiftUI Form)
