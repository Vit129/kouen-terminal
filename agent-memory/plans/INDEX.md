...
| File | Title | Status |
|------|-------|--------|
| [p37-phase-g-autocomplete/dev-task-progress.md](p37-phase-g-autocomplete/dev-task-progress.md) | P37 Phase G — Autocomplete (@ file-path, shell completion strip, AI suggestion via `claude` CLI) | Tasks planned, 0/12 built |
