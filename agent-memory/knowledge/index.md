...
|------|--------|------|-----------|---------|
| appkit-metal.md | AppKit/Metal | CADisplayLink, zPosition, overlay, lifecycle | 3/0 | Metal surface lifecycle fixes and overlay compositing workarounds |
...
|-----------|---------------------|
| appkit-metal.md | `HarnessTerminalKit/HarnessTerminalSurfaceView.swift`, `HarnessApp/UI/PaneSplitButtonsView.swift` |
