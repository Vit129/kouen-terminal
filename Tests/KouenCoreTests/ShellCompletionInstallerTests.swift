...
final class ShellCompletionInstallerTests: XCTestCase {
    private func makeHome() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("kouen-comp-\(UUID().uuidString)", isDirectory: true)
    ...
    func testZshWiresRcWithGuardedSourceBlock() throws {
        ...
        XCTAssertTrue(rc.contains("Kouen CLI completions"), "guarded marker block present")
    ...
    func testReinstallIsIdempotentNoDuplicateBlock() throws {
        ...
        let rc = read(home.appendingPathComponent(".zshrc"))
        let occurrences = rc.components(separatedBy: "# >>> Kouen CLI completions >>>").count - 1
    ...
    func testInstallForLoginShellZshWiresRcAndDropsFish() throws {
        ...
        XCTAssertTrue(read(home.appendingPathComponent(".zshrc")).contains("Kouen CLI completions"))
