...
final class SessionPersistenceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        // Isolate KOUEN_HOME so the disk-backed `SessionStore.load()` test never touches real
        ...
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("kouen-session-store-\(UUID().uuidString)", isDirectory: true)
