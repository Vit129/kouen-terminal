...
final class CommandParserTests: XCTestCase {
    ...
    func testRespawnPaneAcceptsBothClearHistoryForms() throws {
        // `-k` is the tmux-style grammar flag; `--clear-history` is the kouen-cli long
    ...
    func testSetOptionParsesScopesAndJoinsValue() throws {
        ...
        // tmux setw = window option = Kouen tab scope.
        XCTAssertEqual(
    ...
    /// tmux's table name for the vi copy-mode table is `copy-mode-vi`; Kouen's is
