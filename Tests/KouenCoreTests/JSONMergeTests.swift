...
final class JSONMergeTests: XCTestCase {
    ...
    func testMergesNestedHookEventsWithoutDroppingExistingEntries() {
        ...
        let kouenEntry: [String: Any] = ["matcher": "*", "hooks": [["type": "command", "command": "kouen-cli notify"]]]
        let addition: [String: Any] = ["hooks": ["Notification": [kouenEntry], "Stop": [kouenEntry]]]
    ...
    func testIsIdempotent() {
        let existing: [String: Any] = ["hooks": ["Stop": [["type": "command", "command": "kouen-cli notify"]]]]
