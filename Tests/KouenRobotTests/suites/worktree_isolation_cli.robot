...
...    and isolation guarantees using only kouen-cli + git commands.
Library          Process
...
*** Variables ***
${REPO_DIR}       /tmp/kouen-cli-wt-test
${CLI}            /Users/supavit.cho/Git/Personal/kouen-terminal/.build/arm64-apple-macosx/debug/kouen-cli
${WS}             Default
