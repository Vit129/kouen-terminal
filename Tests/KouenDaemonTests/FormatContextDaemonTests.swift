...
/// `currentCommand` commit. Runs against an isolated `KOUEN_HOME` like `SurfaceRegistryTests`.
final class FormatContextDaemonTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("kouen-fmtctx-\(UUID().uuidString)", isDirectory: true)
