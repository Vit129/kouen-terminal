...
final class RealPtyLifecycleTests: XCTestCase {
    ...
    func testProbeReportsShellCwdNotForegroundChild() throws {
        ...
        let dirA = base.appendingPathComponent("kouen-shell-\(UUID().uuidString)")
        let dirB = base.appendingPathComponent("kouen-child-\(UUID().uuidString)")
