...
/// Right-click block menu (`appendBlockMenuItems`, `HarnessTerminalSurfaceView+Find.swift`) —
...
final class BlockContextMenuTests: XCTestCase {
    ...
    @MainActor
    private func makeView() -> HarnessTerminalSurfaceView {
        ...
        HarnessTerminalSurfaceView(offMainParserFramePipeline: false)
    }
