...
/// A concise overview of what Kouen does before setup begins.
    ...
    var body: some View {
        VStack(spacing: 24) {
            StepIntro(
                ...
                bodyText: "Kouen gives your shells, tabs, panes, and coding agents one command layer — and you can reach it from anywhere."
            )
