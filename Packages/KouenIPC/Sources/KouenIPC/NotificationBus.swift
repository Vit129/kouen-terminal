...
public final class NotificationBus: @unchecked Sendable {
    ...
    public let notificationPosted = Notification.Name("KouenNotificationPosted")
    public let tabStatusChanged = Notification.Name("KouenTabStatusChanged")
    public let snapshotChanged = Notification.Name("KouenSnapshotChanged")
    public let configReloaded = Notification.Name("KouenConfigReloaded")
    public let sendKeysRequested = Notification.Name("KouenSendKeysRequested")
    public let copyModeRequested = Notification.Name("KouenCopyModeRequested")
    public let captureRequested = Notification.Name("KouenCaptureRequested")
    ...
    public let mcpActivity = Notification.Name("KouenMCPActivity")
    /// Posted when an agent's activity state changes (idle↔working↔awaiting).
    /// Used by BoardViewController for live card movement and ScriptRuntime for kouen.events.
    public let agentStateChanged = Notification.Name("KouenAgentStateChanged")
    ...
    /// Posted after a script config file is (re)loaded, so `kouen.events.on("configReloaded", ...)`
