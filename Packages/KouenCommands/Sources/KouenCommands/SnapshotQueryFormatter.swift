...
/// Machine-readable rows behind `kouen-cli list-sessions/list-windows/list-panes --json`.
...
/// the parallel `--json` rows. Shared by `kouen-cli`'s `list-sessions`/`list-windows`/
