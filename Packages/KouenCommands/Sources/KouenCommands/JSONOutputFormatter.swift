...
/// The single encoder behind every `kouen-cli … --json` command, so the machine-readable
...
/// KouenCore (not the CLI) means the CLI shim stays thin and the JSON shape is unit-testable.
