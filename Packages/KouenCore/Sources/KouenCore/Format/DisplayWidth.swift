...
///
/// KouenCore deliberately doesn't link the terminal engine, so it can't reach the engine's full
/// generated East-Asian-width table across the package boundary. This is a conservative copy of
/// the ranges that matter for the two KouenCore call sites that measure columns: status-format
