...
/// Cross-platform process-tree primitives shared by the agent scanner (KouenCore) and the PTY
/// layer (KouenDaemonCore). Darwin uses libproc (`proc_listpids`/`proc_pidinfo`); Linux reads
