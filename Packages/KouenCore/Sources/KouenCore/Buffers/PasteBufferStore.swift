...
/// survive `Kouen.app` quitting and so all attached clients see the same
...
public final class PasteBufferStore: @unchecked Sendable {
    ...
    public init(url: URL = KouenPaths.buffersURL, configuration: Configuration = Configuration()) {
        self.url = url
