...
public final class DaemonClient: @unchecked Sendable {
    private let queue = DispatchQueue(label: "com.vit129.kouen.daemon-client")
...
public final class DaemonSubscription: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.vit129.kouen.daemon-subscription")
...
public enum DaemonClientError: Error, CustomStringConvertible {
    ...
    public var description: String {
        switch self {
        case .connectionFailed: "Could not connect to KouenDaemon"
        case .writeFailed: "Failed to write IPC request"
        case .timeout: "KouenDaemon request timed out"
