...
public struct KouenThemeDefinition: Equatable, Sendable, Codable {
...
/// all valid 6-digit hexes, exercised by `KouenThemeCatalogTests`.
extension KouenThemeDefinition {
    static func make(
        _ name: String,
        bg: String,
        fg: String,
