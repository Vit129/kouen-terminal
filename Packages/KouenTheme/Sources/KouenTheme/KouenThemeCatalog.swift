...
public enum KouenThemeCatalog {
    ...
    public static let defaultThemeName = "Kouen Default"
    ...
    public static func theme(named name: String) -> KouenThemeDefinition? {
    ...
    public static func search(_ query: String) -> [KouenThemeDefinition] {
    ...
    /// alphabetically.
    public static var allThemes: [KouenThemeDefinition] { all }
    ...
    private static let all: [KouenThemeDefinition] = {
    ...
    /// `BundledThemesData` (an array of `KouenThemeDefinition`). The data is compiled
    ...
    private static func loadBundledThemes() -> [KouenThemeDefinition] {
        guard
            let data = Data(base64Encoded: BundledThemesData.base64JSON),
            let themes = try? JSONDecoder().decode([KouenThemeDefinition].self, from: data)
        else { return [] }
        return themes
    }

    private static let builtins: [KouenThemeDefinition] = [
        .make(
            "Kouen Default",
