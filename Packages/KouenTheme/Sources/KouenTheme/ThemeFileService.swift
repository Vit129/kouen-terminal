...
/// Reads and writes `.kouentheme` files — the disk layer behind theme export, import,
...
public struct ThemeFileService {
    ...
    /// Read and validate a theme document from a `.kouentheme` file.
    ...
    /// A filesystem-safe `<name>.kouentheme` filename. Path-hostile characters are
