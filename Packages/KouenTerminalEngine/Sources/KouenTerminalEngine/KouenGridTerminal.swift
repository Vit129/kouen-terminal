...
/// is Kouen's native grid terminal and powers the
/// `kouen attach` compositor. It deliberately mirrors that type's shape
...
public final class KouenGridTerminal {
    ...
    /// `kouenGetLastBlock` MCP tool reads.
