...
final class HistoryRowView: NSTableRowView {
    override func drawSelection(in dirtyRect: NSRect) {
        ...
        let rect = bounds.insetBy(dx: HarnessDesign.Spacing.md, dy: 2)
...
private final class HistoryItemView: NSView {
    init(command: String, query: String) {
        ...
        NSLayoutConstraint.activate([
            icon.leadingAnchor.constraint(equalTo: leadingAnchor, constant: HarnessDesign.Spacing.xl),
            icon.centerYAnchor.constraint(equalTo: centerYAnchor),
            icon.widthAnchor.constraint(equalToConstant: 14),

            title.leadingAnchor.constraint(equalTo: icon.trailingAnchor, constant: HarnessDesign.Spacing.md),
            title.centerYAnchor.constraint(equalTo: centerYAnchor),
            title.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -HarnessDesign.Spacing.xl),
        ])
    }
