        ...
        Section("Window") {
            SliderRow(
                ...
                value: Binding(
                    ...
                    set: { model.update(\.backgroundOpacity, HarnessSettings.clampedOpacity(Float($0))) }
                ),
                range: 0...1,
                format: "%"
            )
            ...
            HStack {
                ...
                TextField("X", value: Binding(
                    ...
                    set: { model.update(\.windowPaddingX, HarnessSettings.clampedPadding($0)) }
                ), format: .number)
                .frame(width: 55)
                ...
                TextField("Y", value: Binding(
                    ...
                    set: { model.update(\.windowPaddingY, HarnessSettings.clampedPadding($0)) }
                ), format: .number)
                .frame(width: 55)
                .multilineTextAlignment(.trailing)
                Text("pt")
