...
struct KouenChromePalette {
    ...
    static let fallback = KouenChromePalette.from(
    ...
    static func from(backgroundHex: String, foregroundHex: String, cursorHex: String? = nil, opacity: CGFloat = 1) -> KouenChromePalette {
...
@MainActor
enum KouenChrome {
    private(set) static var current: KouenChromePalette = .fallback
    ...
    static func update(
        ...
        current = KouenChromePalette.from(
