...
10. `KouenPaths` - bridges 42 areas (100 edges)
...
## Communities (3365 total, 2469 thin omitted)

### Community 0 - "CodingKey"
Cohesion: 0.08
Nodes (15): Command, PanePipe, Bool, Data, FileHandle, Int32, SessionID, String (+7 more)
...
Cohesion: 0.07
Nodes (26): colors, ANSIPalette, CellColorResolver, MochaTheme, ResolvedCellColors, RGBColor, Bool, Double (+18 more)
...
Cohesion: 0.11
Nodes (24): DaemonSubscription, Bool, Data, Int32, String, TimeInterval, UInt16, UInt64 (+16 more)

### Community 19 - "SpecialKey"
Cohesion: 0.08
Nodes (31): RGBColor, String, UInt64, SelectionResolver, String, TerminalEmulator, BlockSelection, CursorRender (+23 more)

### Community 21 - "HarnessTerminalSurfaceView"
Cohesion: 0.10
Nodes (15): KouenTerminalSurfaceView, Any, Bool, CGFloat, NSEvent, NSMenu, NSMenuItem, NSPasteboard (+7 more)
...
### Community 32 - ".addTab"
Cohesion: 0.12
Nodes (9): KouenTerminalSurfaceView, CGFloat, CGRect, NSEvent, NSPoint, Range, String, TerminalEmulator (+1 more)
...
Cohesion: 0.05
Nodes (23): NSCursor, T, KouenTerminalSurfaceView, PendingMainHop, SurfaceEmulatorState, SurfaceFrameBuildResult, Bool, Data (+15 more)

### Community 46 - ".buildCommand"
Cohesion: 0.06
Nodes (32): Darwin, Glibc, DaemonClientError, connectionFailed, timeout, unexpectedResponse, writeFailed, Endpoint (+24 more)

### Community 47 - ".normalizedKey"
Cohesion: 0.07
Nodes (29): LSPFileSession, Never, String, Task, URL, Void, LSPClient, LSPClientError (+21 more)
...
Cohesion: 0.23
Nodes (8): NWEndpoint, NWListener, ConnectionState, MobileBridgeServer, Data, NWConnection, T, UInt8
...
Cohesion: 0.12
Nodes (19): Equatable, CodingKeys, error, id, jsonrpc, method, params, result (+11 more)
...
Cohesion: 0.14
Nodes (11): SurfaceRegistry, Set, TabID, SurfaceRegistryTests, PaneID, SessionID, SessionSnapshot, String (+3 more)
...
Cohesion: 0.15
Nodes (21): CoreImage, CryptoKit, Decodable, Encodable, AttachedAck, ControlMessage, Cred, DecodedWSFrame (+13 more)
...
Cohesion: 0.14
Nodes (13): CopyOutcome, copied, keptNewerInstalled, skippedIdentical, InstallError, missingBundledTools, InstallReport, ProbeOutputBox (+5 more)
...
Cohesion: 0.12
Nodes (9): KeybindingsService, Bool, Command, String, OptionSet, Modifiers, Decoder, String (+1 more)
...
Cohesion: 0.16
Nodes (11): HunkActionButton, RepoEntry, StageToggleButton, escaping, MainActor, NSCoder, NSRect, Void (+3 more)
...
### Community 133 - ".load"
Cohesion: 0.10
Nodes (8): SessionEditor, SessionID, Phase67Tests, SessionPersistenceTests, Bool, String, TabID, URL
...
Cohesion: 0.12
Nodes (17): Already portable or mostly portable, Build matrix, Competitive Landscape (research 2026-07-04), Current Architecture Fit, First Implementation Slice, Implications for this plan, Integration tests, macOS-specific today (+9 more)
...
### Community 186 - "Error"
Cohesion: 0.11
Nodes (17): atomicWrite(), backupCorruptFile(), fnv1aHex(), KouenPaths, KouenPathsError, socketPathTooLong, Bool, Data (+9 more)
...
Cohesion: 0.10
Nodes (12): ScriptAPI, ScriptError, evaluationError, unsupportedPlatform, ScriptRuntime, Any, String, URL (+4 more)
...
Cohesion: 0.05
Nodes (32): KouenSidebarPanelViewController, CGFloat, NSMenuItem, NSView, SessionGroup, String, KouenSidebarPanelViewController, NSMenu (+24 more)
...
Cohesion: 0.12
Nodes (21): TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid, SurfaceColorProviderState (+13 more)
...
Cohesion: 0.11
Nodes (17): InputGate, ReconnectLatch, SurfaceIO, Bool, CGFloat, Data, FormatColor, KouenSettings (+9 more)
...
Cohesion: 0.23
Nodes (7): BinaryInstaller, Bool, TimeInterval, URL, BinaryInstallerVersionTests, String, URL
...
Cohesion: 0.14
Nodes (9): KouenCore, KouenDaemonCore, DaemonCommandExecutor, BellScanState, esc, normal, stringEsc, SurfaceMonitor (+1 more)
...
Cohesion: 0.18
Nodes (6): PairingBox, PendingPairing, Bool, Date, String, UInt16
...
### Community 277 - ".run"
Cohesion: 0.10
Nodes (12): OverlayBackground, Context, ChromeBackdrop, KouenDesign, KouenOverlayBackground, RuntimeGlassEffectView, Bool, CGRect (+4 more)
...
Cohesion: 0.08
Nodes (16): LSPTextLocation, LSPTextLocationParser, String, URL, LSPTextLocationParserTests, KouenCLITests, URL, KouenCLI (+8 more)
...
Cohesion: 0.14
Nodes (7): DecodedImage, UInt8, ITerm2InlineImage, Bool, String, UInt8, FrameImage
...
Cohesion: 0.23
Nodes (7): BrowserPaneRegistry, NSWindow, PaneID, WKWebView, WeakBrowserPaneView, WeakScriptMessageHandler, WKScriptMessageHandler
...
Cohesion: 0.11
Nodes (17): RealPty, ScrollbackEntry, ScrollbackReplaySegment, ShellLaunchProfile, CChar, DaemonSurfaceID, Data, Int32 (+9 more)
...
Cohesion: 0.10
Nodes (26): AppKit, CoreGraphics, CoreText, ImageIO, KouenCopyMode, KouenTerminalEngine, KouenTerminalRenderer, KouenTheme (+18 more)
...
Cohesion: 0.13
Nodes (13): Identifiable, DiscoverStepView, Point, String, OnboardingStep, complete, discover, setup (+5 more)
...
Cohesion: 0.14
Nodes (6): Bool, Double, String, TerminalRecordingCodec, TerminalReplay, TerminalRecordingTests
...
### Community 402 - "View"
Cohesion: 0.09
Nodes (33): Color, Configuration, TabBarIconButtonStyle, TabBarInlineIconButtonStyle, ButtonStyle, CommandRow, GlassCard, GlassPrimaryButtonStyle (+25 more)
...
### Community 418 - ".build"
Cohesion: 0.30
Nodes (4): NSCoder, PaneID, PaneNode, SplitDirection
...
Cohesion: 0.08
Nodes (13): String, WorkbenchMRU, Foundation, object, KouenSettings, Bool, Data, KouenCLI (+5 more)
...
Cohesion: 0.12
Nodes (5): FormatContextBuilder, DaemonSurfaceID, SessionSnapshot, String, SessionEditorTests
...
Cohesion: 0.11
Nodes (9): EndpointClientTests, String, URL, GroupedSessionDaemonTests, SessionGroup, String, URL, ShellLaunchProfileTests (+1 more)
...
Cohesion: 0.12
Nodes (12): PaneContainerView, SessionSnapshot, SurfaceID, PaneLifecycleManager, Bool, NSView, PaneID, PaneNode (+4 more)
...
Cohesion: 0.12
Nodes (12): NSRangePointer, NSTextInputClient, KouenTerminalSurfaceView, Any, Bool, NSAttributedString, NSEvent, NSPoint (+4 more)
...
Cohesion: 0.09
Nodes (21): Error, InstallError, unsupported, DaemonError, alreadyRunning, bindFailed, listenFailed, socketFailed (+13 more)
...
## Knowledge Gaps
- **3746 isolated node(s):** `unsupportedPlatform`, `unmodified`, `modified`, `added`, `deleted` (+3741 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2469 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `MetalRendererTests` to `CodingKey`, `callingPaneTarget`, `.handleNormal`, `Changelog Archive`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `Command`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `VTParser`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `HarnessUILibrary`, `.text`, `HarnessChrome`, `HarnessTerminalSurfaceView`, `CopyModeAction`, `SpecialKey`, `.request`, `WorktreeManager`, `SessionGroupHeaderRowView`, `RGBColor`, `.parse`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `LegacySnapshot`, `Task Ledger Archive (Tasks 1–50)`, `TerminalColorGamut`, `harness.resource`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `CodingKeys`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `.normalizedKey`, `DaemonServer`, `.keyEvent`, `HarnessSplitView`, `TerminalTabBarView.swift`, `newWindow`, `BellScanState`, `CommandHistorySearchController`, `PasteBufferStore`, `ViEngine`, `FrecencyDirectoryStore`, `ComposedCell`, `HarnessCLI+Server.swift`, `.text`, `PrefixKeymap`, `TerminalProgressReport`, `String`, `worktree_isolation_cli.robot`, `XCTestCase`, `.statusLineSet`, `OptionStore`, `.parse`, `Endpoint`, `HarnessDesign`, `selectWorkspace`, `LSPClient`, `TerminalGridCell`, `HarnessPaths`, `HarnessTerminalSurfaceView`, `Zombie View Crashes on macOS 26.5 + Swift 6.3.2`, `TerminalModes`, `MenuBarController`, `AttachInputBatcher`, `shim.c`, `.dispatch`, `ScriptRuntime.swift`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `AgentNotchViewModel`, `NSView`, `DamageTrackingTests`, `[1.3.0-vit] - 2026-06-06`, `SoftIconButton`, `[2.5.0] - 2026-06-12`, `.makeSnapshot`, `NotificationCoordinator`, `.firstWaitingTab`, `SessionGroup`, `graphify reference: query, path, explain`, `WorkspaceFileTreeView`, `.encode`, `String`, `HistoryRingBuffer`, `.path`, `GlyphAtlas`, `SwiftUI`, `.install`, `AgentHookInstaller`, `.load`, `CommandTarget`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `[3.11.0] - 2026-06-28`, `CopyModeGridSource`, `AsciiFastPathTests`, `DecodedImage`, `HarnessDaemonToolsTests`, `.evaluate`, `PathToken`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `What You Must Do When Invoked`, `[3.9.1] - 2026-06-22`, `MatchCategory`, `ColorKind`, `TerminalFindBar`, `CommandPromptController`, `ActiveTabCloseDisposition`, `LiveSession`, `URLDetection`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `.rects`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `.testOptionLinesAreNotCommands`, `VTConformanceCorpusTests`, `GridCompositorTests`, `LSPServerRegistry`, `generate-release-notes.swift`, `SessionSnapshot`, `Error`, `AppDelegate`, `Modifiers`, `BrowserPaneView`, `ScriptRuntime`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `ResizeHUDView`, `AgentSessionSummary`, `.classify`, `HarnessBrowserTools`, `ReplayStep`, `[3.9.5] - 2026-06-26`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `SettingsRemoteView`, `PaneTarget`, `.translate`, `NotchLayoutMetrics`, `CellColorResolverTests`, `AgentNotchRowSummary`, `ANSIPalette`, `graphify reference: add a URL and watch a folder`, `HarnessPathDisplay`, `FileChangeWatcher`, `CellColorResolver`, `ExternalOpenKind`, `WorkbenchCommand`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `ReflowPreviewTests`, `HarnessTerminalSurfaceWorkerTests`, `SessionCoordinator`, `NSViewRepresentable`, `Split Right`, `BoardViewController`, `release-hotfix.sh`, `workspace`, `Sidebar SwiftUI Migration — Knowledge`, `listSurfaces`, `ThemeFileServiceTests`, `.welcome`, `HarnessSidebarPanelViewController`, `.userNotificationCenter`, `.path`, `.performInstall`, `[2.2.4] - 2026-06-11`, `[3.11.2] - 2026-06-28`, `DefaultTerminalManager`, `StatusLineView.swift`, `SGRMouseEvent`, `WindowSession`, `[2.5.0] - 2026-06-12`, `renumberWindows`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `.rememberTabForReopen`, `FormatColor`, `click_ui_element`, `AgentHookStrategy`, `StatusLineWidthTests`, `Process`, `JSONDecoder`, `Fixes Applied (layered)`, `NotificationBus`, `settings.json`, `HarnessPaths.swift`, `.parse`, `.scrollWheel`, `ViPathTokenTests`, `Send Ex Command`, `Bug: Tab-Switch Black Screen`, `Terminal AI Chat (⌘I inline overlay)`, `UInt64`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `.theme`, `ImmersivePalette.swift`, `.recordReapedGenerationForTesting`, `RealPty`, `CommandExecutionError`, `Foundation`, `Background Polling & Snapshot Fanout — P22`, `.deepMerge`, `[3.5.1] - 2026-06-20`, `OcclusionTests`, `projectGroupRootPath`, `[2.2.4] - 2026-06-11`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `Identifiable`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `HarnessCLITests`, `UI Automation — Robot Framework (P18)`, `AppKit + Metal Patterns`, `AgentIconRenderer`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `HintModeOverlay`, `SixelDecoder`, `.parseDiffHunks`, `PathToken`, `Project History`, `.highlight`, `SessionEditor`, `main.swift`, `.run`, `PaneLabelDaemonTests`, `MouseButton`, `HarnessOnboarding`, `ScrollbackTests`, `Command Prompt Architecture`, `printThemePreview`, `requireSessionID`, `resolvedCLIPath`, `ACP Client (Shelved)`, `KittyGraphicsCommand`?**
  _High betweenness centrality (0.295) - this node is a cross-community bridge._
- **Why does `KouenCore` connect `WindowTitleStripView` to `callingPaneTarget`, `.handleNormal`, `EngineConformanceTests`, `AgentNotchRootView`, `Command`, `KouenIPC`, `.capsLockRootFallback`, `TerminalEmulator`, `KittyKeyboardTests`, `.applyPreedit`, `HarnessUILibrary`, `SpecialKey`, `CopyModeAction`, `.request`, `SessionGroupHeaderRowView`, `SemanticPromptTests`, `Task Ledger Archive (Tasks 1–50)`, `Equatable`, `LegacySnapshot`, `NSObject`, `MenuTarget`, `String`, `TerminalColorGamut`, `[3.12.0] - 2026-06-30`, `CodingKeys`, `HarnessSettings`, `HarnessOverlayBackground`, `Harness Robot Framework Tests`, `ThemeCatalogEmbedTests`, `.normalizedKey`, `HookEvent`, `DaemonServer`, `.buildCommand`, `.keyEvent`, `ScrollbackPersistenceTests`, `HarnessSplitView`, `TerminalTabBarView.swift`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `ComposedCell`, `CLAUDE.md`, `.text`, `HarnessCLI+Server.swift`, `TerminalProgressReport`, `ShellIntegration`, `.compose`, `FileTreeKeyboardNavigator`, `XCTestCase`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `SessionCoordinator`, `MenuBarController`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `ScriptRuntime.swift`, `MainSplitViewController`, `AgentNotchViewModel`, `.resolve`, `ViEngine`, `NSView`, `SoftIconButton`, `DamageTrackingTests`, `.encode`, `SessionGroup`, `PaneNode`, `clearSelection`, `ViEngine`, `Pipe`, `.install`, `.load`, `[3.10.1] - 2026-06-27`, `CommandTarget`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `[3.11.0] - 2026-06-28`, `.testPaneLeafLegacyDecodeBackfillsSurfaceTabs`, `CopyModeGridSource`, `PaneStyleSet`, `FileTreeWatcher`, `EnvironmentStore`, `HarnessDaemonToolsTests`, `PathToken`, `ThaiCombiningMarkTests`, `.recordReapedGenerationForTesting`, `sessionCreated`, `TerminalFindBar`, `Workspace`, `LiveSession`, `ReflowCorpusTests`, `.decodeKeySpec`, `BoardCard`, `RGBColorTests`, `.handleAgent`, `InlineAICompletionView`, `Phase6KeysTests`, `GridCompositorTests`, `AppDelegate`, `Modifiers`, `ScriptRuntime`, `[2.3.0] - 2026-06-11`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `ResizeHUDView`, `[2.5.1] - 2026-06-12`, `BinaryInstaller`, `MainWindowController`, `.classify`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `CopyModeState`, `HarnessCLI`, `scheduleRender`, `[2.4.0] - 2026-06-12`, `SettingsRemoteView`, `PaneDropZoneOverlay`, `CellColorResolverTests`, `GridCompositor`, `ScrollbackFile`, `Section`, `TerminalServicesProvider`, `AgentNotchRowSummary`, `ANSIPalette`, `HarnessPathDisplay`, `SSHTunnelManagerTests`, `sessionRow`, `graphify reference: incremental update and cluster-only`, `TextGrid`, `.scan`, `WorkbenchCommand`, `.make`, `AgentBridge`, `.make`, `FileNode`, `.renderFixture`, `ReflowPreviewTests`, `[3.4.0] - 2026-06-19`, `HarnessTerminalSurfaceWorkerTests`, `BoardViewController`, `Sidebar SwiftUI Migration — Knowledge`, `Browser Pane (P14)`, `.install`, `StatusLineView.swift`, `SGRMouseEvent`, `KeySpec`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `reorderSession`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `CLICommand`, `click_ui_element`, `.apply`, `.load`, `jobs`, `.encodeMouse`, `RegressionBugFixTests`, `Send Ex Command`, `.selectedText`, `FormatColor`, `.theme`, `RealPty`, `ImageProtocolTests.swift`, `CommandExecutionError`, `CSIParams`, `Foundation`, `DaemonLifecycleTests`, `Background Polling & Snapshot Fanout — P22`, `Architecture Decisions — harness-terminal`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.deepMerge`, `.handleCat`, `[3.5.1] - 2026-06-20`, `State`, `FormatStyledSegment.swift`, `RGBColor`, `Consumers`, `Git Panel`, `.encode`, `DynamicInstanceBuffer`, `ThaiClusterRenderTests`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `Darwin`, `UI Automation — Robot Framework (P18)`, `View`, `themes.json`, `IPC Architecture`, `go.json`, `rust.json`, `HintModeOverlay`, `.delay`, `.highlight`, `SessionEditor`, `RawRepresentable`, `BlockContextMenuTests`, `Section`, `MCPServer`, `.update`, `.normalizedKey`, `ReflowFastPathTests`, `HarnessOnboarding`, `.json`, `Fixed`, `graphify reference: extra exports and benchmark`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Foundation` connect `.highlight` to `Changelog Archive`, `callingPaneTarget`, `ThemeDocument`, `IPCRequest`, `KouenIPC`, `Command`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `.capsLockRootFallback`, `VTParser`, `.applyPreedit`, `MetalRendererTests`, `HarnessChrome`, `SpecialKey`, `CopyModeAction`, `.request`, `RGBColor`, `SemanticPromptTests`, `Sendable`, `Task Ledger Archive (Tasks 1–50)`, `MenuTarget`, `TerminalColorGamut`, `[3.12.0] - 2026-06-30`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `Harness Robot Framework Tests`, `ThemeCatalogEmbedTests`, `.buildCommand`, `HookEvent`, `.normalizedKey`, `markPane`, `.keyEvent`, `TerminalTabBarView.swift`, `BellScanState`, `PasteBufferStore`, `FrecencyDirectoryStore`, `ComposedCell`, `HarnessCLI+Server.swift`, `.text`, `ShellIntegration`, `.compose`, `FileTreeKeyboardNavigator`, `.detect`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `DaemonSubscription`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `SessionCoordinator`, `AttachInputBatcher`, `.dispatch`, `ScriptRuntime.swift`, `DaemonLauncher`, `AnyCodable`, `Recipe`, `Changelog`, `AgentNotchViewModel`, `.resolve`, `ViEngine`, `NSView`, `DamageTrackingTests`, `.makeSnapshot`, `HarnessGridTerminal`, `.firstWaitingTab`, `ActiveTabCloseDisposition`, `SessionGroup`, `PaneNode`, `[3.0.0] - 2026-06-15`, `.encode`, `Pipe`, `ClientSummary`, `HistoryRingBuffer`, `AgentHookInstaller`, `graphify reference: query, path, explain`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `TerminalHostView`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `FileTreeWatcher`, `EnvironmentStore`, `HarnessDaemonToolsTests`, `.evaluate`, `LiveResizeTests`, `Int`, `.recordReapedGenerationForTesting`, `[3.9.1] - 2026-06-22`, `AgentKind`, `AmbientBackground`, `MatchCategory`, `Workspace`, `CommandPromptController`, `[2.1.0] - 2026-06-07`, `LiveSession`, `AgentTableEntry`, `.decodeKeySpec`, `.hold`, `.handleAgent`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `TerminalScreen`, `Error`, `Modifiers`, `BrowserPaneView`, `ScriptRuntime`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `HarnessBrowserTools`, `TerminalProgressReport`, `ReplayStep`, `grok`, `[2.4.0] - 2026-06-12`, `.testDataFrameEncodeVsJSONBase64Output`, `SettingsRemoteView`, `PaneDropZoneOverlay`, `PaneTarget`, `.translate`, `NotchLayoutMetrics`, `CellColorResolverTests`, `GridCompositor`, `Section`, `TerminalServicesProvider`, `AgentNotchRowSummary`, `ReplayStep`, `ANSIPalette`, `HarnessPathDisplay`, `CellColorResolver`, `SSHTunnelManagerTests`, `sessionRow`, `.decide`, `HarnessGridTerminalTests`, `ExternalOpenKind`, `graphify reference: incremental update and cluster-only`, `.scan`, `.copySelection`, `TerminalMetalRenderer`, `PaneBorderStatus`, `.make`, `AgentBridge`, `FileNode`, `ThemeDocumentTests`, `.renderFixture`, `Split Right`, `BundledThemesData.swift`, `Sidebar SwiftUI Migration — Knowledge`, `WindowTitleStripView`, `Browser Pane (P14)`, `.install`, `SGRMouseEvent`, `[2.5.0] - 2026-06-12`, `reorderSession`, `DisplayPanesOverlay`, `FormatColor`, `click_ui_element`, `JSONDecoder`, `Fixes Applied (layered)`, `.load`, `settings.json`, `jobs`, `HarnessPaths.swift`, `.parse`, `.script`, `.selectedText`, `Bug: Tab-Switch Black Screen`, `.unmarkText`, `FormatColor`, `Focus Persistence — Per-Session-Tab Pane Focus (RL-043)`, `UInt64`, `DesktopNotifier`, `FloatingPaneController`, `.theme`, `.reopenClosedTab`, `.recordReapedGenerationForTesting`, `RealPty`, `ImageProtocolTests.swift`, `.makeModel`, `Foundation`, `FileViewerViewController`, `[3.2.0] - 2026-06-16`, `Background Polling & Snapshot Fanout — P22`, `Architecture Decisions — harness-terminal`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.deepMerge`, `SurfaceProgressTracker`, `[3.5.1] - 2026-06-20`, `State`, `[2.2.4] - 2026-06-11`, `.encode`, `.run`, `MCPServer`, `ThaiClusterRenderTests`, `User Profile`, `Darwin`, `UI Automation — Robot Framework (P18)`, `AppKit + Metal Patterns`, `themes.json`, `Split Panes (NSSplitView)`, `javascript.json`, `json.json`, `HintModeOverlay`, `SixelDecoder`, `Bug — Cmd+\ sidebar toggle gone after collapse`, `Competitive Position (as of v3.12.0, 2026-07-02)`, `PathToken`, `SessionEditor`, `RawRepresentable`, `BlockContextMenuTests`, `MCPServer`, `.normalizedKey`, `.encode`, `PaneLabelDaemonTests`, `ReflowFastPathTests`, `.evaluateStyled`, `HarnessOnboarding`, `.steps`, `Service Decomposition — SessionCoordinator (P17)`, `generate-release-notes.swift`, `Fixed`, `.locate`?**
