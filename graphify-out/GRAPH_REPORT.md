...
## Corpus Check
- 803 files · ~834,627 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15358 nodes · 34531 edges · 3356 communities (960 shown, 2396 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 3834 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6c14a8a7`
...
9. `AgentKind` - bridges 49 areas (97 edges)
10. `SurfaceRegistry` - bridges 48 areas (182 edges)
...
## Communities (3356 total, 2396 thin omitted)
...
Cohesion: 0.05
Nodes (33): CGImage, ImageIO, DisplayWidth, String, Unicode, Run, Data, ReleaseNotes (+25 more)
...
Cohesion: 0.25
Nodes (7): DaemonRoundTripTests, Data, String, TimeInterval, OutputAccumulator, Bool, String
...
Cohesion: 0.12
Nodes (9): SessionCoordinator, Bool, Double, PaneNode, SessionID, SplitDirection, String, TabID (+1 more)
...
Cohesion: 0.12
Nodes (6): Command, SessionEditorPhase4Tests, PaneID, TabID, WorkspaceID, SessionEditorTests
...
Cohesion: 0.14
Nodes (10): DaemonSurfaceID, URL, ScrollbackFile, Bool, Data, DispatchWorkItem, URL, ScrollbackFileTests (+2 more)

### Community 18 - "HarnessUILibrary"
Cohesion: 0.12
Nodes (23): DaemonSubscription, Bool, Data, Int32, TimeInterval, UInt64, Void, UnsafeMutableRawPointer (+15 more)
...
Cohesion: 0.12
Nodes (17): OptionStore, OptionStore.Value, Scope, global, pane, session, tab, workspace (+9 more)
...
Cohesion: 0.09
Nodes (16): IndexingIterator, LayoutTemplate, SessionEditor, Bool, Date, Double, PaneID, PaneLeaf (+8 more)
...
Cohesion: 0.07
Nodes (37): TerminalEmulator, RawSelection, SelectionResolver, Bool, KouenTerminalSurfaceView, String, TerminalEmulator, BlockSelection (+29 more)
...
Cohesion: 0.07
Nodes (26): Darwin, Glibc, Endpoint, EndpointError, connectionFailed, notYetSupported, pathTooLong, String (+18 more)
...
Cohesion: 0.17
Nodes (11): LSPFileSession, Never, String, Task, URL, Void, LSPClient, Int32 (+3 more)
...
Cohesion: 0.18
Nodes (17): BgInstance, CursorCacheKey, DecoInstance, EncodedFrameInstances, EncodedRowInstances, GlyphInstance, ImageInstance, PendingBgSpan (+9 more)
...
Cohesion: 0.07
Nodes (13): KouenTerminalSurfaceView, Bool, CAMetalDrawable, NSEvent, RGBColor, String, KouenTerminalSurfaceView, CGFloat (+5 more)
...
Cohesion: 0.14
Nodes (9): Int, TerminalGridSnapshot, SemanticMark, HistoryLine, RewrapResult, Bool, String, TerminalGridCell (+1 more)
...
Cohesion: 0.06
Nodes (20): CornerInfo, EditorDividerView, HitTestPassthroughView, KouenSplitView, PaneDragGripView, PaneHoverButton, PaneSplitButtonsView, CGFloat (+12 more)
...
Cohesion: 0.15
Nodes (12): object, AsyncCLIResultBox, KouenCLI, LSPDefinitionPayload, LSPDiagnosticsPayload, LSPStatusPayload, Error, Result (+4 more)
...
Cohesion: 0.12
Nodes (10): Bool, OptionSet, KeySpec, Modifiers, Decoder, String, UInt8, PrefixKeymapFallbackTests (+2 more)

### Community 113 - "HarnessGridTerminal"
Cohesion: 0.11
Nodes (22): CaseIterable, KouenSettings, ResizeOverlayMode, afterFirst, always, never, ResizeOverlayPosition, bottomRight (+14 more)
...
Cohesion: 0.11
Nodes (9): DaemonSyncService, Bool, Never, SessionCoordinator, SessionSnapshot, Task, UUID, Void (+1 more)
...
Cohesion: 0.16
Nodes (9): HunkActionButton, RepoEntry, StageToggleButton, escaping, MainActor, NSCoder, NSRect, Void (+1 more)
...
### Community 126 - ".path"
Cohesion: 0.06
Nodes (32): AnimatablePair, NotchShape, CGFloat, CGPath, CGRect, Path, AgentArt, AgentMark (+24 more)
...
Cohesion: 0.13
Nodes (14): Logger, OSSignposter, FrameDropCause, encodeFailure, nilDrawable, FrameSignposter, Bool, StaticString (+6 more)
...
Cohesion: 0.10
Nodes (18): KeyRecorderRepresentable, String, Void, OverlayBackground, Context, OverlayBackground, Context, ChromeBackdrop (+10 more)
...
### Community 186 - "Error"
Cohesion: 0.08
Nodes (32): ImagePlacementSnapshot, Bool, String, UInt8, TerminalCellWidth, normal, spacerTail, wide (+24 more)
...
Cohesion: 0.10
Nodes (17): CTFontSymbolicTraits, CellMetrics, GlyphRasterizer, RasterizedGlyph, ShapedGlyph, ShapedRunKey, Bool, CGContext (+9 more)
...
Cohesion: 0.11
Nodes (11): GroupedSessionTests, Set, SurfaceID, Phase67Tests, FormatContextDaemonTests, PaneID, SessionSnapshot, String (+3 more)

### Community 196 - "Feature Provenance — harness-terminal"
Cohesion: 0.08
Nodes (21): Kind, primary, secondary, KouenPillButton, SoftIconButton, Style, accent, agent (+13 more)
...
Cohesion: 0.15
Nodes (11): PtyError, launchFailed, RealPty, ScrollbackEntry, ScrollbackReplaySegment, Data, UInt64, UUID (+3 more)
...
### Community 215 - ".lines"
Cohesion: 0.08
Nodes (20): GitStatusType, added, deleted, modified, renamed, unmodified, untracked, GitStatusProvider (+12 more)
...
Cohesion: 0.11
Nodes (13): ResizeHUDView, DispatchWorkItem, NSCoder, NSColor, NSPoint, NSRect, TimeInterval, SurfaceIO (+5 more)
...
Cohesion: 0.14
Nodes (8): BoardCardView, BoardViewController, FlippedView, Bool, Set, TabID, Void, BoardViewControllerTests
...
Cohesion: 0.13
Nodes (15): DaemonClient, KouenCLI, String, KouenCLI, String, KouenCLI, SessionID, String (+7 more)
...
Cohesion: 0.11
Nodes (19): MTLClearColor, MTLCommandBuffer, MTLLibrary, MTLRenderPipelineState, InstanceUploadCacheKey, PromptGutterUploadKey, Bool, CAMetalDrawable (+11 more)
...
Cohesion: 0.11
Nodes (22): AppKit, CoreGraphics, CoreText, KouenCopyMode, KouenTerminalEngine, KouenTerminalRenderer, KouenTheme, Metal (+14 more)
...
Cohesion: 0.25
Nodes (6): SessionDividerRowView, SidebarBadgeView, NSCoder, NSColor, NSRect, NSPressGestureRecognizer
...
Cohesion: 0.08
Nodes (26): AgentChipView, BoardColumnKind, ChromeRole, sidebar, tabBar, Divider, FontSize, IconSize (+18 more)
...
Cohesion: 0.09
Nodes (22): CustomStringConvertible, Error, ExpressibleByStringLiteral, InstallError, unsupported, DaemonClientError, connectionFailed, timeout (+14 more)
...
Cohesion: 0.14
Nodes (11): keys, HintModeOverlay, Any, KouenTerminalSurfaceView, NSEvent, NSView, String, ITerm2InlineImage (+3 more)
...
Cohesion: 0.10
Nodes (11): KouenCore, KouenDaemonCore, FormatContextBuilder, DaemonSurfaceID, SessionSnapshot, String, GroupedSessionDaemonTests, SessionGroup (+3 more)
...
Cohesion: 0.08
Nodes (16): MainActor, Void, SessionGroupHeaderRowView, SessionWorktreeHeaderRowView, SessionWorktreeRowView, SidebarTitlebarHeaderView, BoardColumnKind, Bool (+8 more)
...
Cohesion: 0.05
Nodes (20): NSCursor, T, KouenTerminalSurfaceView, PendingMainHop, SurfaceEmulatorState, SurfaceFrameBuildResult, Bool, CGFloat (+12 more)
...
Cohesion: 0.11
Nodes (11): Foundation, KouenSettings, Bool, Data, LSPClientError, missingPipe, processNotRunning, serverNotExecutable (+3 more)
...
### Community 1398 - "sessionGroupName"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (9): NWEndpoint, NWListener, PairingBox, PendingPairing, Bool, Date, String, TimeInterval (+1 more)
...
Cohesion: 0.11
Nodes (18): KeybindingsService, Bool, Command, String, Binding, CodingKeys, bindings, disabledSpecs (+10 more)

## Knowledge Gaps
- **3865 isolated node(s):** `unsupportedPlatform`, `unmodified`, `modified`, `added`, `deleted` (+3860 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2396 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `.compose` to `Changelog Archive`, `callingPaneTarget`, `CodingKey`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `Command`, `LSPMessage`, `KouenIPC`, `PerformanceBenchmarks`, `GitPanelView.swift`, `Changed`, `KittyKeyboardTests`, `VTParser`, `HarnessTerminalSurfaceView`, `TerminalEmulator`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `Changed`, `HarnessChrome`, `CopyModeAction`, `SplitPaneCoordinator`, `HarnessTerminalSurfaceView`, `WorktreeManager`, `SessionGroupHeaderRowView`, `install-app.sh`, `.parse`, `RGBColor`, `SemanticPromptTests`, `Notification`, `.addTab`, `Equatable`, `LegacySnapshot`, `MenuTarget`, `Task Ledger Archive (Tasks 1–50)`, `String`, `TerminalColorGamut`, `HarnessSettings`, `harness.resource`, `HarnessSidebarPanelViewController.swift`, `CodingKeys`, `HarnessOverlayBackground`, `.buildCommand`, `.normalizedKey`, `DaemonServer`, `.keyEvent`, `HarnessSplitView`, `TabCell`, `newWindow`, `BellScanState`, `CommandHistorySearchController`, `PasteBufferStore`, `ViEngine`, `FrecencyDirectoryStore`, `ComposedCell`, `HarnessCLI+Server.swift`, `.text`, `PrefixKeymap`, `TerminalProgressReport`, `DecoKind`, `String`, `FileTreeKeyboardNavigator`, `worktree_isolation_cli.robot`, `XCTestCase`, `.detect`, `.parse`, `Endpoint`, `HarnessDesign`, `selectWorkspace`, `.applyPreedit`, `ImmersiveEffects`, `LSPClient`, `TerminalGridCell`, `HarnessPaths`, `.cgPath`, `HarnessTerminalSurfaceView`, `Added`, `MenuBarController`, `TerminalModes`, `AttachInputBatcher`, `shim.c`, `.testRenderEncodeIncrementalDamage160x48`, `PaneContainerView`, `ScriptRuntime.swift`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `Changelog`, `AnyCodable`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `SoftIconButton`, `[1.3.0-vit] - 2026-06-06`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `.encode`, `SessionGroup`, `graphify reference: query, path, explain`, `WorkspaceFileTreeView`, `.request`, `String`, `HistoryRingBuffer`, `.path`, `ClientSummary`, `GlyphAtlas`, `SwiftUI`, `.install`, `AgentHookInstaller`, `.bytes`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `[3.11.0] - 2026-06-28`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `MCPServer`, `HarnessDaemonToolsTests`, `.evaluate`, `PathToken`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `.recordReapedGenerationForTesting`, `TerminalFindBar`, `.jumpToBlock`, `CommandPromptController`, `ActiveTabCloseDisposition`, `LiveSession`, `URLDetection`, `BoardCard`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `Added`, `.rects`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `.testOptionLinesAreNotCommands`, `VTConformanceCorpusTests`, `GridCompositorTests`, `LSPServerRegistry`, `SessionSnapshot`, `Error`, `AppDelegate`, `BrowserPaneView`, `Lexer`, `ScriptRuntime`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `AgentSessionSummary`, `.classify`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `SettingsRemoteView`, `PaneTarget`, `NotchLayoutMetrics`, `CellColorResolverTests`, `GridCompositor`, `ScrollbackFile`, `TerminalServicesProvider`, `CellColorResolver`, `HarnessPathDisplay`, `FileChangeWatcher`, `.hitTest`, `ExternalOpenKind`, `WorkbenchCommand`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `ReflowPreviewTests`, `SessionCoordinator`, `BoardViewController`, `workspace`, `release-hotfix.sh`, `GitMetadataProvider`, `WindowTitleStripView`, `ThemeFileServiceTests`, `.welcome`, `Sidebar SwiftUI Migration — Knowledge`, `listSurfaces`, `HarnessSidebarPanelViewController`, `.userNotificationCenter`, `.path`, `[2.2.4] - 2026-06-11`, `[3.11.2] - 2026-06-28`, `DefaultTerminalManager`, `StatusLineView.swift`, `WindowSession`, `SyntaxTextView`, `.run`, `renumberWindows`, `.menu`, `.rememberTabForReopen`, `FormatColor`, `click_ui_element`, `AgentHookStrategy`, `StatusLineWidthTests`, `Process`, `JSONDecoder`, `AgentVectorIcon`, `Fixes Applied (layered)`, `AgentApprovalBar`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `.scrollWheel`, `Send Ex Command`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `BlockSummary`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `.theme`, `ImmersivePalette.swift`, `ImageProtocolTests.swift`, `.makeModel`, `CommandExecutionError`, `Foundation`, `[2.2.3] - 2026-06-09`, `Background Polling & Snapshot Fanout — P22`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.handleCat`, `OcclusionTests`, `FormatStyledSegment.swift`, `projectGroupRootPath`, `[2.2.4] - 2026-06-11`, `generate-cheatsheet.js`, `Consumers`, `DaemonStats`, `Tab`, `Git Panel`, `DynamicInstanceBuffer`, `.install`, `SurfaceProgressTrackerTests.swift`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `Split Panes (NSSplitView)`, `ITerm2InlineImage`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `yaml.json`, `HintModeOverlay`, `.parseDiffHunks`, `PathToken`, `Project History`, `WaitForRegistry`, `SessionEditor`, `Implementation Phases`, `RawRepresentable`, `main.swift`, `.run`, `.evaluateStyled`, `HarnessOnboarding`, `ScrollbackTests`, `Command Prompt Architecture`, `Changed`, `[3.10.1] - 2026-06-27`, `printThemePreview`, `terminal-cheat-sheet.html`, `requireSessionID`, `resolvedCLIPath`, `.locate`?**
  _High betweenness centrality (0.257) - this node is a cross-community bridge._
- **Why does `KouenCore` connect `KouenIPC` to `Changelog Archive`, `CodingKey`, `.handleNormal`, `graphify reference: extra exports and benchmark`, `callingPaneTarget`, `AgentNotchRootView`, `Added`, `TerminalEmulator`, `PerformanceBenchmarks`, `KittyKeyboardTests`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `.request`, `SessionGroupHeaderRowView`, `.parse`, `Task Ledger Archive (Tasks 1–50)`, `LegacySnapshot`, `NSObject`, `MenuTarget`, `String`, `[3.12.0] - 2026-06-30`, `harness.resource`, `CodingKeys`, `RenderSchedulerTests`, `HarnessOverlayBackground`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `.normalizedKey`, `HookEvent`, `ScrollbackPersistenceTests`, `ThemeCatalogEmbedTests`, `.keyEvent`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `HarnessCLI+Server.swift`, `TerminalProgressReport`, `DecoKind`, `ShellIntegration`, `XCTestCase`, `.statusLineSet`, `.parse`, `TerminalProtocolCompatibilityTests`, `LSPClient`, `LSPDiagnostic`, `.cursorPos`, `MenuBarController`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `.dispatch`, `MainSplitViewController`, `ScriptFileWatcher`, `AgentNotchViewModel`, `NSView`, `ViEngine`, `SoftIconButton`, `DamageTrackingTests`, `.makeSnapshot`, `.resolve`, `.encode`, `SessionGroup`, `PaneNode`, `[3.0.0] - 2026-06-15`, `clearSelection`, `ViEngine`, `Pipe`, `String`, `.install`, `stability_release.robot`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `[3.11.0] - 2026-06-28`, `.testPaneLeafLegacyDecodeBackfillsSurfaceTabs`, `CopyModeGridSource`, `DecodedImage`, `MCPServer`, `FileTreeWatcher`, `EnvironmentStore`, `New Tab`, `HarnessDaemonToolsTests`, `PathToken`, `What You Must Do When Invoked`, `ThaiCombiningMarkTests`, `[3.8.0] - 2026-06-22`, `MatchCategory`, `sessionCreated`, `TerminalFindBar`, `LiveSession`, `ReflowCorpusTests`, `RGBColorTests`, `Added`, `.rects`, `InlineAICompletionView`, `GridCompositorTests`, `AppDelegate`, `BrowserPaneView`, `Lexer`, `ScriptRuntime`, `[2.3.0] - 2026-06-11`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `[2.5.1] - 2026-06-12`, `BinaryInstaller`, `MainWindowController`, `FileTabManager`, `.classify`, `BinaryInstallerVersionTests`, `PaletteModel`, `AutomationScheduler`, `CopyModeState`, `HarnessCLI`, `[2.4.0] - 2026-06-12`, `.printBoard`, `PaneDropZoneOverlay`, `.translate`, `NotchLayoutMetrics`, `.lines`, `CellColorResolverTests`, `GridCompositor`, `ScrollbackFile`, `Section`, `AgentNotchRowSummary`, `ANSIPalette`, `AgentHookInstaller.swift`, `SSHTunnelManagerTests`, `sessionRow`, `graphify reference: incremental update and cluster-only`, `TextGrid`, `.scan`, `WorkbenchCommand`, `.make`, `AgentBridge`, `.make`, `ThemeDocumentTests`, `.renderFixture`, `DaemonMetrics`, `ReflowPreviewTests`, `[3.4.0] - 2026-06-19`, `SessionCoordinator`, `HarnessTerminalSurfaceWorkerTests`, `Split Right`, `BoardViewController`, `GitMetadataProvider`, `Sidebar SwiftUI Migration — Knowledge`, `Browser Pane (P14)`, `KeySpec`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `reorderSession`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `CLICommand`, `Motion`, `.apply`, `.load`, `GitHubCLIClient`, `NotificationBus`, `jobs`, `ThemeDiagnostics`, `.encodeMouse`, `ViPathTokenTests`, `.selectedText`, `Bug: Tab-Switch Black Screen`, `Terminal AI Chat (⌘I inline overlay)`, `FormatColor`, `.theme`, `RealPty`, `CommandExecutionError`, `CSIParams`, `Foundation`, `DaemonLifecycleTests`, `Background Polling & Snapshot Fanout — P22`, `Architecture Decisions — harness-terminal`, `GPU Animation Pattern — Layout Once, GPU Paints`, `SurfaceProgressTracker`, `[3.5.1] - 2026-06-20`, `State`, `FormatStyledSegment.swift`, `RGBColor`, `Fixes Applied (v3.9.1+)`, `Consumers`, `SurfaceRegistryTests.swift`, `Git Panel`, `.encode`, `Identifiable`, `ThaiClusterRenderTests`, `User Profile`, `HarnessCLITests`, `UI Automation — Robot Framework (P18)`, `AppKit + Metal Patterns`, `themes.json`, `Split Panes (NSSplitView)`, `AgentIconRenderer`, `IPC Architecture`, `go.json`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `LaunchdServiceInstaller`, `WaitForRegistry`, `Feature Specs`, `Implementation Phases`, `RawRepresentable`, `BlockContextMenuTests`, `Section`, `main.swift`, `.run`, `PaneLabelDaemonTests`, `MouseButton`, `ReflowFastPathTests`, `HarnessOnboarding`, `.steps`, `Browser Tab Close Button Unresponsive`, `.json`, `Fixed`, `ACP Client (Shelved)`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Foundation` connect `PathToken` to `Changelog Archive`, `callingPaneTarget`, `.handleNormal`, `CodingKey`, `IPCRequest`, `KouenIPC`, `Command`, `LSPMessage`, `TerminalEmulator`, `KittyKeyboardTests`, `VTParser`, `.applyPreedit`, `HarnessChrome`, `SpecialKey`, `SplitPaneCoordinator`, `.request`, `install-app.sh`, `.parse`, `RGBColor`, `Task Ledger Archive (Tasks 1–50)`, `DaemonClient`, `MenuTarget`, `String`, `.startWatching`, `[3.12.0] - 2026-06-30`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `HarnessOverlayBackground`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `ThemeCatalogEmbedTests`, `HookEvent`, `markPane`, `.keyEvent`, `BellScanState`, `PasteBufferStore`, `FrecencyDirectoryStore`, `HarnessCLI+Server.swift`, `.text`, `ShellIntegration`, `DecoKind`, `String`, `FileTreeKeyboardNavigator`, `.statusLineSet`, `OptionStore`, `.parse`, `HarnessDesign`, `DaemonSubscription`, `ImmersiveEffects`, `LSPDiagnostic`, `TerminalGridCell`, `LSPClient`, `SessionCoordinator`, `.cgPath`, `AttachInputBatcher`, `PaneContainerView`, `.dispatch`, `DaemonLauncher`, `AnyCodable`, `Recipe`, `ScriptFileWatcher`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `ViEngine`, `.makeSnapshot`, `HarnessGridTerminal`, `.firstWaitingTab`, `ActiveTabCloseDisposition`, `SessionGroup`, `PaneNode`, `Pipe`, `HistoryRingBuffer`, `AgentHookInstaller`, `[3.10.1] - 2026-06-27`, `.bytes`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `graphify reference: query, path, explain`, `CommandTarget`, `TerminalHostView`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `FileTreeWatcher`, `EnvironmentStore`, `HarnessDaemonToolsTests`, `[3.1.2] - 2026-06-16`, `.evaluate`, `BrowserIntegrationController`, `Int`, `LiveResizeTests`, `.recordReapedGenerationForTesting`, `[3.9.1] - 2026-06-22`, `AgentKind`, `AmbientBackground`, `MatchCategory`, `Workspace`, `CommandPromptController`, `ActiveTabCloseDisposition`, `FilePreviewCoordinator`, `[2.1.0] - 2026-06-07`, `LiveSession`, `URLDetection`, `.hold`, `.rects`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `Added`, `GridCompositorTests`, `Error`, `BrowserPaneView`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `BinaryInstallerVersionTests`, `PaletteModel`, `TerminalProgressReport`, `ReplayStep`, `grok`, `HarnessCLI`, `scheduleRender`, `SettingsRemoteView`, `PaneDropZoneOverlay`, `PaneTarget`, `.translate`, `NotchLayoutMetrics`, `.lines`, `CellColorResolverTests`, `ScrollbackFile`, `Section`, `ReplayStep`, `AgentNotchRowSummary`, `ANSIPalette`, `TerminalServicesProvider`, `HarnessPathDisplay`, `CellColorResolver`, `SSHTunnelManagerTests`, `sessionRow`, `.decide`, `HarnessGridTerminalTests`, `ExternalOpenKind`, `graphify reference: incremental update and cluster-only`, `.scan`, `.make`, `.copySelection`, `PaneBorderStatus`, `TerminalMetalRenderer`, `FindWindowMatcherTests`, `.make`, `FileNode`, `.renderFixture`, `SessionCoordinator`, `NSViewRepresentable`, `BundledThemesData.swift`, `release-hotfix.sh`, `Sidebar SwiftUI Migration — Knowledge`, `WindowTitleStripView`, `Browser Pane (P14)`, `reorderSession`, `harness-cli.fish`, `FormatColor`, `click_ui_element`, `Motion`, `JSONDecoder`, `.load`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `jobs`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `ThemeDiagnostics`, `ViPathTokenTests`, `Send Ex Command`, `.selectedText`, `Bug: Tab-Switch Black Screen`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `.unmarkText`, `FormatColor`, `BlockSummary`, `DesktopNotifier`, `FloatingPaneController`, `.theme`, `.reopenClosedTab`, `.recordReapedGenerationForTesting`, `Foundation`, `Architecture Decisions — harness-terminal`, `AutomationScheduler`, `[3.5.1] - 2026-06-20`, `State`, `FormatStyledSegment.swift`, `[2.2.4] - 2026-06-11`, `Fixes Applied (v3.9.1+)`, `.encode`, `Identifiable`, `SurfaceProgressTrackerTests.swift`, `MCPServer`, `ThaiClusterRenderTests`, `NSTextField Leak in BoardViewController (P20 Performance)`, `Darwin`, `UI Automation — Robot Framework (P18)`, `.load`, `themes.json`, `Split Panes (NSSplitView)`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `javascript.json`, `json.json`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `Bug — Cmd+\ sidebar toggle gone after collapse`, `.delay`, `Competitive Position (as of v3.12.0, 2026-07-02)`, `PathToken`, `LaunchdServiceInstaller`, `Feature Specs`, `ThaiClusterCopyTests.swift`, `SessionEditor`, `Implementation Phases`, `RawRepresentable`, `BlockContextMenuTests`, `main.swift`, `.encode`, `PaneLabelDaemonTests`, `MouseButton`, `ReflowFastPathTests`, `.evaluateStyled`, `HarnessOnboarding`, `Service Decomposition — SessionCoordinator (P17)`, `terminal-cheat-sheet.html`, `.json`, `Fixed`, `ACP Client (Shelved)`, `KittyGraphicsCommand`?**
