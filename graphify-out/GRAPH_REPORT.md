...
## Summary
- 20155 nodes · 54294 edges · 2097 communities (637 shown, 1460 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 8078 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8310905`
...
4. `Process` - bridges 47 areas (101 edges)
5. `DaemonClient` - bridges 46 areas (209 edges)
...
10. `.requestDaemon(_:)` - bridges 35 areas (89 edges)
...
## Communities (2097 total, 1460 thin omitted)
...
Cohesion: 0.10
Nodes (14): ConcurrentIndexSet, .count, DaemonContentionTests, SubscriptionBox, .count, URL, DaemonRoundTripTests, String (+6 more)
...
Cohesion: 0.05
Nodes (49): AnyTransition, AgentNotchPeekEvent, AgentNotchRootView, .bottomRadius, .closedAccessibilityLabel, .closedTransition, .closedView, .currentHeight (+41 more)
...
Cohesion: 0.05
Nodes (46): DecodedImage, .byteCount, UInt8, Bool, CAMetalDrawable, String, String, UInt64 (+38 more)

### Community 11 - "GitPanelView.swift"
Cohesion: 0.07
Nodes (30): IndexingIterator, LayoutTemplate, SessionEditor, .addSurface(tabID:paneID:), .addSurface(to:paneID:surfaceID:cwd:), .split(node:targetPaneID:direction:paneCount:before:), .split(node:targetPaneID:with:direction:beforeTarget:), .surfaceID(forPaneID:in:) (+22 more)
...
Cohesion: 0.05
Nodes (34): tab, .tab(for:), .tab(forSurfaceKey:), AutomationScheduler, DispatchSourceTimer, DaemonCommandExecutor, Command, .init(forTesting:) (+26 more)
...
Cohesion: 0.14
Nodes (19): DaemonSubscription, .start(onData:onEnd:buffered:), .start(onResponse:onEnd:), Bool, UInt64, Void, UnsafeMutableRawPointer, sysClose() (+11 more)
...
Cohesion: 0.04
Nodes (65): a1t(), amn(), B0, b2t(), BBe(), cg(), ch(), cvt() (+57 more)

### Community 22 - "CopyModeAction"
Cohesion: 0.01
Nodes (552): _0t(), _1n(), _3e(), _5e(), _5n(), _6e(), _9e(), a2t() (+544 more)
...
Cohesion: 0.06
Nodes (48): _3n(), aR(), bV(), c_n(), cKt(), copy(), cYt(), d4e() (+40 more)
...
### Community 28 - ".parse"
Cohesion: 0.03
Nodes (262): pe(), r, X(), A(), code(), R(), a(), ae() (+254 more)
...
Cohesion: 0.11
Nodes (38): al(), bdn(), bIn(), d7e(), dOt(), dU(), Eb(), Etn() (+30 more)
...
Cohesion: 0.17
Nodes (6): KouenPaths, SSHTunnelManager, Bool, SSHTunnelManagerTests, String, URL
...
Cohesion: 0.13
Nodes (16): bXt(), Eme(), H7(), IR(), kCn(), kUe(), LUe(), lXt() (+8 more)
...
Cohesion: 0.03
Nodes (84): a9e(), agn(), agt(), avn(), bce(), bee(), c8n(), cSn() (+76 more)
...
Cohesion: 0.13
Nodes (14): FleetJobItem, .isActive, .launchAgentScriptPath, .statusDisplay, AutomationsFleetView, .body, .emptyFleetView, .headerBar (+6 more)
...
Cohesion: 0.06
Nodes (41): NSCursor, RGBColor, TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate (+33 more)
...
Cohesion: 0.15
Nodes (14): MainActor, Void, Group, ParsedShortcut, .displayString, PrefixCheatsheetWindow, .groups, PrefixIndicatorWindow (+6 more)
...
### Community 64 - ".text"
Cohesion: 0.10
Nodes (21): table(), tablecell(), tablerow(), Y(), AOt(), Ape(), bOt(), cX() (+13 more)
...
Cohesion: 0.06
Nodes (40): _4e(), A1(), a2n(), aat(), bj(), bln(), bw(), bwt() (+32 more)
...
Cohesion: 0.03
Nodes (83): a8n(), aoe(), _at(), aV(), bb(), bR(), c9e(), cce() (+75 more)
...
Cohesion: 0.09
Nodes (28): AS(), aTn(), bvt(), cc(), cOn(), d2(), dce(), e6() (+20 more)
...
Cohesion: 0.06
Nodes (33): LSPFileSession, Never, String, Task, URL, Void, URL, SyntaxDefinitionTarget (+25 more)

### Community 84 - "LSPDiagnostic"
Cohesion: 0.27
Nodes (12): agentWaitChannel(), BrowserElement, BrowserElementBounds, BrowserSnapshot, BufferSummary, HookEntry, IPCResponse, OptionEntry (+4 more)
...
Cohesion: 0.06
Nodes (50): a6(), CWt(), dUe(), eJ(), EWt(), fle(), fme(), fUe() (+42 more)
...
Cohesion: 0.09
Nodes (10): ImageLimits, Bool, ImageDecoder, Bool, NSDraggingInfo, NSDragOperation, NSPasteboard, URL (+2 more)
...
Cohesion: 0.10
Nodes (27): a0n(), aA(), cV(), dl(), dyn(), eAn(), ewn(), fk() (+19 more)
...
Cohesion: 0.06
Nodes (14): SessionCoordinator, .selectWorkspace(_:), Bool, Double, PaneID, PaneNode, SplitDirection, String (+6 more)
...
Cohesion: 0.22
Nodes (4): RecipePickerModelMergeTests, Bool, String, SurfaceID
...
Cohesion: 0.08
Nodes (27): b5e(), c6(), cke(), _gn(), gSn(), gU(), h7e(), jpt() (+19 more)

### Community 154 - "LiveResizeTests"
Cohesion: 0.09
Nodes (23): Bool, String, UInt8, TerminalCellWidth, normal, spacerTail, wide, TerminalGridCell (+15 more)
...
### Community 157 - "Added"
Cohesion: 0.15
Nodes (8): SessionGroup, .automationsList, String, SessionGroup, NSMenu, NSMenuItem, SessionGroup, SessionID
...
Cohesion: 0.13
Nodes (25): .resolvedGitStatus, fetchGitStatus(), ProjectCategory, ProjectCategorySection, .body, .c, ProjectDirectoryTreeModel, .isExpanded (+17 more)
...
Cohesion: 0.12
Nodes (7): KouenDaemonTools, .init(client:subscriptionClient:controlEnabled:), SpawnedAgentSurface, Bool, Result, String, UUID
...
Cohesion: 0.11
Nodes (17): FilterStatus, active, all, completed, CaseIterable, ResizeOverlayMode, afterFirst, always (+9 more)
...
Cohesion: 0.05
Nodes (35): Selector, .body, .init(coder:), .init(frame:), .init(coder:), Kind, primary, secondary (+27 more)
...
Cohesion: 0.10
Nodes (9): GitPanelView, .isHidden, .removeWorktreeAction(_:), Any, DispatchWorkItem, NSMenuItem, UnsafeMutableRawPointer, .init(card:) (+1 more)
...
Cohesion: 0.04
Nodes (36): SessionID, ContentAreaViewController, CornerInfo, EditorDividerView, HitTestPassthroughView, KouenSplitView, .dividerColor, .dividerThickness (+28 more)
...
Cohesion: 0.17
Nodes (31): aQ(), bqt(), cbe(), DD(), dqt(), Eqt(), Fa(), G3() (+23 more)
...
Cohesion: 0.11
Nodes (47): Ame(), aQt(), aUe(), aXt(), Cqt(), CUe(), cXt(), DYt() (+39 more)
...
Cohesion: 0.02
Nodes (206): em(), a7n(), a9n(), abn(), aDt(), ag(), aln(), bd() (+198 more)
...
Cohesion: 0.14
Nodes (15): Darwin, Foundation, Glibc, KouenCore, PtyError, launchFailed, ShellLaunchProfile, .argv (+7 more)
...
Cohesion: 0.20
Nodes (9): IssueTrackerPanelView, .body, .filteredIssues, .statusBannerText, String, IssueFetchStatus, apiError, live (+1 more)
...
Cohesion: 0.12
Nodes (23): Cjt(), Dr(), Ejt(), Fwe(), H2e(), hR(), jX(), Kje() (+15 more)
...
### Community 301 - ".parse"
Cohesion: 0.10
Nodes (10): PrefixKeymap, Any, Bool, NSEvent, TimeInterval, ControlKeyNormalizer, Bool, String (+2 more)
...
Cohesion: 0.13
Nodes (20): aJ(), cJ(), dXt(), F0(), fXt(), hyn(), Ime(), m2t() (+12 more)
...
Cohesion: 0.08
Nodes (21): AnyObject, TimeInterval, ZombieHoldRegistry, BrowserIntegrationController, NSView, PaneID, PaneContainerView, .init(node:cwd:themeName:existingHosts:existingBrowserPanes:) (+13 more)
...
Cohesion: 0.13
Nodes (8): AgentTableEntry, MatchSource, ownProcess, wrapperLaunch, Bool, Set, String, AgentDetectorTests
...
Cohesion: 0.09
Nodes (25): AYt(), bGt(), Cme(), EUe(), eYt(), IUe(), iXt(), j9n() (+17 more)
...
Cohesion: 0.21
Nodes (4): ClaudeCodeHarness, Bool, UUID, ClaudeCodeHarnessTests
...
Cohesion: 0.14
Nodes (15): Color, .hexString, ColorHexRow, .body, .colorBinding, .currentHex, .isCustom, PaletteCell (+7 more)
...
Cohesion: 0.15
Nodes (8): bUt(), fQ, Gbe(), handler(), hqe(), M9(), mUt(), _Q()
...
Cohesion: 0.08
Nodes (19): .webView(_:didCommit:), .webView(_:didStartProvisionalNavigation:), BrowserPaneViewTests, MockWebView, .isLoading, .url, Any, Bool (+11 more)
...
### Community 402 - "View"
Cohesion: 0.06
Nodes (36): MonoPillButtonStyle, Configuration, ButtonStyle, CommandRow, .body, GlassCard, .body, GlassPrimaryButtonStyle (+28 more)
...
Cohesion: 0.07
Nodes (29): EndpointError, connectionFailed, .description, notYetSupported, pathTooLong, String, EndpointConnector, Int32 (+21 more)
...
Cohesion: 0.09
Nodes (24): QuietRow, .body, StatusPill, .body, .color, Agent, OnboardingEnvironment, Bool (+16 more)
...
Cohesion: 0.08
Nodes (35): Int, Date, String, TerminalBlock, TerminalBlockStore, .block(atPromptLine:), .block(id:), .lastFinishedBlock (+27 more)
...
Cohesion: 0.20
Nodes (12): eGt(), HUe(), Ije(), KD(), kXt(), $Rt(), tJe(), UUe() (+4 more)
...
Cohesion: 0.09
Nodes (20): .notchSection, .notifySection, SettingsAppearanceView, .autoTheme, .body, .themeSection, SliderRow, .body (+12 more)
...
Cohesion: 0.07
Nodes (28): clamp(), statusColor(), statusHelp(), Configuration, Date, Never, SplitDirection, String (+20 more)
...
Cohesion: 0.09
Nodes (28): SettingsColorsView, .body, .chromeSection, .paletteSection, .renderingSection, .terminalColorsSection, KeyRecorderRepresentable, SettingsKeysView (+20 more)
...
Cohesion: 0.20
Nodes (8): GroupHeaderRow, .body, RecipePickerFooter, .body, RecipePickerModel, .body, NSWindow, String
...
Cohesion: 0.32
Nodes (7): .pairedAlreadyBanner, .pairingQRPanel, .body, .sidebarEmptyView, GitHubSearchResult, Label, Repository
...
Cohesion: 0.09
Nodes (28): .init(entry:), AgentChipView, .intrinsicContentSize, ChromeRole, sidebar, tabBar, FontSize, IconSize (+20 more)
...
Cohesion: 0.11
Nodes (8): Int32, String, TimeInterval, UInt16, UUID, T, IPCEnvelope, IPCCodecTests
...
Cohesion: 0.02
Nodes (316): l, _2t(), _4n(), _6n(), _7n(), a0(), a5n(), a_n() (+308 more)
...
Cohesion: 0.03
Nodes (36): NSRangePointer, TerminalGridCell, NSEvent, Any, CGFloat, NSEvent, NSMenu, NSMenuItem (+28 more)
...
Cohesion: 0.09
Nodes (17): CGFloat, MainSplitViewController, .setSidebarVisible(_:), SplitChromeDelegate, .splitView(_:constrainMaxCoordinate:ofSubviewAt:), .splitView(_:constrainMinCoordinate:ofSubviewAt:), .splitView(_:effectiveRect:forDrawnRect:ofDividerAt:), .splitView(_:shouldAdjustSizeOfSubview:) (+9 more)
...
Cohesion: 0.25
Nodes (7): PickerItemRow, .badgeText, .iconName, .subtitle, .titleText, AttributedString, NSColor
...
Cohesion: 0.29
Nodes (7): PickerItem, .groupLabel, historyBlock, .id, recipe, .searchableText, SurfaceID
...
Cohesion: 0.11
Nodes (21): .exit, DaemonClient, String, String, String, String, KouenCLI, SessionID (+13 more)
...
- **1460 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
