...
## Corpus Check
- 715 files · ~850,575 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14588 nodes · 31249 edges · 3722 communities (1231 shown, 2491 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 3430 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70ba89ce`
...
## Communities (3722 total, 2491 thin omitted)

### Community 0 - "CodingKey"
Cohesion: 0.18
Nodes (14): CodingKey, BannerShortcut, BannerShortcutRegistry, CodingKeys, description, key, showInBanner, Keybinding (+6 more)
...
Cohesion: 0.11
Nodes (15): DaemonClient, ConcurrentIndexSet, DaemonContentionTests, String, URL, DaemonRoundTripTests, Data, Int32 (+7 more)
...
Cohesion: 0.14
Nodes (4): ContentAreaViewController, String, TabID, Notification
...
Cohesion: 0.19
Nodes (9): HarnessSettings, Bool, Decoder, Double, Float, TerminalTextRenderingMode, crisp, native (+1 more)
...
Cohesion: 0.12
Nodes (6): HarnessSidebarPanelViewController, NSMenuItem, NSView, String, SessionSnapshot, SidebarTitlebarHeaderView
...
Cohesion: 0.17
Nodes (8): ChromeBackdrop, HarnessDesign, RuntimeGlassEffectView, Bool, NSColor, NSPoint, NSView, NSVisualEffectView

### Community 45 - "HarnessTerminalSurfaceView.swift"
Cohesion: 0.07
Nodes (12): NSCursor, StaticString, HarnessTerminalSurfaceView, Data, DispatchSemaphore, DispatchWorkItem, NSPasteboard, NSWindow (+4 more)
...
Cohesion: 0.07
Nodes (18): SessionEditor, Bool, Date, SessionID, String, SurfaceID, Tab, TabID (+10 more)
...
Cohesion: 0.13
Nodes (15): CLIInstallLocator, DetachKeys, absent, invalid, parsed, HarnessCLI, OptionalUUID, absent (+7 more)
...
Cohesion: 0.11
Nodes (20): OptionStore, OptionStore.Value, Scope, global, pane, session, tab, workspace (+12 more)
...
Cohesion: 0.11
Nodes (24): DaemonSubscription, Bool, Data, Int32, TimeInterval, UInt64, Void, UnsafeMutableRawPointer (+16 more)
...
Cohesion: 0.16
Nodes (12): object, LSPDiagnostic, LSPDiagnosticSeverity, error, hint, information, warning, LSPHover (+4 more)
...
Cohesion: 0.13
Nodes (12): InlineAICompletionController, HarnessSettings, String, HarnessOptions, Bool, CGFloat, FormatColor, HarnessSettings (+4 more)
...
### Community 95 - "shim.c"
Cohesion: 0.13
Nodes (5): CHarnessSys, Configuration, UInt16, UInt8, TTYSize
...
Cohesion: 0.13
Nodes (10): NSEvent, HarnessPillButton, Kind, primary, secondary, SoftIconButton, NSCoder, NSEvent (+2 more)

### Community 112 - ".makeSnapshot"
Cohesion: 0.25
Nodes (9): PaneListRow, SessionListRow, SnapshotQueryFormatter, Bool, SessionGroup, SessionSnapshot, String, UUID (+1 more)
...
Cohesion: 0.07
Nodes (28): String, UInt16, UUID, DecodedReplyFrame, output, reply, DecodedRequestFrame, input (+20 more)
...
Cohesion: 0.13
Nodes (13): FlippedView, GitResult, RepoEntry, Bool, escaping, MainActor, NSEvent, Void (+5 more)
...
Cohesion: 0.19
Nodes (11): ColorHexRow, PaletteCell, SettingsColorsView, Bool, String, WritableKeyPath, SettingsModel, Any (+3 more)
...
Cohesion: 0.14
Nodes (18): FileNode, Bool, String, FileTreeScanOptions, MatchCategory, exactFilename, filenameContains, filenameContainsTokens (+10 more)
...
Cohesion: 0.12
Nodes (12): KeyRecorderRepresentable, String, Void, OverlayBackground, Context, OverlayBackground, Context, HarnessOverlayBackground (+4 more)
...
### Community 186 - "Error"
Cohesion: 0.11
Nodes (16): Error, InstallError, unsupported, DaemonError, alreadyRunning, bindFailed, listenFailed, socketFailed (+8 more)
...
Cohesion: 0.07
Nodes (28): BrowserPaneRegistry, BrowserPaneView, BrowserProgressLine, BrowserTab, BrowserTabButton, Bool, Double, NSCoder (+20 more)
...
Cohesion: 0.09
Nodes (23): CommandPaletteController, PaletteAction, PaletteCommandConfig, PaletteFileEntry, PaletteFooter, PaletteGrepMatch, PaletteItemRow, PaletteModel (+15 more)
...
Cohesion: 0.15
Nodes (8): RemoteHostsService, RemoteHost, String, RemoteHost, SettingsRemoteView, Bool, RemoteHost, String
...
Cohesion: 0.14
Nodes (12): NSView, DetachedPaneOverlay, Style, detached, reconnectingChip, NSCoder, NSEvent, NSPoint (+4 more)
...
Cohesion: 0.20
Nodes (10): LSPClient, LSPClientError, missingPipe, processNotRunning, serverNotExecutable, Int32, String, Task (+2 more)
...
### Community 266 - ".path"
Cohesion: 0.19
Nodes (5): NSCoder, NSEvent, NSRect, NSTextView, SyntaxTextViewInner
...
Cohesion: 0.13
Nodes (7): PaneBorderStatus, Bool, Command, CommandTarget, HarnessGridTerminal, PaneRect, WindowSession
...
Cohesion: 0.19
Nodes (9): Notification.Name, Bool, NSRange, NSString, URL, Void, SyntaxDefinitionTarget, SyntaxLineNumberGutterView (+1 more)
...
### Community 280 - ".menu"
Cohesion: 0.24
Nodes (5): NSColor, NSStackView, NSTextField, String, NSClickGestureRecognizer
...
Cohesion: 0.31
Nodes (5): NSButton, NSImage, SidebarBadgeView, NSCoder, NSRect
...
Cohesion: 0.12
Nodes (16): AppKit, CoreGraphics, CoreText, HarnessCopyMode, HarnessTerminalEngine, HarnessTerminalRenderer, HarnessTheme, ImageIO (+8 more)
...
Cohesion: 0.30
Nodes (4): HarnessCLI, SessionID, String, Bool
...
Cohesion: 0.28
Nodes (3): Tab, SnapshotQueryFormatterTests, SessionSnapshot
...
Cohesion: 0.06
Nodes (17): HarnessCore, FormatContextBuilder, DaemonSurfaceID, SessionSnapshot, String, Phase67Tests, FormatContextDaemonTests, PaneID (+9 more)
...
Cohesion: 0.22
Nodes (6): MockWebView, Bool, URL, WKNavigation, WebKit, WKWebView
...
Cohesion: 0.10
Nodes (13): MainActor, Void, SessionDividerRowView, SessionGroupHeaderRowView, SessionWorktreeHeaderRowView, SessionWorktreeRowView, NSEvent, NSMenu (+5 more)
...
Cohesion: 0.12
Nodes (18): ClosureTarget, MenuActionTarget, OverlayWindow, Phase67UI, PopupWindow, Bool, Command, NSEvent (+10 more)
...
Cohesion: 0.14
Nodes (11): DesktopNotifier, HarnessPathDisplay, NotificationPresenter, Bool, MainActor, String, Void, UNNotification (+3 more)
...
Cohesion: 0.27
Nodes (7): Page, advanced, appearance, remote, terminal, SettingsRootView, String
...
Cohesion: 0.06
Nodes (30): HarnessSidebarPanelViewController, CGFloat, NSMenuItem, NSView, SessionGroup, String, HarnessSidebarPanelViewController, NSMenu (+22 more)

### Community 621 - "ViEngine"
Cohesion: 0.09
Nodes (10): ScreenPos, bottom, middle, top, Bool, String, ViEngine, HarnessCLI (+2 more)
...
Cohesion: 0.22
Nodes (6): SliderRow, ClosedRange, Double, String, SettingsKeysView, SwiftUI
...
Cohesion: 0.09
Nodes (16): ResizeHUDView, DispatchWorkItem, NSCoder, NSColor, NSPoint, NSRect, TimeInterval, InputGate (+8 more)
...
Cohesion: 0.15
Nodes (11): LegacyHarnessSettingsCodingKeys, commandFinishedNotifications, tmuxControlsEnabled, ResizeOverlayMode, afterFirst, always, never, ResizeOverlayPosition (+3 more)
...
### Community 688 - ".hold"
Cohesion: 0.29
Nodes (4): SettingsAppearanceView, Bool, T, WritableKeyPath
...
Cohesion: 0.20
Nodes (6): HarnessWindow, NSEvent, MainWindowController, Any, NSRect, NSWindowController
...
Cohesion: 0.31
Nodes (6): JSONRPCError, HarnessBrowserTools, Bool, Double, String, TimeInterval

### Community 715 - "[3.5.0] - 2026-06-20"
Cohesion: 0.29
Nodes (3): DispatchWorkItem, String, StyledSegment
...
### Community 743 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.40
Nodes (4): Dispatch, Charset, ascii, decSpecialGraphics

### Community 746 - ".hitTest"
Cohesion: 0.50
Nodes (4): PaletteMode, errors, grep, normal

### Community 759 - "DiffLineType"
Cohesion: 0.50
...
Cohesion: 0.07
Nodes (30): Darwin, Glibc, DaemonClientError, connectionFailed, timeout, unexpectedResponse, writeFailed, Endpoint (+22 more)
...
Cohesion: 0.09
Nodes (19): SessionStore, DispatchWorkItem, SessionSnapshot, TimeInterval, PendingVersionBanner, welcome, whatsNew, State (+11 more)

### Community 3419 - "Page"
Cohesion: 0.19
Nodes (5): SettingsHostingController, SettingsWindowController, NSCoder, NSWindow, NSAppearance

## Knowledge Gaps
- **3720 isolated node(s):** `unsupportedPlatform`, `unmodified`, `modified`, `added`, `deleted` (+3715 more)
...
- **Why does `Int` connect `Int` to `Changelog Archive`, `ThemeDocument`, `EngineConformanceTests`, `AgentNotchRootView`, `HarnessDaemonTools`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `PasteController`, `Kind`, `VTParser`, `HarnessTerminalSurfaceView`, `MetalRendererTests`, `HarnessChrome`, `UInt32`, `HarnessTerminalSurfaceView`, `.request`, `RGBColor`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `LegacySnapshot`, `DaemonClient`, `.encode`, `TerminalColorGamut`, `HarnessSettings`, `harness.resource`, `HarnessSidebarPanelViewController.swift`, `CodingKeys`, `RenderSchedulerTests`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `[3.12.0] - 2026-06-30`, `DaemonServer`, `HarnessSplitView`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `PasteBufferStore`, `ViEngine`, `ComposedCell`, `.text`, `PrefixKeymap`, `[2.2.3] - 2026-06-09`, `worktree_isolation_cli.robot`, `.compose`, `ImportedTerminalConfig`, `OptionStore`, `TerminalProtocolCompatibilityTests`, `DaemonSubscription`, `KeyRecorderView.swift`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `WrapperOptionBehavior`, `SessionCoordinator`, `HarnessTerminalSurfaceView`, `.cursorPos`, `MenuBarController`, `TerminalModes`, `AttachInputBatcher`, `.testRenderEncodeIncrementalDamage160x48`, `.dispatch`, `MainSplitViewController`, `AnyCodable`, `Changelog`, `AgentNotchViewModel`, `NSView`, `DamageTrackingTests`, `[1.3.0-vit] - 2026-06-06`, `.testBuildShiftedMatchesFullBuildAcrossScrollWalk`, `.makeSnapshot`, `HarnessGridTerminal`, `.decodeKeySpec`, `.encode`, `SessionGroup`, `[3.0.0] - 2026-06-15`, `WorkspaceFileTreeView`, `ViEngine`, `Pipe`, `String`, `p12_mcp.robot`, `.path`, `HistoryRingBuffer`, `GlyphAtlas`, `SwiftUI`, `.write`, `.assertAllPathsAgree`, `AgentHookInstaller`, `.agentJSON`, `[3.10.0] - 2026-06-27`, `CommandTarget`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `TerminalSelection`, `TerminalHostView`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `NotificationEntry`, `New Tab`, `HarnessDaemonToolsTests`, `CompletionPopupView`, `What You Must Do When Invoked`, `PathToken`, `.handle`, `ThaiCombiningMarkTests`, `MatchCategory`, `Toggle Sidebar`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `ActiveTabCloseDisposition`, `FilePreviewCoordinator`, `AgentTableEntry`, `.detect`, `HarnessCLI+Workbench.swift`, `URLDetection`, `ReflowCorpusTests`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `.rects`, `[1.8.0] - 2026-06-07`, `VTConformanceCorpusTests`, `GridCompositorTests`, `TerminalScreen`, `.currentSize`, `[2.1.0] - 2026-06-07`, `SessionSnapshot`, `AppDelegate`, `BrowserPaneView`, `Error`, `[2.2.1] - 2026-06-08`, `ScriptRuntime`, `GlyphRasterizer`, `ResizeHUDView`, `.classify`, `BinaryInstallerVersionTests`, `HarnessBrowserTools`, `PaletteModel`, `[3.5.0] - 2026-06-20`, `CopyModeState`, `[3.9.5] - 2026-06-26`, `scheduleRender`, `HarnessCLI`, `PaneTarget`, `.translate`, `CellColorResolverTests`, `GridCompositor`, `ScrollbackFile`, `AgentNotchRowSummary`, `.parse`, `CellColorResolver`, `.resolve`, `ANSIPalette`, `.configureEnvironment`, `CLAUDE.md`, `HarnessGridTerminalTests`, `extraction-spec.md`, `TerminalMetalRenderer`, `PaneBorderStatus`, `ThemeDocumentTests`, `FormatContextDaemonTests`, `DaemonMetrics`, `skill-trigger.py`, `ReflowPreviewTests`, `SessionCoordinator`, `Split Right`, `BoardViewController`, `DaemonSyncService`, `FileEditorView`, `.welcome`, `HarnessSidebarPanelViewController`, `.apply`, `.path`, `WindowSession`, `StatusLineView.swift`, `SGRMouseEvent`, `SyntaxTextView`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `RemoteHostStoreTests`, `FormatColor`, `.apply`, `StatusLineWidthTests`, `Process`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `ThemeDiagnostics`, `.encodeMouse`, `TargetSpec`, `skipUnlessLiveDaemonTests`, `.compute`, `FrameSignposter`, `Send Ex Command`, `AgentSnapshot`, `LayoutNode`, `WorkspaceSymbolIndex`, `.drawGlyph`, `RealPty`, `ImageProtocolTests.swift`, `Foundation`, `FileViewerViewController`, `Page`, `.moveSelection`, `DaemonLifecycleTests`, `.clampedBlur`, `.init`, `.moveActiveSession`, `.setCellPixelSize`, `DaemonStats`, `Tab`, `DynamicInstanceBuffer`, `.run`, `Identifiable`, `SurfaceProgressTrackerTests.swift`, `PromptQueue`, `ThaiClusterRenderTests`, `.selectAdjacentSession`, `HarnessCLITests`, `.moveActiveSession`, `.cursorBackwardTabs`, `.navigateCurrentFile`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `CopyModeLine`, `HarnessCore`, `.initialState`, `WaitForRegistry`, `SessionEditor`, `.init`, `AgentIconRenderer`, `Section`, `RecordSession`, `FormatContext`, `RecordingEvent`, `ReflowFastPathTests`, `HarnessOnboarding`, `.steps`, `ScrollbackTests`, `terminal-cheat-sheet.html`, `release.yml`, `Fixed`, `ThaiClusterCopyTests.swift`?**
  _High betweenness centrality (0.262) - this node is a cross-community bridge._
- **Why does `Foundation` connect `settings.json` to `Changelog Archive`, `CodingKey`, `ThemeDocument`, `LSPMessage`, `PerformanceBenchmarks`, `KittyKeyboardTests`, `VTParser`, `MetalRendererTests`, `UInt32`, `OnboardingEnvironment`, `SplitPaneCoordinator`, `SemanticPromptTests`, `Sendable`, `Equatable`, `DaemonClient`, `String`, `[3.12.0] - 2026-06-30`, `CodingKeys`, `RenderSchedulerTests`, `.buildCommand`, `.normalizedKey`, `HookEvent`, `DaemonServer`, `ThemeCatalogEmbedTests`, `EngineConformanceTests.swift`, `PasteBufferStore`, `FrecencyDirectoryStore`, `CLAUDE.md`, `ComposedCell`, `[3.10.0] - 2026-06-27`, `HarnessCLI+Server.swift`, `TerminalProgressReport`, `ShellIntegration`, `String`, `worktree_isolation_cli.robot`, `ImportedTerminalConfig`, `ScriptSnapshotModels.swift`, `[3.8.0] - 2026-06-22`, `LayoutTemplate`, `OptionStore`, `Endpoint`, `TerminalProtocolCompatibilityTests`, `NodeRow`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `.load`, `TerminalModes`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `DaemonLauncher`, `Recipe`, `ScriptFileWatcher`, `CommandFinishedTests`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `.decodeKeySpec`, `CopyModeAction.swift`, `.makeSnapshot`, `NotificationCoordinator`, `.encode`, `SessionGroup`, `PaneNode`, `HarnessGridTerminal`, `String`, `HistoryRingBuffer`, `[3.10.0] - 2026-06-27`, `.write`, `ToolRegistry.swift`, `.load`, `stability_release.robot`, `CommandTarget`, `PtyDrainCeilingBenchmark`, `[3.10.1] - 2026-06-27`, `TerminalHostView`, `CopyModeGridSource`, `DecodedImage`, `.decode`, `EnvironmentStore`, `HarnessDaemonToolsTests`, `[3.1.2] - 2026-06-16`, `PathToken`, `.handle`, `Int`, `ThaiCombiningMarkTests`, `[3.9.0] - 2026-06-22`, `[3.9.1] - 2026-06-22`, `MatchCategory`, `AgentKind`, `What You Must Do When Invoked`, `[3.11.6] - 2026-06-29`, `Workspace`, `.detect`, `ActiveTabCloseDisposition`, `[3.5.0] - 2026-06-20`, `AgentTableEntry`, `HarnessCLI+Workbench.swift`, `TreeSitterGrammarBundle`, `URLDetection`, `[3.9.5] - 2026-06-26`, `.status`, `.rects`, `VTConformanceCorpusTests`, `GridCompositorTests`, `TerminalScreen`, `LSPServerRegistry`, `generate-release-notes.swift`, `SessionSnapshot`, `Error`, `ScrollbackFile.swift`, `OutputTrigger`, `GlyphRasterizer`, `AgentSessionSummary.swift`, `.classify`, `FileTabManager`, `BinaryInstallerVersionTests`, `HarnessBrowserTools`, `CopyModeState`, `HarnessCLI`, `[3.9.5] - 2026-06-26`, `Identifiers.swift`, `SettingsRemoteView`, `[2.4.0] - 2026-06-12`, `PaneTarget`, `NotchLayoutMetrics`, `Hermes → Harness`, `Fixed`, `GridCompositor`, `Result`, `Section`, `AgentNotchRowSummary`, `.parse`, `graphify reference: add a URL and watch a folder`, `.resolve`, `FileChangeWatcher`, `graphify reference: commit hook and native CLAUDE.md integration`, `SSHTunnelManagerTests`, `CellColorResolver`, `ANSIPalette`, `graphify reference: incremental update and cluster-only`, `WorkbenchCommand`, `TerminalBlockStoreTests`, `.make`, `TerminalMetalRenderer`, `PaneBorderStatus`, `ClipboardOSCTests`, `AgentBridge`, `graphify reference: commit hook and native CLAUDE.md integration`, `FormatContextDaemonTests`, `DaemonMetrics`, `report.html`, `HarnessTerminalSurfaceWorkerTests`, `Split Right`, `BoardViewController`, `DaemonSyncService`, `GitMetadataProvider`, `FileEditorView`, `ThemeFileServiceTests`, `.install`, `SGRMouseEvent`, `KeySpec`, `.run`, `RemoteHostStoreTests`, `FormatColor`, `graphify reference: GitHub clone and cross-repo merge`, `AgentHookStrategy`, `GitHubCLIClient`, `NotificationBus`, `jobs`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `ThemeDiagnostics`, `.terminalHost`, `.script`, `skipUnlessLiveDaemonTests`, `Send Ex Command`, `AgentSnapshot`, `LayoutNode`, `WorkspaceSymbolIndex`, `.theme`, `RealPty`, `ImageProtocolTests.swift`, `CommandExecutionError`, `Foundation`, `Added`, `FileViewerViewController`, `[3.2.0] - 2026-06-16`, `DaemonLifecycleTests`, `.deepMerge`, `SurfaceProgressTracker`, `.handleCat`, `State`, `RGBColor`, `generate-cheatsheet.js`, `[2.2.4] - 2026-06-11`, `DaemonStats`, `Tab`, `.encode`, `DynamicInstanceBuffer`, `.run`, `.install`, `PromptQueue`, `Darwin`, `HarnessCLITests`, `TerminalDamage.swift`, `FilePreviewCoordinatorTabScopeTests`, `HarnessCore`, `AgentVectorIcon`, `WaitForRegistry`, `RemoteHostStore`, `.run`, `RecordSession`, `FormatContext`, `.encode`, `RecordingEvent`, `.evaluateStyled`, `HarnessOnboarding`, `.install`, `SystemdUserInstaller`, `release.yml`, `RemoteHostsService`, `ThaiClusterCopyTests.swift`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `HarnessCore` connect `HarnessCore` to `graphify reference: extra exports and benchmark`, `AgentNotchRootView`, `PasteController`, `ShellCompletionInstallerTests`, `HarnessSettingsTests.swift`, `MetalRendererTests`, `OnboardingEnvironment`, `SplitPaneCoordinator`, `.request`, `TabAlertTests`, `SessionGroupHeaderRowView`, `RGBColor`, `.parse`, `Equatable`, `LegacySnapshot`, `MenuTarget`, `NSObject`, `.encode`, `DaemonClient`, `DesktopNotifier`, `TerminalColorGamut`, `harness.resource`, `[3.12.0] - 2026-06-30`, `.normalizedKey`, `HookEvent`, `DaemonServer`, `TerminalTabBarView.swift`, `TabCell`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `PasteBufferStore`, `FrecencyDirectoryStore`, `HarnessCLI+Server.swift`, `TerminalProgressReport`, `ShellIntegration`, `ImportedTerminalConfig`, `ScriptSnapshotModels.swift`, `.parse`, `Endpoint`, `NodeRow`, `HarnessDesign`, `DaemonSubscription`, `LSPClient`, `LSPDiagnostic`, `HarnessPaths`, `MenuBarController`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `DaemonLauncher`, `MainSplitViewController`, `Recipe`, `AgentNotchViewModel`, `NSView`, `ViEngine`, `.decodeKeySpec`, `[2.5.0] - 2026-06-12`, `NotificationCoordinator`, `.encode`, `graphify reference: query, path, explain`, `[3.0.0] - 2026-06-15`, `WorkspaceFileTreeView`, `ViEngine`, `Pipe`, `String`, `ToolRegistry.swift`, `.write`, `.load`, `[3.10.1] - 2026-06-27`, `graphify reference: query, path, explain`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `TerminalHostView`, `CopyModeGridSource`, `.decode`, `TriState`, `NotificationEntry`, `EnvironmentStore`, `[3.1.2] - 2026-06-16`, `HarnessDaemonToolsTests`, `What You Must Do When Invoked`, `.handle`, `[3.3.0] - 2026-06-18`, `ThaiCombiningMarkTests`, `MatchCategory`, `AgentKind`, `What You Must Do When Invoked`, `TerminalFindBar`, `[3.11.6] - 2026-06-29`, `CommandPromptController`, `ActiveTabCloseDisposition`, `AgentTableEntry`, `[3.5.0] - 2026-06-20`, `HarnessCLI+Workbench.swift`, `.status`, `BinaryRefresherTests`, `.rects`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `Error`, `AppDelegate`, `BrowserPaneView`, `ScrollbackFile.swift`, `ScriptRuntime`, `[2.5.1] - 2026-06-12`, `[3.2.0] - 2026-06-16`, `AgentSessionSummary`, `MainWindowController`, `FileTabManager`, `.classify`, `HarnessBrowserTools`, `PaletteModel`, `HarnessCLI`, `[2.4.0] - 2026-06-12`, `SettingsRemoteView`, `PaneDropZoneOverlay`, `NotchLayoutMetrics`, `Fixed`, `GridCompositor`, `Section`, `AgentNotchRowSummary`, `ANSIPalette`, `SSHTunnelManagerTests`, `ExternalOpenKind`, `.make`, `graphify reference: commit hook and native CLAUDE.md integration`, `AgentBridge`, `FileNode`, `FormatContextDaemonTests`, `SessionCoordinator`, `NSViewRepresentable`, `BoardViewController`, `DaemonSyncService`, `.install`, `HarnessSidebarPanelViewController`, `StatusLineView.swift`, `SGRMouseEvent`, `KeySpec`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `[1.5.1] - 2026-06-06`, `.run`, `DisplayPanesOverlay`, `RemoteHostStoreTests`, `AgentHookStrategy`, `StatusLineWidthTests`, `Process`, `JSONDecoder`, `AgentApprovalBar`, `settings.json`, `jobs`, `.parse`, `.terminalHost`, `RegressionBugFixTests`, `.script`, `skipUnlessLiveDaemonTests`, `Send Ex Command`, `AgentSnapshot`, `LayoutNode`, `WorkspaceSymbolIndex`, `FloatingPaneController`, `worktree_isolation.robot`, `.theme`, `RealPty`, `Foundation`, `FileViewerViewController`, `Page`, `DaemonLifecycleTests`, `[3.2.0] - 2026-06-16`, `.deepMerge`, `SurfaceProgressTracker`, `State`, `DaemonStats`, `.encode`, `.run`, `.install`, `Identifiable`, `PromptQueue`, `Darwin`, `HarnessCLITests`, `.measure`, `FilePreviewCoordinatorTabScopeTests`, `.initialState`, `.run`, `RecordSession`, `FormatContext`, `StartupMetrics`, `.encode`, `HarnessOnboarding`, `.steps`, `AgentHookInstallerTests.swift`, `CommandIPCTranslatorTests.swift`, `CommandParserTests.swift`, `SystemdUserInstaller`, `RemoteHostsService`, `Fixed`, `ThaiClusterCopyTests.swift`, `graphify reference: extra exports and benchmark`, `State`?**
...
- **What connects `unsupportedPlatform`, `unmodified`, `modified` to the rest of the system?**
  _3740 weakly-connected nodes found - possible documentation gaps or missing edges._
