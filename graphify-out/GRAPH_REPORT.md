...
10. `Notification` - bridges 37 areas (67 edges)
...
## Communities (2106 total, 1453 thin omitted)
...
Cohesion: 0.06
Nodes (43): AnyTransition, Color, .hexString, AgentNotchPeekEvent, AgentNotchRootView, .body, .bottomRadius, .closedAccessibilityLabel (+35 more)
...
Cohesion: 0.08
Nodes (33): KouenGridTerminal, BlockSelection, CursorRender, CursorStyle, bar, block, underline, FrameBuilder (+25 more)
...
Cohesion: 0.07
Nodes (19): AutomationScheduler, DispatchSourceTimer, DaemonCommandExecutor, Command, BellScanState, esc, normal, string (+11 more)
...
Cohesion: 0.02
Nodes (98): _2t(), a2n(), a6e(), ake(), amn(), B0, b6(), BBe() (+90 more)

### Community 22 - "CopyModeAction"
Cohesion: 0.01
Nodes (547): _0t(), _1n(), _3n(), _5n(), _6e(), _6n(), _9e(), a2() (+539 more)
...
Cohesion: 0.08
Nodes (38): aR(), copy(), cYt(), DGt(), dje(), dm(), FRt(), FX() (+30 more)
...
### Community 28 - ".parse"
Cohesion: 0.03
Nodes (278): pe(), r, X(), A(), code(), R(), a(), aDt() (+270 more)

### Community 30 - "Notification"
Cohesion: 0.15
Nodes (8): BrowserPaneView, .init(title:isActive:onSelect:onClose:), Any, Bool, NSPopover, String, TimeInterval, NSAppearance
...
### Community 32 - ".addTab"
Cohesion: 0.09
Nodes (22): .onSelect, FleetRowView, .body, .statusColor, .statusDot, .subtitle, FleetView, .body (+14 more)
...
Cohesion: 0.04
Nodes (68): _8n(), a4e(), a9e(), aae(), aXe(), bee(), c_n(), cae() (+60 more)
...
Cohesion: 0.20
Nodes (14): AutomationsFleetModel, .load(detectScheduledRuns:), AutomationSource, daemon, launchAgent, FleetJobItem, .isActive, .launchAgentScriptPath (+6 more)
...
Cohesion: 0.09
Nodes (29): TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid, .init(themeName:fontFamily:fontSize:vivid:colorRendering:colorGamut:offMainParserFramePipeline:liveResizeReflow:) (+21 more)
...
Cohesion: 0.11
Nodes (33): _3e(), dmn(), dTn(), Etn(), i0(), iAn(), kft(), kMt() (+25 more)
...
### Community 64 - ".text"
Cohesion: 0.09
Nodes (26): _5e(), ast(), bXe(), cmn(), d4n(), g3e(), j8e(), jTn() (+18 more)
...
Cohesion: 0.06
Nodes (58): A1(), aw(), awt(), b2(), bMt(), bw(), Cf(), cFt() (+50 more)
...
Cohesion: 0.02
Nodes (106): _4e(), a0(), a8n(), ag(), b6n(), bce(), bkn(), bwn() (+98 more)
...
Cohesion: 0.08
Nodes (26): LSPFileSession, Never, String, Task, URL, Void, Error, object (+18 more)
...
Cohesion: 0.08
Nodes (37): a6(), CWt(), dUe(), eJ(), EWt(), eYt(), fme(), fUe() (+29 more)
...
Cohesion: 0.06
Nodes (15): KouenTerminalKit, NSPasteboard, URL, NSPasteboard, KouenTerminalSurfaceDragDropTests, KouenTerminalSurfaceFocusTests, OcclusionTests, NSWindow (+7 more)
...
Cohesion: 0.03
Nodes (83): aat(), aoe(), AS(), bR(), c5n(), cc(), d2(), d6() (+75 more)
...
Cohesion: 0.08
Nodes (12): SessionCoordinator, .selectWorkspace(byIndex:), Bool, Double, PaneID, PaneNode, SplitDirection, String (+4 more)
...
Cohesion: 0.07
Nodes (15): KouenCLITests, URL, DetachKeys, absent, invalid, parsed, UInt8, KouenFilePreviewLoader (+7 more)
...
Cohesion: 0.08
Nodes (28): ase(), aTn(), aV(), bb(), cce(), ef(), f4n(), fOn() (+20 more)
...
Cohesion: 0.11
Nodes (21): aXt(), AYt(), Cme(), DYt(), EUe(), IR(), IUe(), j9n() (+13 more)
...
Cohesion: 0.07
Nodes (22): .init(coder:), BrowserProgressLine, .init(coder:), .init(frame:), BrowserTabButton, .init(coder:), DesignModeElementInfo, DesignModePopoverViewController (+14 more)

### Community 159 - "MatchCategory"
Cohesion: 0.10
Nodes (17): .agentColorBinding, colors, ANSIPalette, CellColorResolver, MochaTheme, ResolvedCellColors, .init(hex:), .init(red:green:blue:alpha:) (+9 more)
...
Cohesion: 0.20
Nodes (14): BrowserSnapshotAck, agentWaitChannel(), BrowserElement, BrowserElementBounds, BrowserSnapshot, BufferSummary, HookEntry, IPCResponse (+6 more)
...
Cohesion: 0.08
Nodes (16): Kind, primary, secondary, KouenDesign, KouenPillButton, .init(title:kind:), .isHovered, .isPressed (+8 more)

### Community 197 - "AgentSessionSummary"
Cohesion: 0.10
Nodes (19): OverlayBackground, Context, OverlayBackground, Context, .init(frame:), ChromeBackdrop, .init(role:), KouenOverlayBackground (+11 more)
...
Cohesion: 0.09
Nodes (20): AgentSessionHistoryModel, .hasMoreToLoad, .minimumWindowStart, .searchQuery, .selectedScope, .windowedRecords, AgentSessionHistoryView, .body (+12 more)

### Community 245 - "ThemeDocumentTests"
Cohesion: 0.09
Nodes (50): Ame(), aQt(), Cqt(), CUe(), cXt(), een(), Eme(), eVe() (+42 more)
...
Cohesion: 0.12
Nodes (13): ContentAreaViewController, HitTestPassthroughView, PaneContainerView, .init(node:cwd:themeName:existingHosts:existingBrowserPanes:), .init(paneID:), Bool, CGFloat, NSPoint (+5 more)
...
Cohesion: 0.22
Nodes (11): KouenChrome, KouenChromePalette, Bool, CGFloat, NSColor, String, DirectoryPickerFooter, .body (+3 more)
...
Cohesion: 0.15
Nodes (13): .groupedRecords, .body, MainActor, Void, Group, PrefixCheatsheetWindow, .groups, PrefixIndicatorWindow (+5 more)
...
Cohesion: 0.19
Nodes (9): PaletteModel, PalettePanel, .canBecomeKey, PaletteRow, header, PaletteView, .body, Bool (+1 more)
...
Cohesion: 0.12
Nodes (7): KouenPaths, SessionStore, DispatchWorkItem, TimeInterval, MobileBridgeSpawnTests, String, URL
...
### Community 360 - "State"
Cohesion: 0.06
Nodes (39): a0n(), ble(), c6(), cke(), cV(), dl(), dx(), eAn() (+31 more)
...
Cohesion: 0.25
Nodes (5): PaletteAction, PaletteFileEntry, PaletteGrepMatch, String, Void
...
Cohesion: 0.05
Nodes (24): Am(), bUt(), bze(), Cm(), EQ(), fQ, Gbe(), GUt (+16 more)
...
Cohesion: 0.33
Nodes (4): .activeTab, BrowserTab, UUID, tabs

### Community 391 - "AppKit + Metal Patterns"
Cohesion: 0.15
Nodes (16): New Tab, Cmd T Creates New Session, CLI Isolate Creates Worktree And Session, CLI Isolate With Custom Branch Name, Close Session Keeps Dirty Worktree, Close Session Removes Clean Worktree, Create Isolated Session And Select, Drag Reorder Past Worktree Row No Crash (+8 more)
...
Cohesion: 0.09
Nodes (24): Endpoint, EndpointError, connectionFailed, .description, notYetSupported, pathTooLong, String, EndpointConnector (+16 more)
...
### Community 451 - ".run"
Cohesion: 0.16
Nodes (11): .init(frame:), NSHostingView, NSLayoutConstraint, NSRect, Tab, TerminalTabBarView, .delegate, .init(frame:) (+3 more)

### Community 452 - "tmux parity — status, adaptations, and deliberate divergences"
Cohesion: 0.13
Nodes (23): aJ(), bXt(), cJ(), dXt(), F0(), fXt(), gXt(), HUe() (+15 more)
...
Cohesion: 0.04
Nodes (74): AgentRow, .agentColor, .executables, .hookButton, .hookButtonTitle, HookState, failed, idle (+66 more)
...
Cohesion: 0.26
Nodes (4): DataBox, Any, GitPanelViewDiffErrorTests, String
...
Cohesion: 0.06
Nodes (37): CustomStringConvertible, Darwin, Foundation, Glibc, KouenCore, KouenDaemonCore, DaemonClientError, connectionFailed (+29 more)
...
Cohesion: 0.09
Nodes (27): eGt(), en(), gC(), gk(), GOt(), hhn(), Ije(), iXt() (+19 more)
...
Cohesion: 0.06
Nodes (44): AgentChipView, .init(coder:), .intrinsicContentSize, .init(coder:), ChromeRole, sidebar, tabBar, Divider (+36 more)

### Community 523 - ".encode"
Cohesion: 0.12
Nodes (9): OptionSet, .description, .init(from:), .init(key:modifiers:), Modifiers, Decoder, String, UInt8 (+1 more)
...
Cohesion: 0.11
Nodes (19): Any, center, ClosureTarget, MenuActionTarget, OverlayWindow, .canBecomeKey, Phase67UI, PopupWindow (+11 more)
...
Cohesion: 0.02
Nodes (434): l, em(), z(), _4n(), _7n(), a1t(), a7n(), aA() (+426 more)
...
Cohesion: 0.23
Nodes (5): UUID, BrowserPaneRegistry, NSWindow, PaneID, WeakBrowserPaneView
...
Cohesion: 0.17
Nodes (11): BrowserNetworkEntry, BrowserResponsePayload, cookies, error, network, ok, open, screenshot (+3 more)
...
Cohesion: 0.20
Nodes (9): PaletteCommandConfig, PaletteFooter, .body, PaletteMode, errors, grep, normal, PaletteSectionHeader (+1 more)
...
Cohesion: 0.13
Nodes (12): InputGate, .siblings, SurfaceIO, .currentSubscription, FormatColor, KouenSettings, String, SurfaceID (+4 more)
...
Cohesion: 0.25
Nodes (8): bvt(), hyn(), m2t(), QBt(), sO(), sPt(), uct(), zhn()
...
### Community 782 - "qk"
Cohesion: 0.02
Nodes (221): a(), b(), c(), d(), e(), f(), g(), h() (+213 more)
...
### Community 806 - "PaletteItemRow"
Cohesion: 0.50
Nodes (4): PaletteItemRow, .body, AttributedString, NSColor

### Community 809 - "CodingKeys"
Cohesion: 0.40
...
### Community 817 - "TerminalColorRole"
Cohesion: 0.40
...
Cohesion: 0.10
Nodes (23): KeybindingsService, Bool, Command, String, KeySpec, Binding, .init(from:), .init(spec:command:note:repeatable:) (+15 more)

## Knowledge Gaps
- **3510 isolated node(s):** `AppIntents`, `noActivePane`, `.localizedStringResource`, `horizontal`, `vertical` (+3505 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1453 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `code:text (:workbench start swift)` to `callingPaneTarget`, `graphify reference: extra exports and benchmark`, `.handleNormal`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `AnyCodable`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `RealPtyLifecycleTests`, `FileTreeKeyboardNavigator`, `VTParser`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `.recordReapedGenerationForTesting`, `HarnessChrome`, `SplitPaneCoordinator`, `.readGrid(scrollbackOffset:)`, `WorktreeManager`, `Harness tmux-style capabilities`, `SessionGroupHeaderRowView`, `NSObject`, `.init`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `.bufferLine`, `.characterIndex`, `MenuTarget`, `Task Ledger Archive (Tasks 1–50)`, `HarnessSettings`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `.normalizedKey`, `.keyEvent`, `.handleWake`, `HarnessSplitView`, `TabCell`, `KouenOverlayBackground`, `CommandHistorySearchController`, `3.2 สิ่งที่ implement แล้ว`, `ViEngine`, `FrecencyDirectoryStore`, `generate-release-notes.swift`, `HarnessCLI+Server.swift`, `ShellIntegrationTests`, `PasteBufferStore`, `worktree_isolation_cli.robot`, `WorkbenchMRU`, `p44-mobile-agent-inbox-design.html`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `HarnessDesign`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `HarnessPaths`, `HarnessTerminalSurfaceView`, `TerminalModes`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `FormatContextDaemonTests`, `.dispatch`, `ScriptRuntime.swift`, `.installCLI`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `Session Grouping and Split Session Plan`, `domain-design.md`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `SoftIconButton`, `[1.3.0-vit] - 2026-06-06`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `WorkspaceFileTreeView`, `ViEngine`, `String`, `HistoryRingBuffer`, `GlyphAtlas`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `.load`, `.startWatching`, `PtyDrainCeilingBenchmark`, `RGBColor`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `TriState`, `Community None`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `Added`, `MatchCategory`, `What You Must Do When Invoked`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `WriteOutcome`, `ActiveTabCloseDisposition`, `AgentTableEntry`, `TransportError`, `URLDetection`, `ImportedTerminalConfig`, `New Tab`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `Added`, `FormatStringExtendedVariableTests`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `P25 — iOS/iPadOS Support`, `LSPServerRegistry`, `SessionSnapshot`, `AppDelegate`, `.init`, `.makeDiffScrollView`, `main.swift`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `GlyphRasterizer`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `BinaryInstaller`, `.classify`, `SwarmFleetView`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `.testNilRequestGetsErrorReplyNotHang`, `DisplayWidth`, `PaneTarget`, `ColorKind`, `.lines`, `.handleUndo`, `GridCompositor`, `ScrollbackFile`, `Prompt`, `TerminalServicesProvider`, `ResizeDirection`, `ImageTextureCache`, `SSHTunnelManagerTests`, `ExternalOpenKind`, `WorkbenchCommand`, `.make`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `PanePipe`, `FileNode`, `azt`, `ReflowPreviewTests`, `HarnessTerminalSurfaceWorkerTests`, `cqe`, `workspace`, `release-hotfix.sh`, `GitMetadataProvider`, `WindowTitleStripView`, `ThemeFileServiceTests`, `.install`, `HarnessSidebarPanelViewController`, `.path`, `ScrollbackPersistenceTests`, `DefaultTerminalManager`, `WindowSession`, `StatusLineView.swift`, `DisplayWidth`, `[2.5.0] - 2026-06-12`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `DecodedWSFrame`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `Fixes Applied (layered)`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.script`, `TerminalColorRole`, `FrameSignposter`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `code:bash (# In a Harness pane:)`, `DesktopNotifier`, `LayoutNode`, `.theme`, `.drawGlyph`, `Added`, `.makeModel`, `CommandExecutionError`, `Foundation`, `code:bash (harness-cli install-hooks openclaw)`, `FileViewerViewController`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.handleCat`, `[3.5.1] - 2026-06-20`, `FormatStyledSegment.swift`, `generate-cheatsheet.js`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `Git Panel`, `P13 — Embedded Browser Pane (cmux parity)`, `ScrollReuseTests`, `SurfaceProgressTrackerTests.swift`, `NSTextField Leak in BoardViewController (P20 Performance)`, `Darwin`, `UI Automation — Robot Framework (P18)`, `PresentAttempt`, `AgentIconRenderer`, `markdown.json`, `RealPtyLifecycleTests`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `SixelDecoder`, `.delay`, `Case: cwd "bleed" — session worktree jumps to wrong dir during builds`, `BoardCardView`, `PathToken`, `SessionEditor`, `GroupedSessionDaemonTests`, `main.swift`, `Section`, `Modifiers`, `PaletteMode`, `PresentAttempt`, `SessionCoordinator.swift`, `.recordReapedGenerationForTesting`, `RunState`, `.deinit`, `DispatchTime`, `HarnessOnboarding`, `Added`, `ScrollbackTests`, `Command Prompt Architecture`, `.testKouenRendererFixtureDefaultTextReportsPlausibleGlyphStats`, `ccRunCancel`, `ccRunGet`, `Added`, `.bind`, `.automationList`, `.json`, `.panePathLookup`?**
  _High betweenness centrality (0.266) - this node is a cross-community bridge._
- **Why does `AgentSessionSummary` connect `Terminal AI Chat (⌘I inline overlay)` to `worktree_isolation_cli.robot`, `Changelog`, `Added`, `.parse`, `Consumers`, `code:text (:workbench start swift)`, `.deinit`, `.hideFind`, `LaunchdServiceInstaller`, `HarnessUILibrary`, `PaneNode`, `TerminalGridCell`, `Community None`, `RemoteHostStore`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`?**
  _High betweenness centrality (0.193) - this node is a cross-community bridge._
- **Why does `fbt()` connect `TaskDashboardBody` to `Changelog`, `4. Technical Architecture`, `CopyModeAction`, `qk`?**
