# Graph Report - kouen-terminal  (2026-09-15)

## Corpus Check
- 809 files · ~926,995 words
...
10. `Notification` - bridges 36 areas (63 edges)
...
## Communities (2182 total, 1581 thin omitted)
...
Cohesion: 0.06
Nodes (24): DaemonClient, ClaudeCodeHarnessIPCTests, String, URL, DaemonBrowserRoutingTests, String, URL, ConcurrentIndexSet (+16 more)

### Community 5 - "IPCRequest"
Cohesion: 0.06
Nodes (29): .start(onResponse:onEnd:), Int32, String, TimeInterval, UInt16, UUID, Void, Data (+21 more)

### Community 6 - "AgentNotchRootView"
Cohesion: 0.05
Nodes (50): AnyTransition, AnyView, AgentNotchRootView, .body, .bottomRadius, .closedAccessibilityLabel, .closedTransition, .closedView (+42 more)
...
Cohesion: 0.12
Nodes (13): .addSurface(tabID:paneID:), .addSurface(to:paneID:surfaceID:cwd:), .tab(containingPaneID:), .tab(forSurfaceKey:), .tabIndex(surfaceKey:), .tabIndex(workspaceID:tabID:), Bool, Date (+5 more)
...
Cohesion: 0.05
Nodes (40): RGBColor, TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid (+32 more)
...
Cohesion: 0.11
Nodes (47): aVe(), b(), Bje(), cVe(), DJt(), dzt(), Ejt(), FR() (+39 more)
...
Cohesion: 0.03
Nodes (78): a4e(), ag(), agt(), avt(), bce(), c8n(), cSn(), ctn() (+70 more)
...
Cohesion: 0.08
Nodes (37): DaemonSubscription, .start(onData:onEnd:buffered:), Bool, UInt64, decodeBoundedCString(), ignoreSIGPIPE(), makeUnixStreamSocket(), setNoSigPipe() (+29 more)
...
Cohesion: 0.06
Nodes (40): .init(entry:), AgentChipView, .intrinsicContentSize, ChromeRole, sidebar, tabBar, Divider, FontSize (+32 more)

### Community 22 - "CopyModeAction"
Cohesion: 0.01
Nodes (545): _0t(), _1n(), _2t(), _3n(), _4e(), _5e(), _5n(), _6e() (+537 more)
...
Cohesion: 0.08
Nodes (17): Command, BellScanState, esc, normal, string, stringEsc, PanePipe, SurfaceMonitor (+9 more)
...
Cohesion: 0.05
Nodes (24): Bool, NSObjectProtocol, Set, String, Tab, TabID, WorktreeAutoIsolateService, Range (+16 more)
...
Cohesion: 0.09
Nodes (25): CKouenSys, ClientRecord, CountBox, DaemonError, alreadyRunning, bindFailed, .description, listenFailed (+17 more)
...
Cohesion: 0.06
Nodes (24): DaemonClientActor, TimeInterval, DaemonSessionService, .endpoint, .request(_:timeout:), Bool, TimeInterval, Endpoint (+16 more)

### Community 47 - ".normalizedKey"
Cohesion: 0.05
Nodes (71): a7e(), AS(), cc(), d2(), dce(), e6(), ec(), eOn() (+63 more)
...
Cohesion: 0.10
Nodes (9): SessionEditor, .tabIndex(surfaceID:), SessionID, Phase67Tests, SessionPersistenceTests, Bool, String, TabID (+1 more)
...
Cohesion: 0.07
Nodes (29): #badge-count, #bottom-sheet, #btn-multi-submit, #btn-submit-choice, #btn-voice, #card-1, #card-2, #card-3 (+21 more)
...
Cohesion: 0.02
Nodes (375): l, _4n(), _6n(), a1t(), a_n(), aA(), abn(), abt() (+367 more)
...
Cohesion: 0.08
Nodes (44): Codable, BrowserCookie, BrowserElement, BrowserElementBounds, BrowserNetworkEntry, BrowserRequestPayload, close, cookies (+36 more)
...
Cohesion: 0.05
Nodes (37): o, a9e(), avn(), aXe(), aZ(), bee(), d8e(), Da() (+29 more)
...
Cohesion: 0.06
Nodes (25): SessionStore, DispatchWorkItem, TimeInterval, .tab(for:), DaemonCommandExecutor, SurfaceRegistry, Set, PendingVersionBanner (+17 more)

### Community 99 - ".dispatch"
Cohesion: 0.08
Nodes (45): amn(), cg(), ch(), cvt(), dln(), dV(), e9e(), gU() (+37 more)

### Community 100 - "ScriptRuntime.swift"
Cohesion: 0.13
Nodes (15): .lspPosition(characterOffset:), Equatable, LSPDiagnostic, LSPDiagnosticSeverity, error, hint, information, warning (+7 more)
...
Cohesion: 0.05
Nodes (44): _7n(), b3e(), c6(), calculate(), constructor(), ehn(), gce(), gmn() (+36 more)

### Community 108 - ".resolve"
Cohesion: 0.03
Nodes (232): r, X(), A(), code(), R(), a(), aDt(), ae() (+224 more)
...
Cohesion: 0.08
Nodes (10): ImagePlacement, Pen, SavedCursor, ClosedRange, Range, TerminalGridUnderline, UnsafeBufferPointer, TerminalScreen (+2 more)
...
Cohesion: 0.11
Nodes (22): AtlasEntry, ClusterGlyphKey, GlyphAtlas, .entry(for:), .entry(forCluster:bold:italic:), .entry(forShaped:font:), .stats, GlyphAtlasStats (+14 more)
...
Cohesion: 0.06
Nodes (32): BrowserPaneRegistry, BrowserPaneView, .activeTab, .init(url:paneID:), .init(url:paneID:webView:), .webView(_:createWebViewWith:for:windowFeatures:), .webView(_:didCommit:), .webView(_:didFinish:) (+24 more)
...
Cohesion: 0.06
Nodes (31): Logger, os, OSSignposter, Phase, daemonConnected, firstDrawablePresented, firstSnapshot, firstSurfaceAttached (+23 more)
...
Cohesion: 0.10
Nodes (20): SessionGroup, String, SidebarBadgeLabel, .body, SidebarDividerRow, .body, SidebarGroupHeaderRow, .body (+12 more)
...
Cohesion: 0.09
Nodes (17): .init(coder:), BrowserProgressLine, .init(coder:), .init(frame:), .init(coder:), DesignModePopoverViewController, .init(coder:), .init(title:properties:styles:onStyleChanged:onCopyCSS:) (+9 more)
...
Cohesion: 0.12
Nodes (17): NotificationDropdownPanelView, .acceptsFirstResponder, .cornerConfiguration, .init(coder:), .init(entries:onSelect:onClearAll:onDismiss:), NotificationRowView, .init(coder:), .isHighlighted (+9 more)

### Community 158 - "Harness Terminal — IDE Sidebar Feature Branch"
Cohesion: 0.11
Nodes (28): d2t(), eJ(), fme(), gKt(), gUe(), $He(), ixn(), kGt() (+20 more)
...
Cohesion: 0.09
Nodes (10): NWEndpoint, PairingBox, .current, .isLockedOut, PendingPairing, Bool, Date, NWListener (+2 more)
...
Cohesion: 0.09
Nodes (24): ChecksStatus, fail, none, pass, pending, CIRun, GitHubCLIClient, IssueInfo (+16 more)
...
Cohesion: 0.11
Nodes (6): ISO8601DateFormatter, KouenDaemonTools, .init(client:subscriptionClient:controlEnabled:), Bool, String, UUID
...
### Community 176 - "Added"
Cohesion: 0.05
Nodes (58): A1(), a8n(), aV(), b2(), b6(), bb(), bw(), c8e() (+50 more)
...
Cohesion: 0.07
Nodes (27): BrowserTabButton, .init(title:isActive:onSelect:onClose:), Selector, .init(coder:), .init(frame:), .init(coder:), Kind, primary (+19 more)
...
Cohesion: 0.05
Nodes (52): TerminalGridCell, DecodedImage, .byteCount, UInt8, KouenGridTerminal, Bool, CAMetalDrawable, String (+44 more)
...
Cohesion: 0.08
Nodes (30): CommandPaletteController, PaletteAction, PaletteCommandConfig, PaletteFileEntry, PaletteGrepMatch, PaletteItemRow, PaletteMode, errors (+22 more)

### Community 207 - "scheduleRender"
Cohesion: 0.14
Nodes (8): AgentTable, TimeInterval, ProcessScan, Int32, AgentScanner, Bool, DispatchSourceTimer, TimeInterval
...
### Community 215 - ".lines"
Cohesion: 0.08
Nodes (32): a0n(), dbt(), dhn(), dl(), eAn(), eht(), ewn(), fhn() (+24 more)
...
Cohesion: 0.12
Nodes (14): OverlayBackground, Context, InlineFilePreview, Context, OverlayBackground, Context, NSViewRepresentable, GlassEffectView (+6 more)
...
Cohesion: 0.21
Nodes (6): NSColor, ResolvedCanvas, String, ThemeManager, ThemePreset, ThemeManagerTests
...
Cohesion: 0.09
Nodes (19): .agentColorBinding, SettingsHostingController, .init(coder:), .init(page:), SettingsWindowController, NSCoder, NSWindow, Page (+11 more)

### Community 237 - "TerminalBlockStoreTests"
Cohesion: 0.11
Nodes (12): CGFloat, Bool, CGFloat, NSCoder, NSEvent, NSLayoutConstraint, NSPoint, NSRect (+4 more)
...
Cohesion: 0.12
Nodes (10): TerminalCellWidth, CharacterWidth, Bool, ClosedRange, Unicode, CharacterWidthTable, UInt16, UInt8 (+2 more)
...
Cohesion: 0.13
Nodes (20): Cjt(), H2e(), hR(), jX(), Kje(), KX(), L7(), Ljt() (+12 more)
...
Cohesion: 0.08
Nodes (22): _3e(), aHt(), bme(), bYt(), dTn(), fqt(), hVe(), m1t() (+14 more)

### Community 251 - "SessionCoordinator"
Cohesion: 0.23
Nodes (4): MainActor, Void, NSEvent, NSAnimationContext
...
Cohesion: 0.06
Nodes (31): a0(), b6n(), Bm(), cte(), Em(), g7e(), gkn(), If() (+23 more)
...
Cohesion: 0.12
Nodes (15): AYt(), Cme(), e7e(), EUe(), eYt(), hxn(), Lme(), lxn() (+7 more)
...
Cohesion: 0.15
Nodes (15): KouenChrome, KouenChromePalette, Bool, CGFloat, NSColor, String, PaletteFooter, .body (+7 more)
...
Cohesion: 0.04
Nodes (67): AgentRow, .agentColor, .executables, .hookButton, .hookButtonTitle, SettingsAgentsView, .agentsSection, .notchSection (+59 more)
...
Cohesion: 0.05
Nodes (47): a2(), aAn(), akn(), bln(), bwt(), bYe(), cIn(), d6e() (+39 more)

### Community 286 - "code:bash (harness-cli install-hooks hermes)"
Cohesion: 0.19
Nodes (6): MarkdownPreviewView, Bool, String, URL, KouenSyntaxResources, MarkdownPreviewTests
...
### Community 298 - "jobs"
Cohesion: 0.09
Nodes (58): Ame(), aQt(), aXt(), Cqt(), CUe(), cXt(), DYt(), Eme() (+50 more)
...
Cohesion: 0.14
Nodes (9): GitPanelView, .isHidden, .removeWorktreeAction(path:), GitResult, Bool, DispatchWorkItem, String, ValidateOutcome (+1 more)
...
Cohesion: 0.08
Nodes (28): AppKit, CoreGraphics, CoreText, ImageIO, KouenCopyMode, KouenTerminalEngine, KouenTerminalKit, KouenTerminalRenderer (+20 more)
...
Cohesion: 0.12
Nodes (5): Bool, KouenSettingsTests, URL, Void, String
...
Cohesion: 0.18
Nodes (4): Any, NSMenuItem, NSClickGestureRecognizer, NSUserInterfaceItemIdentifier
...
Cohesion: 0.06
Nodes (16): CGImage, NSCursor, ImageLimits, Bool, TerminalColorRole, background, cursor, foreground (+8 more)
...
Cohesion: 0.12
Nodes (12): LinePos, end, firstNonBlank, start, NSEvent, ViDiagnosticNavigator, ViMode, insert (+4 more)
...
Cohesion: 0.10
Nodes (13): OverlayBackground, Context, ChromeBackdrop, .init(role:), KouenDesign, KouenOverlayBackground, RuntimeGlassEffectView, Bool (+5 more)
...
Cohesion: 0.16
Nodes (8): _7(), A7(), a8(), c8(), ene(), Gnn, IC(), o8()

### Community 438 - "SessionEditor"
Cohesion: 0.08
Nodes (38): a6(), aJ(), bXt(), cJ(), dXt(), F0(), fXt(), gC() (+30 more)
...
Cohesion: 0.08
Nodes (20): Group, ParsedShortcut, .displayString, PrefixCheatsheetWindow, .groups, PrefixIndicatorWindow, PrefixKeymap, Any (+12 more)
...
Cohesion: 0.11
Nodes (20): Bool, String, UInt8, TerminalCellWidth, normal, spacerTail, wide, TerminalGridCell (+12 more)
...
Cohesion: 0.15
Nodes (11): LaunchdServiceInstaller, .backendName, .isInstalled, ServiceInstaller, ServiceInstallers, .current, ServiceInstallReport, Bool (+3 more)
...
### Community 491 - "Added"
Cohesion: 0.12
Nodes (6): ContentAreaViewController, .init(tabID:paneID:), Bool, NSLayoutConstraint, SplitDirection, TabID
...
Cohesion: 0.02
Nodes (217): a(), b(), c(), d(), e(), f(), g(), h() (+209 more)

### Community 499 - ".routingRuleList"
Cohesion: 0.05
Nodes (48): a9n(), agn(), _at(), b2t(), bTn(), d5e(), dst(), Fm() (+40 more)
...
Cohesion: 0.04
Nodes (55): ap(), apn(), ase(), aTn(), b1t(), c4n(), d8n(), EWt() (+47 more)
...
Cohesion: 0.09
Nodes (24): SessionDividerRowView, .init(coder:), .init(frame:), SessionGroupHeaderRowView, .init(coder:), .init(frame:), SessionWorktreeHeaderRowView, .init(coder:) (+16 more)
...
Cohesion: 0.10
Nodes (14): Tab, BrowserIntegrationController, NSView, PaneID, HitTestPassthroughView, PaneContainerView, .init(node:cwd:themeName:existingHosts:existingBrowserPanes:), .init(paneID:) (+6 more)
...
### Community 598 - "GroupedSessionDaemonTests"
Cohesion: 0.33
...
Cohesion: 0.03
Nodes (40): NSRangePointer, NSEvent, Any, Bool, CGFloat, NSEvent, NSMenu, NSMenuItem (+32 more)
...
### Community 699 - "eYt"
Cohesion: 0.15
Nodes (16): aNt(), dwn(), fwn(), HUe(), jUe(), KD(), kr(), kXt() (+8 more)
...
### Community 704 - "oh"
Cohesion: 0.07
Nodes (13): KouenDaemonCore, IPCCodecInvariantTests, RawSocketError, connectFailed, writeFailed, EndpointClientTests, String, URL (+5 more)
...
### Community 716 - ".routingRuleReorder"
Cohesion: 0.29
...
Cohesion: 0.14
Nodes (14): .exit, String, KouenCLI, SessionID, String, Bool, Int32, Never (+6 more)
...
- **1581 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `LiveResizeTests` to `Changelog Archive`, `ThemeDocument`, `graphify reference: extra exports and benchmark`, `callingPaneTarget`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `VTParser`, `MetalRendererTests`, `HarnessUILibrary`, `.recordReapedGenerationForTesting`, `HarnessChrome`, `.build`, `SplitPaneCoordinator`, `.readGrid(scrollbackOffset:)`, `NSRect`, `Harness tmux-style capabilities`, `WorktreeManager`, `.parse`, `.init`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `.bufferLine`, `MenuTarget`, `.characterIndex`, `Task Ledger Archive (Tasks 1–50)`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `FileTreeKeyboardNavigator`, `.buildCommand`, `.sendInput`, `DaemonServer`, `.keyEvent`, `HarnessSplitView`, `TabCell`, `KouenOverlayBackground`, `CommandHistorySearchController`, `PasteBufferStore`, `ViEngine`, `FrecencyDirectoryStore`, `generate-release-notes.swift`, `HarnessCLI+Server.swift`, `Completed Plans Archive`, `.compose`, `worktree_isolation_cli.robot`, `.configureEnvironment`, `.parse`, `Endpoint`, `HarnessDesign`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `GroupedSessionDaemonTests`, `HarnessTerminalSurfaceView`, `TerminalModes`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `AnyCodable`, `domain-design.md`, `DamageTrackingTests`, `SoftIconButton`, `code:text (:workbench start swift)`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `SessionGroup`, `one`, `WorkspaceFileTreeView`, `[1.3.0-vit] - 2026-06-06`, `String`, `HistoryRingBuffer`, `GlyphAtlas`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `.startWatching`, `PtyDrainCeilingBenchmark`, `User Story Mapping (MANDATORY)`, `RGBColor`, `CopyModeGridSource`, `How to use Harness from the terminal only (no GUI)`, `PaneStyleSet`, `AsciiFastPathTests`, `Community None`, `Int`, `ThaiCombiningMarkTests`, `MatchCategory`, `What You Must Do When Invoked`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `ActiveTabCloseDisposition`, `URLDetection`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `.showFind`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `VTConformanceCorpusTests`, `GridCompositorTests`, `P25 — iOS/iPadOS Support`, `LSPServerRegistry`, `SessionSnapshot`, `AppDelegate`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `AsyncCLIResultBox`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `.apply`, `.classify`, `MCP Server (harness-mcp)`, `.routingRuleReorder`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `.testDataFrameEncodeVsJSONBase64Output`, `PaneTarget`, `.apply`, `GridCompositor`, `.selectAdjacentSession`, `ScrollbackFile`, `Prompt`, `TerminalServicesProvider`, `SSHTunnelManagerTests`, `ExternalOpenKind`, `P10 Task: Lazy Scrollback Reflow`, `WorkbenchCommand`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `Experience modes`, `ReflowPreviewTests`, `workspace`, `release-hotfix.sh`, `GitMetadataProvider`, `WindowTitleStripView`, `.install`, `HarnessSidebarPanelViewController`, `.path`, `DefaultTerminalManager`, `WindowSession`, `StatusLineView.swift`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `Fixes Applied (layered)`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `.encodeMouse`, `FrameSignposter`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `DesktopNotifier`, `LayoutNode`, `.theme`, `README.md`, `.drawGlyph`, `ImageProtocolTests.swift`, `CommandExecutionError`, `CSIParams`, `Foundation`, `FileViewerViewController`, `Contents.json`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.handleCat`, `[3.5.1] - 2026-06-20`, `FormatStyledSegment.swift`, `RGBColor`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `Git Panel`, `SurfaceProgressTrackerTests.swift`, `MCPServer`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `HarnessCLITests`, `PresentAttempt`, `main.swift`, `Fixed`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `markdown.json`, `.refreshSurfaceMetadata`, `FilePreviewCoordinatorTabScopeTests`, `Case: cwd "bleed" — session worktree jumps to wrong dir during builds`, `BoardCardView`, `PathToken`, `.init`, `WaitForRegistry`, `LegacySnapshot`, `Modifiers`, `PresentAttempt`, `TerminalModes`, `.deinit`, `DirectionalAxis`, `ReflowFastPathTests`, `HarnessOnboarding`, `.endFind`, `Added`, `ScrollbackTests`, `.resolve`, `ccRunCancel`, `ccRunGet`, `Added`, `ccRuns`, `.testProceduralBoxAndBlockCellsDoNotEnterShapedRunCache`, `.json`, `WindowBorderOverlayView`, `.panePathLookup`?**
  _High betweenness centrality (0.230) - this node is a cross-community bridge._
- **Why does `AgentSessionSummary` connect `Terminal AI Chat (⌘I inline overlay)` to `NSTextField Leak in BoardViewController (P20 Performance)`, `rust.json`, `ScriptRuntime.swift`, `[3.5.1] - 2026-06-20`, `Changelog`, `MCP Server (harness-mcp)`, `PaneNode`, `Consumers`, `.build`, `Project History`, `LSPDiagnostic`, `PaneNode`, `Community None`, `LiveResizeTests`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `fbt()` connect `XCTestCase` to `Changelog`, `AgentNotchViewModel`, `.normalizedKey`, `.automationList`, `CopyModeAction`?**
