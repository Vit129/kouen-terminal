...
## Corpus Check
- 861 files · ~974,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20153 nodes · 54297 edges · 2106 communities (651 shown, 1455 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 8078 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `930ee7d5`
...
2. `AgentKind` - bridges 57 areas (144 edges)
3. `SessionCoordinator` - bridges 54 areas (235 edges)
4. `Process` - bridges 49 areas (101 edges)
5. `SessionSnapshot` - bridges 48 areas (181 edges)
6. `SurfaceRegistry` - bridges 43 areas (214 edges)
7. `DaemonClient` - bridges 40 areas (209 edges)
8. `IPCResponse` - bridges 40 areas (103 edges)
9. `KouenTerminalSurfaceView` - bridges 36 areas (343 edges)
...
## Communities (2106 total, 1455 thin omitted)
...
Cohesion: 0.06
Nodes (20): ClaudeCodeHarnessIPCTests, String, URL, ConcurrentIndexSet, .count, DaemonContentionTests, SubscriptionBox, .count (+12 more)

### Community 5 - "IPCRequest"
Cohesion: 0.07
Nodes (24): UInt16, Data, DecodedReplyFrame, output, reply, DecodedRequestFrame, input, request (+16 more)

### Community 6 - "AgentNotchRootView"
Cohesion: 0.06
Nodes (43): AnyTransition, Color, .hexString, AgentNotchRootView, .body, .bottomRadius, .closedAccessibilityLabel, .closedTransition (+35 more)
...
Cohesion: 0.03
Nodes (59): l, o, ake(), amn(), ate(), aZ(), b6(), c8e() (+51 more)
...
Cohesion: 0.07
Nodes (35): RawSelection, Bool, String, BlockSelection, CursorRender, CursorStyle, bar, block (+27 more)

### Community 11 - "GitPanelView.swift"
Cohesion: 0.15
Nodes (12): .addSurface(tabID:paneID:), .tab(containingPaneID:), .tabIndex(surfaceKey:), .tabIndex(workspaceID:tabID:), Bool, Date, String, SurfaceID (+4 more)
...
Cohesion: 0.07
Nodes (18): .tab(forSurfaceKey:), DaemonCommandExecutor, Command, BellScanState, esc, normal, string, stringEsc (+10 more)
...
Cohesion: 0.01
Nodes (482): _1n(), _2t(), _3n(), _5n(), _6e(), _9e(), a2n(), a2t() (+474 more)
...
Cohesion: 0.06
Nodes (55): aR(), Cjt(), cKt(), cYt(), dC(), DGt(), dm(), ece() (+47 more)
...
### Community 28 - ".parse"
Cohesion: 0.03
Nodes (246): pe(), r, X(), A(), code(), R(), a(), aDt() (+238 more)

### Community 30 - "Notification"
Cohesion: 0.18
Nodes (7): BrowserPaneView, .init(title:isActive:onSelect:onClose:), DesignModeElementInfo, Any, Bool, NSPopover, String
...
Cohesion: 0.14
Nodes (29): a7e(), dU(), Etn(), gae(), Gwe(), hO(), i0(), iAn() (+21 more)
...
Cohesion: 0.17
Nodes (7): DaemonClientActor, DaemonSessionService, .endpoint, Bool, Endpoint, DaemonSessionServiceTests, .init(client:subscriptionClient:isToolAllowed:disabledError:)
...
Cohesion: 0.10
Nodes (20): Executor, Hook, HookEvent, HookRegistry, Bool, Command, URL, UUID (+12 more)

### Community 49 - "DaemonServer"
Cohesion: 0.04
Nodes (61): _4e(), a4e(), Ac(), ag(), agt(), b2(), bj(), c8n() (+53 more)
...
Cohesion: 0.04
Nodes (61): _0t(), _6n(), ast(), aXe(), bee(), bgn(), bkn(), byn() (+53 more)
...
Cohesion: 0.02
Nodes (97): _5e(), A1(), aat(), bd(), _Bt(), bvt(), bw(), by() (+89 more)
...
Cohesion: 0.03
Nodes (81): a8n(), agn(), aoe(), _at(), aV(), bb(), bR(), bX() (+73 more)
...
Cohesion: 0.05
Nodes (48): a0(), b6n(), bce(), bwn(), cSn(), cte(), Df(), dle() (+40 more)
...
Cohesion: 0.11
Nodes (10): DaemonSyncService, .sync(metadataOnly:), Bool, Never, String, TabID, Task, Void (+2 more)
...
Cohesion: 0.08
Nodes (12): .receive(_:), DispatchSemaphore, TerminalGridSnapshot, FluidityBenchmarks, NSWindow, String, UInt64, NSWindow (+4 more)

### Community 83 - "LSPClient"
Cohesion: 0.08
Nodes (25): Error, LSPClient, LSPClientError, missingPipe, processNotRunning, serverNotExecutable, AsyncStream, CheckedContinuation (+17 more)

### Community 84 - "LSPDiagnostic"
Cohesion: 0.21
Nodes (9): BrowserCookie, BrowserElement, BrowserElementBounds, BrowserNetworkEntry, BrowserSnapshot, BufferSummary, Bool, Date (+1 more)

### Community 85 - "TerminalGridCell"
Cohesion: 0.10
Nodes (24): Codable, Equatable, URL, CodingKeys, error, id, jsonrpc, method (+16 more)
...
Cohesion: 0.09
Nodes (30): eJ(), fme(), fwn(), gKt(), gUe(), $He(), kGt(), LC() (+22 more)
...
Cohesion: 0.11
Nodes (16): TerminalEmulator, .captureLines(joinWrapped:), .feed(_:), .promptRows, .readGrid(scrollbackOffset:), .assertAllPathsAgree(_:cols:rows:file:line:), StaticString, String (+8 more)

### Community 92 - "P2 — Async IPC Refactor: Design Document"
Cohesion: 0.09
Nodes (19): KouenIPC, SavedLayoutStore, Bool, String, URL, UUID, PaneLayoutShape, branch (+11 more)

### Community 93 - "code:bash (# Terminal 1: Create workspace with long-running job)"
Cohesion: 0.07
Nodes (13): TerminalGridCell, Any, Bool, NSMenu, NSMenuItem, NSPasteboard, String, TerminalGridCell (+5 more)
...
Cohesion: 0.36
Nodes (4): AgentListFormatter, Date, String, dvn()
...
Cohesion: 0.09
Nodes (25): c6(), eL(), evt(), _gn(), h7e(), kAn(), kbn(), l1t() (+17 more)
...
Cohesion: 0.12
Nodes (13): ContentAreaViewController, HitTestPassthroughView, PaneContainerView, .init(node:cwd:themeName:existingHosts:existingBrowserPanes:), .init(paneID:), NSPoint, NSView, PaneID (+5 more)
...
Cohesion: 0.09
Nodes (16): Selector, Kind, primary, secondary, KouenPillButton, .init(coder:), .init(title:kind:), .isHovered (+8 more)

### Community 197 - "AgentSessionSummary"
Cohesion: 0.14
Nodes (14): OverlayBackground, Context, OverlayBackground, Context, .init(coder:), .init(coder:), KouenOverlayBackground, .init(coder:) (+6 more)
...
Cohesion: 0.09
Nodes (10): GitPanelView, .isHidden, .removeWorktreeAction(_:), .removeWorktreeAction(path:), Any, DispatchWorkItem, NSEvent, NSMenuItem (+2 more)
...
Cohesion: 0.09
Nodes (58): Ame(), aQt(), aXt(), cJ(), Cme(), Cqt(), CUe(), cXt() (+50 more)
...
Cohesion: 0.06
Nodes (32): Bm(), cFt(), CWt(), dUe(), Em(), eu(), Fm(), fpt() (+24 more)
...
Cohesion: 0.13
Nodes (17): Darwin, Foundation, Glibc, KouenCore, KouenDaemonCore, Network, WriteOutcome, complete (+9 more)
...
Cohesion: 0.12
Nodes (11): aen(), bme(), bYt(), fqt(), hVe(), ien(), qme(), qrn (+3 more)
...
Cohesion: 0.09
Nodes (13): Bool, CAMetalDrawable, String, String, UInt64, ANSIPalette, UInt8, .color(_:) (+5 more)
...
### Community 301 - ".parse"
Cohesion: 0.07
Nodes (22): .groupedRecords, .body, MainActor, Void, Group, ParsedShortcut, .displayString, PrefixCheatsheetWindow (+14 more)
...
Cohesion: 0.09
Nodes (7): KouenSettings, NotchVisibilityMode, automatic, off, on, Bool, ExperienceModeTests
...
Cohesion: 0.14
Nodes (13): .activeTab, .init(url:paneID:webView:), .webView(_:createWebViewWith:for:windowFeatures:), .webView(_:didFinish:), BrowserTab, Double, URL, UUID (+5 more)
...
Cohesion: 0.29
Nodes (7): ShellInfo, ShellStepView, .allConfigured, .noneConfigured, Bool, String, URL
...
Cohesion: 0.08
Nodes (29): AppKit, KouenCopyMode, KouenTerminalEngine, KouenTerminalKit, KouenTerminalRenderer, KouenTheme, Metal, ImmersiveEffects (+21 more)
...
Cohesion: 0.06
Nodes (37): AYt(), dhn(), en(), EUe(), eYt(), fhn(), gC(), ghn() (+29 more)
...
### Community 360 - "State"
Cohesion: 0.06
Nodes (51): _3e(), a1t(), a2(), akn(), bpn(), cIn(), cU(), dTn() (+43 more)
...
Cohesion: 0.10
Nodes (28): al(), b1t(), bdn(), bIn(), c4n(), d7e(), dOt(), f6n() (+20 more)
...
Cohesion: 0.14
Nodes (7): GitResult, Bool, String, ValidateOutcome, WorktreeEntry, GitPanelViewToastErrorSummaryTests, GitPanelViewWorktreeParsingTests
...
Cohesion: 0.11
Nodes (18): .body, OnboardingStep, complete, discover, .id, setup, shell, .title (+10 more)
...
Cohesion: 0.23
Nodes (12): AddToWorkspaceSheet, .allSelected, .body, .folderName, .listHeight, .selectedCount, DiscoveredRepoItem, FolderScanner (+4 more)
...
### Community 402 - "View"
Cohesion: 0.06
Nodes (44): Configuration, TabBarInlineIconButtonStyle, ButtonStyle, CommandRow, .body, GlassCard, .body, GlassPrimaryButtonStyle (+36 more)
...
Cohesion: 0.13
Nodes (10): CoreText, ShapedGlyphSignature, Bool, CGFloat, CGGlyph, String, Bool, String (+2 more)
...
Cohesion: 0.17
Nodes (13): Int, Date, String, TerminalBlock, TerminalBlockStore, .block(atPromptLine:), .block(id:), .lastFinishedBlock (+5 more)
...
Cohesion: 0.12
Nodes (10): .event(_:), .interval(_:_:), StaticString, T, PendingMainHop, SurfaceEmulatorState, SurfaceFrameBuildResult, Bool (+2 more)
...
### Community 451 - ".run"
Cohesion: 0.29
Nodes (10): CGFloat, Range, Tab, TabBarIconButtonStyle, TabBarLayoutMetrics, .pitch, tabDisplayTitle(), TerminalTabBarBody (+2 more)

### Community 452 - "tmux parity — status, adaptations, and deliberate divergences"
Cohesion: 0.06
Nodes (40): a6(), aJ(), bXt(), dme(), dXt(), eGt(), EWt(), F0() (+32 more)
...
Cohesion: 0.04
Nodes (63): AgentRow, .agentColor, .executables, .hookButton, .hookButtonTitle, HookState, failed, idle (+55 more)
...
Cohesion: 0.17
Nodes (11): .logIfFailed(_:), .request(_:), Error, TimeInterval, daemonError, .request(_:), .request(_:timeout:), LatencyMonitor (+3 more)
...
Cohesion: 0.05
Nodes (50): AgentChipView, .init(frame:), .intrinsicContentSize, ChromeBackdrop, .init(role:), ChromeRole, sidebar, tabBar (+42 more)
...
Cohesion: 0.13
Nodes (11): FilterStatus, active, all, completed, CaseIterable, LayoutTemplate, evenHorizontal, evenVertical (+3 more)
...
Cohesion: 0.10
Nodes (13): UnsafeBufferPointer, TerminalCellWidth, UInt8, UnsafeBufferPointer, CharacterWidth, Bool, ClosedRange, Unicode (+5 more)
...
Cohesion: 0.02
Nodes (395): V, _4n(), _7n(), a9n(), a_n(), aA(), ace(), act() (+387 more)
...
Cohesion: 0.03
Nodes (40): NSCursor, NSRangePointer, NSEvent, NSDraggingInfo, NSDragOperation, Any, Bool, NSAttributedString (+32 more)
...
Cohesion: 0.09
Nodes (20): CGFloat, DisplayLinkTarget, MainSplitViewController, .setSidebarVisible(_:), SplitChromeDelegate, .splitView(_:constrainMaxCoordinate:ofSubviewAt:), .splitView(_:constrainMinCoordinate:ofSubviewAt:), .splitView(_:effectiveRect:forDrawnRect:ofDividerAt:) (+12 more)
...
Cohesion: 0.14
Nodes (15): Bpe(), displayable(), eFe(), Fpe(), jpe(), KBe(), kFe(), pC() (+7 more)
...
Cohesion: 0.15
Nodes (13): B3(), cFe(), dFe(), _Dt(), fFe(), lFe(), oFe(), _Ot() (+5 more)
...
Cohesion: 0.21
Nodes (5): .init(forTesting:), UUID, Void, PanePipe, FileHandle
...
Cohesion: 0.14
Nodes (15): AgentIconArt, AgentVectorIcon, Bool, CGSize, String, CoreGraphics, Kind, arms (+7 more)

### Community 724 - "ColorKind"
Cohesion: 0.24
Nodes (8): KouenGridTerminal, .captureLines(fromLine:toLine:), .captureLines(joinWrapped:), .feed(_:), .onSetClipboard, Bool, String, UInt8
...
Cohesion: 0.20
Nodes (5): Notification.Name, os, FrameDropCause, encodeFailure, nilDrawable
...
### Community 774 - "AgentNotchViewModel.swift"
Cohesion: 0.22
...
### Community 796 - "TerminalColorRole"
Cohesion: 0.29
...
Cohesion: 0.12
Nodes (18): .exit, DaemonClient, String, String, String, KouenCLI, SessionID, String (+10 more)
...
- **1455 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `main.swift` to `callingPaneTarget`, `graphify reference: extra exports and benchmark`, `.handleNormal`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `.testManyConcurrentSubscribersAllReceiveOutput`, `FileTreeKeyboardNavigator`, `TerminalEmulator`, `GitPanelView.swift`, `RealPtyLifecycleTests`, `PerformanceBenchmarks`, `VTParser`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `.recordReapedGenerationForTesting`, `HarnessChrome`, `.sessionID`, `SplitPaneCoordinator`, `.readGrid(scrollbackOffset:)`, `WorktreeManager`, `SessionGroupHeaderRowView`, `Harness tmux-style capabilities`, `NSObject`, `.init`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `.bufferLine`, `MenuTarget`, `.characterIndex`, `Task Ledger Archive (Tasks 1–50)`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `.sendInput`, `.keyEvent`, `HarnessSplitView`, `TabCell`, `KouenOverlayBackground`, `CommandHistorySearchController`, `ShellIntegrationTests`, `3.2 สิ่งที่ implement แล้ว`, `FrecencyDirectoryStore`, `generate-release-notes.swift`, `HarnessCLI+Server.swift`, `PasteBufferStore`, `worktree_isolation_cli.robot`, `p44-mobile-agent-inbox-design.html`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `HarnessDesign`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `HarnessPaths`, `HarnessTerminalSurfaceView`, `TerminalModes`, `code:bash (# Terminal 1: Create workspace with long-running job)`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `.installCLI`, `.dispatch`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `AnyCodable`, `domain-design.md`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `SoftIconButton`, `code:text (:workbench start swift)`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `[1.3.0-vit] - 2026-06-06`, `ClientSummary`, `HistoryRingBuffer`, `GlyphAtlas`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `.load`, `CommandTarget`, `.startWatching`, `PtyDrainCeilingBenchmark`, `User Story Mapping (MANDATORY)`, `RGBColor`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `TriState`, `Community None`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `MatchCategory`, `What You Must Do When Invoked`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `ActiveTabCloseDisposition`, `TransportError`, `URLDetection`, `ImportedTerminalConfig`, `New Tab`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `Added`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `VTConformanceCorpusTests`, `GridCompositorTests`, `P25 — iOS/iPadOS Support`, `SessionSnapshot`, `AppDelegate`, `.init`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `main.swift`, `.makeDiffScrollView`, `user-stories.md`, `GlyphRasterizer`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `BinaryInstaller`, `.start`, `.classify`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `DisplayWidth`, `DaemonRoundTripTests.swift`, `PaneTarget`, `ColorKind`, `AgentVectorIcon`, `.lines`, `GridCompositor`, `ScrollbackFile`, `TerminalServicesProvider`, `ResizeDirection`, `ImageTextureCache`, `.gestureRecognizer`, `SSHTunnelManagerTests`, `HGe`, `ExternalOpenKind`, `WorkbenchCommand`, `.make`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `FileNode`, `DaemonMetrics`, `ReflowPreviewTests`, `workspace`, `release-hotfix.sh`, `ThemeFileServiceTests`, `.install`, `HarnessSidebarPanelViewController`, `.path`, `ScrollbackPersistenceTests`, `DefaultTerminalManager`, `WindowSession`, `StatusLineView.swift`, `[2.5.0] - 2026-06-12`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `TerminalColorRole`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `Fixes Applied (layered)`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.script`, `FrameSignposter`, `Bug: Tab-Switch Black Screen`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `code:bash (# In a Harness pane:)`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `.theme`, `.drawGlyph`, `Added`, `CommandExecutionError`, `CSIParams`, `Foundation`, `code:bash (harness-cli install-hooks openclaw)`, `code:bash (harness-cli install-hooks pi)`, `FileViewerViewController`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.deepMerge`, `.handleCat`, `[3.5.1] - 2026-06-20`, `FormatStyledSegment.swift`, `Consumers`, `DaemonStats`, `P13 — Embedded Browser Pane (cmux parity)`, `.run`, `ScrollReuseTests`, `SurfaceProgressTrackerTests.swift`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `Darwin`, `AgentIconRenderer`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `markdown.json`, `RealPtyLifecycleTests`, `FilePreviewCoordinatorTabScopeTests`, `SixelDecoder`, `Case: cwd "bleed" — session worktree jumps to wrong dir during builds`, `BoardCardView`, `PathToken`, `Project History`, `SessionEditor`, `Section`, `Modifiers`, `PaletteMode`, `PresentAttempt`, `SessionCoordinator.swift`, `.run`, `.recordReapedGenerationForTesting`, `ComposerPanel`, `.encode`, `RunState`, `.deinit`, `Never`, `DispatchTime`, `HarnessOnboarding`, `Added`, `ScrollbackTests`, `Command Prompt Architecture`, `.resolve`, `ccRunCancel`, `ccRunGet`, `Added`, `.bind`, `.json`, `WindowBorderOverlayView`, `SwarmFleetBody`, `.panePathLookup`?**
  _High betweenness centrality (0.246) - this node is a cross-community bridge._
- **Why does `AgentSessionSummary` connect `Terminal AI Chat (⌘I inline overlay)` to `IPCRequest`, `worktree_isolation_cli.robot`, `Changelog`, `AgentNotchViewModel`, `Added`, `Consumers`, `.deinit`, `HookEvent`, `LaunchdServiceInstaller`, `.control`, `PaneNode`, `TerminalGridCell`, `Community None`, `.installCLI`, `main.swift`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `fbt()` connect `TaskDashboardBody` to `Changelog`, `CopyModeAction`, `qk`?**
