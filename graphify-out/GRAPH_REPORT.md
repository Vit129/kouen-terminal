...
10. `IPCResponse` - bridges 36 areas (103 edges)
...
## Communities (2132 total, 1501 thin omitted)
...
Cohesion: 0.07
Nodes (16): ConcurrentIndexSet, .count, DaemonContentionTests, String, URL, DaemonRoundTripTests, String, TimeInterval (+8 more)

### Community 5 - "IPCRequest"
Cohesion: 0.07
Nodes (25): Data, DecodedReplyFrame, output, reply, DecodedRequestFrame, input, request, FrameError (+17 more)

### Community 6 - "AgentNotchRootView"
Cohesion: 0.05
Nodes (51): AnyTransition, AnyView, AgentNotchPeekEvent, AgentNotchRootView, .body, .bottomRadius, .closedAccessibilityLabel, .closedTransition (+43 more)
...
Cohesion: 0.11
Nodes (11): LayoutTemplate, evenHorizontal, evenVertical, mainHorizontal, mainVertical, tiled, Command, SessionEditorPhase4Tests (+3 more)
...
Cohesion: 0.05
Nodes (53): RGBColor, DecodedImage, .byteCount, UInt8, SurfaceColorProviderState, RawSelection, SelectionResolver, Bool (+45 more)
...
Cohesion: 0.01
Nodes (501): _0t(), _1n(), _3n(), _5e(), _5n(), a2t(), a3n(), a4e() (+493 more)
...
Cohesion: 0.04
Nodes (74): a6(), aR(), cKt(), copy(), cYt(), dC(), DGt(), dje() (+66 more)

### Community 25 - "WorktreeManager"
Cohesion: 0.04
Nodes (41): .tab(forSurfaceKey:), DaemonCommandExecutor, Command, .init(forTesting:), UUID, Void, BellScanState, esc (+33 more)

### Community 26 - "Harness tmux-style capabilities"
Cohesion: 0.04
Nodes (70): _1t(), _2t(), a8n(), aae(), agn(), aV(), bb(), bvt() (+62 more)
...
### Community 28 - ".parse"
Cohesion: 0.03
Nodes (232): pe(), r, X(), A(), code(), R(), a(), aDt() (+224 more)

### Community 30 - "Notification"
Cohesion: 0.15
Nodes (10): BrowserPaneView, BrowserProgressLine, .init(frame:), DesignModeElementInfo, Any, NSLayoutConstraint, NSPopover, NSRect (+2 more)
...
Cohesion: 0.16
Nodes (5): CGFloat, NSEvent, NSEvent, NSPoint, UInt16
...
Cohesion: 0.09
Nodes (28): CopyModeMatch, ColorKind, .base, bg, fg, underline, CompositorPane, GridCompositor (+20 more)

### Community 54 - "HarnessSplitView"
Cohesion: 0.16
Nodes (14): .pairedAlreadyBanner, .pairingQRPanel, AutomationsFleetView, .emptyFleetView, .headerBar, .sidebarEmptyView, .sidebarHeaderBar, JobResultSheetView (+6 more)
...
Cohesion: 0.12
Nodes (23): TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid, .gridOriginPointsX (+15 more)

### Community 60 - "ViEngine"
Cohesion: 0.07
Nodes (16): surfaceID, .surfaceID(forPaneID:), LegacySnapshot, LegacyWorkspace, SessionEditorTests, Bool, Date, String (+8 more)
...
Cohesion: 0.26
Nodes (7): .activeTab, .webView(_:didFinish:), BrowserTab, Bool, Double, UUID, tabs
...
### Community 64 - ".text"
Cohesion: 0.08
Nodes (10): TerminalGridCell, Bool, NSDraggingInfo, NSDragOperation, NSPasteboard, String, TerminalGridCell, URL (+2 more)
...
Cohesion: 0.02
Nodes (400): l, V, em(), _4n(), _6n(), _7n(), a2(), a7n() (+392 more)
...
Cohesion: 0.04
Nodes (51): Codable, JSONOutputFormatter, Bool, String, T, BrowserCookie, BrowserElement, BrowserElementBounds (+43 more)
...
Cohesion: 0.11
Nodes (13): String, WorkbenchMRU, FileEditorView, .init(frame:), Bool, NSEvent, NSHostingView, NSRect (+5 more)
...
Cohesion: 0.05
Nodes (54): a1t(), b2n(), b2t(), bpn(), cyn(), d1t(), d9n(), dTn() (+46 more)
...
Cohesion: 0.07
Nodes (42): al(), ax(), b1t(), bdn(), bIn(), c4n(), d7e(), dOt() (+34 more)

### Community 93 - "code:bash (# Terminal 1: Create workspace with long-running job)"
Cohesion: 0.16
Nodes (33): b(), Bje(), DJt(), dzt(), FR(), gJt(), gzt(), Hl() (+25 more)
...
Cohesion: 0.05
Nodes (48): a2n(), aOn(), bhn(), bX(), c0n(), cct(), cxn(), e4e() (+40 more)
...
Cohesion: 0.07
Nodes (40): aXt(), AYt(), bXt(), Cme(), Cqt(), EUe(), GYt(), H7() (+32 more)
...
Cohesion: 0.08
Nodes (16): DaemonReconnectPolicy, DetachedPaneOverlay, .init(coder:), .init(frame:style:), Style, detached, reconnectingChip, NSCoder (+8 more)
...
Cohesion: 0.18
Nodes (9): .init(coder:), .init(coder:), .init(coder:), DesignModePopoverViewController, .init(coder:), .init(title:properties:styles:onStyleChanged:onCopyCSS:onPromptAgent:), NSCoder, NSTextField (+1 more)
...
Cohesion: 0.09
Nodes (8): Bool, Range, Set, String, URLDetection, String, StringProtocol, EngineConformanceTests
...
Cohesion: 0.08
Nodes (22): BrowserTabButton, .init(title:isActive:onSelect:onClose:), SelectAllOnClickTextField, NSEvent, Selector, Kind, primary, secondary (+14 more)

### Community 197 - "AgentSessionSummary"
Cohesion: 0.12
Nodes (31): dU(), Dwe(), e9n(), Etn(), gCn(), GDt(), hO(), i0() (+23 more)
...
Cohesion: 0.15
Nodes (7): Bool, String, VerificationResult, VerificationRunner, String, VerificationRunnerTests, String
...
Cohesion: 0.08
Nodes (16): GitPanelView, .isHidden, .removeWorktreeAction(_:), .removeWorktreeAction(path:), Any, DispatchWorkItem, NSButton, NSColor (+8 more)
...
Cohesion: 0.13
Nodes (9): Bool, NSEvent, NSPopover, NSRange, NSString, Void, SyntaxTextView, .init(frame:) (+1 more)
...
Cohesion: 0.13
Nodes (16): SettingsHostingController, .init(coder:), .init(page:), NSCoder, Page, advanced, appearance, automations (+8 more)
...
Cohesion: 0.09
Nodes (55): aJ(), Ame(), aQt(), cJ(), CUe(), cXt(), dXt(), DYt() (+47 more)
...
Cohesion: 0.04
Nodes (69): amn(), ate(), b6(), c8e(), Cf(), cg(), ch(), cvt() (+61 more)
...
Cohesion: 0.07
Nodes (37): CustomStringConvertible, Darwin, Foundation, Glibc, KouenCore, DaemonClientError, connectionFailed, .description (+29 more)
...
Cohesion: 0.07
Nodes (39): SettingsAgentsView, .agentsSection, .body, .deliverySection, .detectionSection, .notchSection, .notifySection, Bool (+31 more)
...
Cohesion: 0.16
Nodes (11): BrowserPaneRegistry, .init(url:paneID:), .init(url:paneID:webView:), NSWindow, PaneID, WKWebView, WeakBrowserPaneView, WeakScriptMessageHandler (+3 more)

### Community 286 - "code:bash (harness-cli install-hooks hermes)"
Cohesion: 0.12
Nodes (11): MarkdownPreviewView, Any, Bool, Error, String, URL, Void, URL (+3 more)
...
Cohesion: 0.09
Nodes (12): SessionCoordinator, .selectWorkspace(_:), Bool, Double, PaneID, PaneNode, SplitDirection, String (+4 more)
...
### Community 301 - ".parse"
Cohesion: 0.15
Nodes (10): Bool, String, Range, String, TerminalGridCell, TerminalBufferMatch, TerminalBufferSearch, String (+2 more)
...
Cohesion: 0.13
Nodes (22): bC(), bFe(), Cjt(), clamp(), Ejt(), formatHsl(), H2e(), jBe() (+14 more)
...
Cohesion: 0.08
Nodes (30): aNt(), bNt(), bu(), cNt(), dNt(), dwn(), eNt(), eRe() (+22 more)
...
Cohesion: 0.10
Nodes (22): CoreGraphics, CoreText, ImageIO, KouenCopyMode, KouenTerminalEngine, KouenTerminalKit, KouenTerminalRenderer, KouenTheme (+14 more)
...
Cohesion: 0.13
Nodes (19): Color, .hexString, ColorHexRow, .body, .colorBinding, .currentHex, .isCustom, PaletteCell (+11 more)
...
Cohesion: 0.08
Nodes (12): AgentDetection, AgentDetector, Date, Int32, TimeInterval, ProcessScan, Int32, AgentSnapshot (+4 more)
...
Cohesion: 0.07
Nodes (22): AnyCancellable, .rowList, AgentNotchViewModel, .visibleRows, .waitingCount, Bool, CGFloat, Duration (+14 more)

### Community 360 - "State"
Cohesion: 0.05
Nodes (49): _4e(), aAn(), ag(), akn(), bEn(), bj(), bln(), bwt() (+41 more)
...
Cohesion: 0.09
Nodes (21): FlippedView, .isFlipped, .init(coder:), .init(frame:), HunkActionButton, .init(coder:), .init(title:onClick:), StageToggleButton (+13 more)
...
Cohesion: 0.09
Nodes (21): .webView(_:createWebViewWith:for:windowFeatures:), .webView(_:didCommit:), WKNavigationAction, BrowserPaneViewTests, MockWebView, .isLoading, .url, Any (+13 more)
...
### Community 402 - "View"
Cohesion: 0.07
Nodes (29): Configuration, TabBarIconButtonStyle, TabBarInlineIconButtonStyle, ButtonStyle, CommandRow, .body, GlassCard, .body (+21 more)
...
Cohesion: 0.20
Nodes (8): Bool, NSEvent, NSPanel, String, TurnDiffPanel, .canBecomeKey, TurnDiffReviewerController, NSObject
...
Cohesion: 0.10
Nodes (7): String, KouenSidebarPanelViewController, CGFloat, NSMenuItem, NSView, String, String
...
### Community 435 - ".init"
Cohesion: 0.05
Nodes (44): A1(), aat(), ast(), B1(), b2(), bw(), d4n(), d6() (+36 more)
...
Cohesion: 0.28
Nodes (4): NSObjectProtocol, Tab, TabID, WorktreeAutoIsolateService
...
Cohesion: 0.10
Nodes (20): a0n(), Bm(), dl(), eAn(), Em(), gb(), i8n(), jm() (+12 more)
...
Cohesion: 0.11
Nodes (22): dhn(), fhn(), gC(), ghn(), iXt(), jUe(), jXt(), kme() (+14 more)
...
Cohesion: 0.24
Nodes (4): .automationsList, String, String, .trimmed
...
Cohesion: 0.05
Nodes (13): azt(), B0, BBe(), F7, Fze, Gg(), gPt(), ibe() (+5 more)
...
Cohesion: 0.05
Nodes (48): .init(entry:), ChromeRole, sidebar, tabBar, Collection, .aggregateBoardStatus, .taskTooltipSummary, FontSize (+40 more)
...
Cohesion: 0.06
Nodes (34): MainActor, Void, SessionDividerRowView, .init(coder:), .init(frame:), SessionGroupHeaderRowView, .init(coder:), SessionWorktreeHeaderRowView (+26 more)
...
Cohesion: 0.05
Nodes (33): OverlayBackground, Context, InlineFilePreview, Context, OverlayBackground, Context, AgentChipView, .init(coder:) (+25 more)
...
Cohesion: 0.05
Nodes (17): NSCursor, Bool, CAMetalDrawable, NSEvent, String, KouenTerminalSurfaceView, CGFloat, .currentSelectionRegion (+9 more)
...
Cohesion: 0.09
Nodes (18): CGFloat, String, MainSplitViewController, .setSidebarVisible(_:), SplitChromeDelegate, .splitView(_:constrainMaxCoordinate:ofSubviewAt:), .splitView(_:constrainMinCoordinate:ofSubviewAt:), .splitView(_:effectiveRect:forDrawnRect:ofDividerAt:) (+10 more)
...
### Community 704 - "oh"
Cohesion: 0.06
Nodes (17): GroupedSessionTests, SessionGroup, Set, SurfaceID, Phase67Tests, FormatContextDaemonTests, PaneID, String (+9 more)
...
Cohesion: 0.70
Nodes (3): DisplayLinkTarget, CADisplayLink, Void

### Community 722 - ".configureEnvironment"
Cohesion: 0.06
Nodes (37): AS(), bXe(), cc(), d2(), dce(), e6(), eOn(), h2t() (+29 more)
...
Cohesion: 0.06
Nodes (34): B3(), BDt(), Bpe(), cFe(), dFe(), displayable(), _Dt(), eFe() (+26 more)

### Community 729 - ".normalizedKey"
Cohesion: 0.17
Nodes (7): AnyObject, TimeInterval, ZombieHoldRegistry, BrowserIntegrationController, NSView, PaneID, ObjectIdentifier
...
### Community 782 - "qk"
Cohesion: 0.03
Nodes (98): _6e(), _9e(), a0(), ace(), agt(), b6n(), bce(), c8n() (+90 more)
...
- **1501 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `code:text (:workbench start swift)` to `callingPaneTarget`, `graphify reference: extra exports and benchmark`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `LSPMessage`, `FileTreeKeyboardNavigator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `RealPtyLifecycleTests`, `TabContextCommand`, `TerminalEmulator`, `VTParser`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `.recordReapedGenerationForTesting`, `HarnessChrome`, `SplitPaneCoordinator`, `.readGrid(scrollbackOffset:)`, `WorktreeManager`, `SessionGroupHeaderRowView`, `RGBColor`, `.init`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `.bufferLine`, `.characterIndex`, `MenuTarget`, `Task Ledger Archive (Tasks 1–50)`, `HarnessSettings`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `LayoutTemplate`, `DaemonServer`, `.keyEvent`, `TabCell`, `KouenOverlayBackground`, `CommandHistorySearchController`, `3.2 สิ่งที่ implement แล้ว`, `PasteBufferStore`, `main.swift`, `ComposedCell`, `HarnessCLI+Server.swift`, `.text`, `generate-release-notes.swift`, `FrecencyDirectoryStore`, `.toastErrorSummary`, `Completed Plans Archive`, `ViEngine`, `worktree_isolation_cli.robot`, `WorkbenchMRU`, `.feed(_:)`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `HarnessDesign`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `HarnessPaths`, `.control`, `HarnessTerminalSurfaceView`, `TerminalModes`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `.installCLI`, `.dispatch`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `FormatContextDaemonTests`, `AnyCodable`, `AgentNotchViewModel`, `DamageTrackingTests`, `SoftIconButton`, `[1.3.0-vit] - 2026-06-06`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `WorkspaceFileTreeView`, `HistoryRingBuffer`, `GlyphAtlas`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `AgentHookInstaller`, `.load`, `CommandTarget`, `.startWatching`, `PtyDrainCeilingBenchmark`, `User Story Mapping (MANDATORY)`, `CopyModeGridSource`, `How to use Harness from the terminal only (no GUI)`, `PaneStyleSet`, `AsciiFastPathTests`, `TriState`, `Community None`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `.getBlock`, `MatchCategory`, `What You Must Do When Invoked`, `Workspace`, `CommandPromptController`, `WriteOutcome`, `ActiveTabCloseDisposition`, `AgentTableEntry`, `TransportError`, `.update`, `ImportedTerminalConfig`, `New Tab`, `URLDetection`, `[1.5.1] - 2026-06-06`, `BlockSummary`, `Added`, `BinaryRefresherTests`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `P25 — iOS/iPadOS Support`, `LSPServerRegistry`, `SessionSnapshot`, `LayoutProbeView`, `AppDelegate`, `.init`, `.nextBrowserPaneID`, `main.swift`, `user-stories.md`, `.makeDiffScrollView`, `GlyphRasterizer`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `BinaryInstaller`, `.start`, `.classify`, `HeadlessRunEvent`, `SwarmFleetView`, `Harness keybindings`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `.injectVersionBannerIfPending`, `PaneTarget`, `.lines`, `GridCompositor`, `ScrollbackFile`, `Prompt`, `TerminalServicesProvider`, `ResizeDirection`, `ImageTextureCache`, `SSHTunnelManagerTests`, `ExternalOpenKind`, `P10 Task: Lazy Scrollback Reflow`, `WorkbenchCommand`, `.make`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `ReplayStep`, `FileNode`, `ReflowPreviewTests`, `Split Right`, `BoardViewController`, `workspace`, `DecodedWSFrame`, `release-hotfix.sh`, `WindowTitleStripView`, `.install`, `HarnessSidebarPanelViewController`, `.path`, `DefaultTerminalManager`, `WindowSession`, `StatusLineView.swift`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `Fixes Applied (layered)`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `jobs`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `00-inception-plan.md`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `.theme`, `.drawGlyph`, `Added`, `CSIParams`, `Foundation`, `FileViewerViewController`, `Contents.json`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.handleCat`, `[3.5.1] - 2026-06-20`, `OcclusionTests`, `FormatStyledSegment.swift`, `RGBColor`, `Consumers`, `DynamicInstanceBuffer`, `ScrollReuseTests`, `SurfaceProgressTrackerTests.swift`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `UI Automation — Robot Framework (P18)`, `AgentIconRenderer`, `Fixed`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `markdown.json`, `rust.json`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `SixelDecoder`, `Bug — Cmd+\ sidebar toggle gone after collapse`, `Case: cwd "bleed" — session worktree jumps to wrong dir during builds`, `Competitive Position (as of v3.12.0, 2026-07-02)`, `PathToken`, `GroupedSessionDaemonTests`, `main.swift`, `Modifiers`, `PresentAttempt`, `tmux parity — status, adaptations, and deliberate divergences`, `.deinit`, `Never`, `HarnessOnboarding`, `Added`, `ScrollbackTests`, `Added`, `.routingRuleList`, `.json`, `SessionStore`, `.panePathLookup`?**
  _High betweenness centrality (0.232) - this node is a cross-community bridge._
- **Why does `AgentSessionSummary` connect `Terminal AI Chat (⌘I inline overlay)` to `rust.json`, `ScriptRuntime.swift`, `IPCRequest`, `OcclusionTests`, `NotificationBus`, `Changelog`, `AgentTableEntry`, `PerformanceBenchmarks`, `Consumers`, `code:text (:workbench start swift)`, `SpecialKey`, `LSPDiagnostic`, `PaneNode`, `Community None`, `LegacySnapshot`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `fbt()` connect `XCTestCase` to `Changelog`, `P2 — Async IPC Refactor: Design Document`, `KittyKeyboardTests`, `CopyModeAction`?**
