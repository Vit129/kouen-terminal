...
10. `KouenTerminalSurfaceView` - bridges 33 areas (343 edges)
...
## Communities (2205 total, 1605 thin omitted)

### Community 0 - "CodingKey"
Cohesion: 0.09
Nodes (48): Bje(), Cjt(), Czt(), DJt(), dzt(), Ejt(), FR(), gJt() (+40 more)
...
Cohesion: 0.07
Nodes (24): UInt16, DecodedReplyFrame, output, reply, DecodedRequestFrame, input, request, FrameError (+16 more)
...
Cohesion: 0.16
Nodes (5): Double, PaneID, SplitDirection, SurfaceID, TabID
...
Cohesion: 0.11
Nodes (23): DaemonSubscription, .start(onData:onEnd:buffered:), Bool, Data, UInt64, sysClose(), DaemonClientTests, FrameRecorder (+15 more)
...
Cohesion: 0.01
Nodes (516): _1n(), _2t(), _3n(), _5n(), _6e(), _9e(), a2n(), a2t() (+508 more)
...
Cohesion: 0.16
Nodes (6): Bool, String, UInt8, TerminalEmulator, .captureLines(fromLine:toLine:), .onSetClipboard
...
Cohesion: 0.04
Nodes (46): ag(), aoe(), b5e(), bR(), cAn(), d8n(), d9n(), e2n() (+38 more)
...
Cohesion: 0.08
Nodes (14): NSRangePointer, Any, NSAttributedString, NSEvent, NSRange, NSRect, String, UInt64 (+6 more)
...
### Community 64 - ".text"
Cohesion: 0.22
Nodes (9): NSHostingView, NSRect, Tab, TerminalTabBarView, .delegate, .init(frame:), .leadingInset, .mouseDownCanMoveWindow (+1 more)
...
Cohesion: 0.02
Nodes (254): l, V, em(), _6n(), a5n(), a7e(), a7n(), a9n() (+246 more)
...
Cohesion: 0.12
Nodes (12): FileEditorView, .init(frame:), Bool, NSEvent, NSRect, String, URL, GitDiffGutter (+4 more)
...
Cohesion: 0.12
Nodes (12): Int, ImagePlacementSnapshot, SemanticMark, TerminalGridSnapshot, HistoryLine, ImagePlacement, RewrapResult, Bool (+4 more)
...
Cohesion: 0.06
Nodes (28): KouenPaths, SessionStore, DispatchWorkItem, TimeInterval, SurfaceRegistry, Set, PendingVersionBanner, welcome (+20 more)
...
Cohesion: 0.10
Nodes (17): FileHandle, LSPMessage, notification, request, response, Decoder, Encoder, KeyedDecodingContainer (+9 more)
...
Cohesion: 0.03
Nodes (243): pe(), r, X(), A(), code(), R(), a(), aDt() (+235 more)
...
Cohesion: 0.10
Nodes (6): SavedCursor, ClosedRange, Range, TerminalScreen, .cursorVisible, .markRowsDirty(_:)
...
Cohesion: 0.12
Nodes (24): eJ(), fme(), fwn(), gKt(), gUe(), $He(), kGt(), LC() (+16 more)
...
Cohesion: 0.13
Nodes (12): .onCurrentCWD, CGFloat, Character, NSRange, NSString, NSTextView, String, ViEngine (+4 more)
...
Cohesion: 0.05
Nodes (52): _0t(), agn(), agt(), _at(), bce(), bgn(), c8n(), cgn() (+44 more)
...
### Community 176 - "Added"
Cohesion: 0.07
Nodes (36): a0(), al(), b6n(), bdn(), bIn(), d7e(), dhn(), dOt() (+28 more)
...
Cohesion: 0.07
Nodes (29): CoreText, CTFontSymbolicTraits, MTLDevice, CellMetrics, GlyphRasterizer, .rasterize(cluster:bold:italic:), .rasterize(codepoint:bold:italic:), .rasterize(glyph:font:) (+21 more)
...
Cohesion: 0.01
Nodes (307): _4n(), _8n(), a1t(), a8n(), act(), Af(), aOn(), avn() (+299 more)

### Community 196 - "Feature Provenance — harness-terminal"
Cohesion: 0.06
Nodes (33): .init(coder:), .init(coder:), Collection, .aggregateBoardStatus, .taskTooltipSummary, Kind, primary, secondary (+25 more)

### Community 197 - "AgentSessionSummary"
Cohesion: 0.12
Nodes (7): GitPanelView, .isHidden, .removeWorktreeAction(_:), Any, DispatchWorkItem, NSMenuItem, NSClickGestureRecognizer
...
Cohesion: 0.07
Nodes (38): Equatable, DecodedImage, .byteCount, UInt8, KouenGridTerminal, SelectionResolver, String, BlockSelection (+30 more)
...
Cohesion: 0.12
Nodes (20): PaletteAction, PaletteGrepMatch, PaletteItemRow, .body, PaletteModel, PalettePanel, .canBecomeKey, PaletteRow (+12 more)
...
### Community 215 - ".lines"
Cohesion: 0.06
Nodes (35): abn(), aU(), b1n(), b3e(), c2t(), c6(), dCn(), dte() (+27 more)
...
Cohesion: 0.02
Nodes (246): a(), b(), c(), d(), e(), f(), g(), h() (+238 more)
...
### Community 243 - ".make"
Cohesion: 0.18
Nodes (19): Encodable, AISuggestionAck, AttachedAck, BrowserFramePush, BrowserOkAck, Cred, DetachedAck, DeviceCredentials (+11 more)
...
Cohesion: 0.17
Nodes (12): bvt(), CWt(), dUe(), EWt(), hyn(), m2t(), QBt(), sO() (+4 more)
...
Cohesion: 0.04
Nodes (61): _3e(), _4e(), a4e(), a9e(), cvn(), Da(), e3(), eL() (+53 more)
...
Cohesion: 0.12
Nodes (23): a6(), aJ(), bXt(), cJ(), F0(), fXt(), gC(), h2() (+15 more)

### Community 260 - ".welcome"
Cohesion: 0.04
Nodes (68): aA(), amn(), ate(), avt(), b6(), c8e(), Cf(), cg() (+60 more)
...
Cohesion: 0.08
Nodes (14): PaneBorderStatus, Bool, Command, Data, DispatchWorkItem, PaneID, PaneLeaf, PaneNode (+6 more)
...
Cohesion: 0.05
Nodes (59): AgentRow, .agentColor, .executables, .hookButton, .hookButtonTitle, HookState, failed, idle (+51 more)
...
Cohesion: 0.06
Nodes (33): BrowserPaneView, .init(coder:), .init(url:paneID:webView:), .webView(_:didStartProvisionalNavigation:), BrowserProgressLine, .init(coder:), .init(frame:), BrowserTabButton (+25 more)
...
Cohesion: 0.09
Nodes (28): a2(), akn(), bpn(), bYe(), cIn(), ew(), h3n(), ift() (+20 more)
...
### Community 298 - "jobs"
Cohesion: 0.07
Nodes (71): Ame(), aQt(), aXt(), Cqt(), CUe(), cXt(), DYt(), een() (+63 more)
...
Cohesion: 0.07
Nodes (19): Bool, String, UUID, TaskDaemonBridge, SessionID, KouenCommands, KouenIPC, Status (+11 more)
...
Cohesion: 0.13
Nodes (19): AnyTransition, AgentNotchPeekEvent, AgentNotchRootView, .bottomRadius, .closedAccessibilityLabel, .closedTransition, .closedView, .currentHeight (+11 more)
...
Cohesion: 0.24
Nodes (8): clamp(), statusColor(), SplitDirection, T, TabID, .body, .dragGesture, TerminalTabBarDelegate
...
Cohesion: 0.10
Nodes (19): KouenCopyMode, KouenTerminalEngine, KouenTerminalRenderer, KouenTheme, Metal, ImmersiveEffects, CALayer, .currentRawSelection (+11 more)
...
Cohesion: 0.04
Nodes (55): _5e(), A1(), aat(), ast(), bw(), c5n(), cmn(), d6() (+47 more)

### Community 355 - ".deepMerge"
Cohesion: 0.10
Nodes (18): DotView, .init(coder:), .init(frame:), Bool, Context, Date, Never, NSCoder (+10 more)
...
Cohesion: 0.09
Nodes (19): JSONDecoder, JSONEncoder, Kind, input, metadata, output, resize, RecordingEvent (+11 more)
...
Cohesion: 0.06
Nodes (17): NSCursor, Data, TerminalColorRole, background, cursor, foreground, palette, Bool (+9 more)
...
Cohesion: 0.09
Nodes (29): .init(entry:), AgentChipView, .intrinsicContentSize, ChromeRole, sidebar, tabBar, Divider, FontSize (+21 more)
...
Cohesion: 0.10
Nodes (10): ScriptAPI, Foundation, JavaScriptCore, KouenCore, Mode, compatible, kouen, TerminalIdentity (+2 more)
...
Cohesion: 0.20
Nodes (6): CSIParams, .count, Pen, TerminalGridColor, TerminalGridUnderline, UInt8
...
Cohesion: 0.06
Nodes (21): .event(_:), .interval(_:_:), StaticString, T, Bool, CAMetalDrawable, .testingPendingResize, PendingMainHop (+13 more)
...
Cohesion: 0.13
Nodes (14): AYt(), Cme(), dXt(), EUe(), eYt(), IUe(), j9n(), KYt() (+6 more)
...
Cohesion: 0.09
Nodes (26): Bool, String, UInt8, TerminalCellWidth, normal, spacerTail, wide, TerminalCursor (+18 more)
...
Cohesion: 0.11
Nodes (9): CommandPaletteController, PaletteCommandConfig, PaletteFileEntry, PaletteMode, errors, grep, normal, String (+1 more)
...
Cohesion: 0.14
Nodes (9): _Bt(), by(), e7e(), fst(), hxn(), lxn(), sBt, XWt() (+1 more)
...
Cohesion: 0.29
Nodes (4): BrowserPaneRegistry, .init(url:paneID:), NSWindow, PaneID
...
Cohesion: 0.15
Nodes (12): LinePos, end, firstNonBlank, start, Bool, ViDiagnosticNavigator, ViMode, insert (+4 more)
...
Cohesion: 0.17
Nodes (15): apn(), ern(), G4(), G7(), Jnn(), nrn(), Qnn(), sHe() (+7 more)
...
Cohesion: 0.15
Nodes (15): eGt(), hhn(), HUe(), Ije(), JVt(), KD(), kXt(), lhn() (+7 more)
...
Cohesion: 0.08
Nodes (21): OverlayBackground, Context, OverlayBackground, Context, .init(frame:), ChromeBackdrop, .init(role:), KouenDesign (+13 more)
...
Cohesion: 0.11
Nodes (6): CKouenSys, PtyError, launchFailed, ShellLaunchProfile, .argv, ShellLaunchProfileTests
...
### Community 591 - "DaemonClientError"
Cohesion: 0.29
...
Cohesion: 0.17
Nodes (11): CodingKeys, cols, createdAt, dataBase64, rows, timeMs, type, version (+3 more)
...
Cohesion: 0.10
Nodes (5): SessionID, String, WorkspaceID, NSMenuItem, NSView
...
## Knowledge Gaps
- **3500 isolated node(s):** `AppIntents`, `noActivePane`, `.localizedStringResource`, `horizontal`, `vertical` (+3495 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1605 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `code:bash (# Terminal 1: Create workspace with long-running job)` to `Changelog Archive`, `callingPaneTarget`, `graphify reference: extra exports and benchmark`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `VTParser`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `HarnessChrome`, `SplitPaneCoordinator`, `.request`, `WorktreeManager`, `Harness tmux-style capabilities`, `SessionGroupHeaderRowView`, `TransportError`, `.init`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `.bufferLine`, `.characterIndex`, `MenuTarget`, `Task Ledger Archive (Tasks 1–50)`, `CodingKeys`, `FileTreeKeyboardNavigator`, `HarnessSidebarPanelViewController.swift`, `.buildCommand`, `.normalizedKey`, `DaemonServer`, `.keyEvent`, `HarnessSplitView`, `TabCell`, `CommandHistorySearchController`, `.withinPixelCap`, `PasteBufferStore`, `FrecencyDirectoryStore`, `ComposedCell`, `HarnessCLI+Server.swift`, `AutomationScheduler`, `worktree_isolation_cli.robot`, `.feed(_:)`, `.parse`, `Endpoint`, `HarnessDesign`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `HarnessPaths`, `AgentRoutingRuleSummary`, `HarnessTerminalSurfaceView`, `.tomlKouenBlock`, `TerminalModes`, `P2 — Async IPC Refactor: Design Document`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `4. Technical Architecture`, `.dispatch`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `AnyCodable`, `DamageTrackingTests`, `SoftIconButton`, `code:text (:workbench start swift)`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `[1.3.0-vit] - 2026-06-06`, `WorkspaceFileTreeView`, `ViEngine`, `Pipe`, `String`, `HistoryRingBuffer`, `GlyphAtlas`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `.startWatching`, `.readGrid(scrollbackOffset:)`, `User Story Mapping (MANDATORY)`, `PtyDrainCeilingBenchmark`, `RGBColor`, `CopyModeGridSource`, `How to use Harness from the terminal only (no GUI)`, `PaneStyleSet`, `AsciiFastPathTests`, `Community None`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `MatchCategory`, `What You Must Do When Invoked`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `CodingKeys`, `.deleteWorkspaceFromMenu`, `URLDetection`, `.makeDiffScrollView`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `ComposedFrame`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `VTConformanceCorpusTests`, `GridCompositorTests`, `P25 — iOS/iPadOS Support`, `LSPServerRegistry`, `AsyncCLIResultBox`, `SessionSnapshot`, `AppDelegate`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `.apply`, `AgentSessionSummary`, `.classify`, `.start`, `MCP Server (harness-mcp)`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `PaneTarget`, `GridCompositor`, `Prompt`, `TerminalServicesProvider`, `ExternalOpenKind`, `P10 Task: Lazy Scrollback Reflow`, `WorkbenchCommand`, `.make`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `ReflowPreviewTests`, `BoardViewController`, `workspace`, `release-hotfix.sh`, `WindowTitleStripView`, `.install`, `HarnessSidebarPanelViewController`, `.path`, `DefaultTerminalManager`, `WindowSession`, `StatusLineView.swift`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `Fixes Applied (layered)`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `ViPathTokenTests`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `.theme`, `README.md`, `.drawGlyph`, `CommandExecutionError`, `Foundation`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.deepMerge`, `.handleCat`, `FormatStyledSegment.swift`, `[2.2.4] - 2026-06-11`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `P13 — Embedded Browser Pane (cmux parity)`, `.install`, `SurfaceProgressTrackerTests.swift`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `Darwin`, `HarnessCLITests`, `.load`, `Split Panes (NSSplitView)`, `main.swift`, `Fixed`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `json.json`, `markdown.json`, `.refreshSurfaceMetadata`, `rust.json`, `yaml.json`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `Case: cwd "bleed" — session worktree jumps to wrong dir during builds`, `BoardCardView`, `PathToken`, `Project History`, `.init`, `LegacySnapshot`, `GroupedSessionDaemonTests`, `main.swift`, `Section`, `Modifiers`, `PresentAttempt`, `.recordReapedGenerationForTesting`, `ComposerPanel`, `TerminalModes`, `.deinit`, `HarnessOnboarding`, `.hitTest`, `.endFind`, `Added`, `ScrollbackTests`, `ccRunGet`, `Service Decomposition — SessionCoordinator (P17)`, `.json`, `PromptQueue`, `.panePathLookup`?**
  _High betweenness centrality (0.252) - this node is a cross-community bridge._
- **Why does `AgentSessionSummary` connect `Terminal AI Chat (⌘I inline overlay)` to `Equatable`, `rust.json`, `.recordReapedGenerationForTesting`, `.startWatching`, `Changelog`, `MCP Server (harness-mcp)`, `PaneNode`, `Consumers`, `BoardCardView`, `DaemonSubscription`, `SplitPaneCoordinator`, `PaneNode`, `SessionCoordinator`, `Community None`, `code:bash (# Terminal 1: Create workspace with long-running job)`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `fbt()` connect `XCTestCase` to `ResizeHUDView`, `SSHTunnelManagerTests`, `Changelog`, `CopyModeAction`, `.lines`?**
...
- **What connects `AppIntents`, `noActivePane`, `.localizedStringResource` to the rest of the system?**
  _3520 weakly-connected nodes found - possible documentation gaps or missing edges._
