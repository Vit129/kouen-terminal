...
## Corpus Check
- 716 files · ~851,592 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14593 nodes · 31263 edges · 3700 communities (1218 shown, 2482 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 3430 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2202305e`
...
4. `IPCResponse` - bridges 51 areas (69 edges)
5. `SpecialKey` - bridges 51 areas (56 edges)
6. `EngineConformanceTests` - bridges 50 areas (76 edges)
7. `MenuTarget` - bridges 50 areas (60 edges)
8. `AgentKind` - bridges 47 areas (92 edges)
9. `CommandParserTests` - bridges 42 areas (43 edges)
10. `CopyModeAction` - bridges 41 areas (44 edges)
...
## Communities (3700 total, 2482 thin omitted)
...
Cohesion: 0.15
Nodes (15): AnyTransition, AnyView, AgentNotchPeekEvent, AgentNotchRootView, HorizontalInsetRect, NotchOverviewRow, NotchStatusDot, Bool (+7 more)
...
Cohesion: 0.16
Nodes (11): TerminalDamage, MetalRendererTests, RenderedFixture, Bool, MTLTexture, RenderColor, StaticString, String (+3 more)
...
Cohesion: 0.09
Nodes (15): HarnessTerminalSurfaceView, Any, Bool, CGFloat, NSEvent, NSMenu, NSMenuItem, NSPasteboard (+7 more)
...
### Community 32 - ".addTab"
Cohesion: 0.10
Nodes (15): KeybindingsService, Bool, Command, String, CodingKeys, bindings, disabledSpecs, id (+7 more)
...
Cohesion: 0.08
Nodes (18): NSCursor, TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid (+10 more)

### Community 40 - "HarnessSettings"
Cohesion: 0.15
Nodes (13): HarnessSettings, ResizeOverlayPosition, bottomRight, center, topRight, Bool, Decoder, Double (+5 more)
...
Cohesion: 0.18
Nodes (3): HarnessSidebarPanelViewController, String, SessionSnapshot
...
Cohesion: 0.16
Nodes (11): ChromeBackdrop, HarnessDesign, HarnessOverlayBackground, RuntimeGlassEffectView, Bool, NSCoder, NSColor, NSPoint (+3 more)

### Community 45 - "HarnessTerminalSurfaceView.swift"
Cohesion: 0.09
Nodes (9): HarnessTerminalSurfaceView, SurfaceFrameBuildConfiguration, SurfaceFrameBuildResult, Bool, Float, NSWindow, RenderColor, UInt64 (+1 more)
...
Cohesion: 0.08
Nodes (23): ClientRecord, CountBox, DaemonServer, PendingBrowserRequest, PendingWrite, Bool, CheckedContinuation, Data (+15 more)
...
Cohesion: 0.06
Nodes (19): CornerInfo, EditorDividerView, HarnessSplitView, PaneDragGripView, PaneHoverButton, PaneSplitButtonsView, DispatchWorkItem, Double (+11 more)
...
Cohesion: 0.09
Nodes (12): SessionEditor, Bool, Date, SessionID, String, SurfaceID, TabID, WorkspaceID (+4 more)
...
Cohesion: 0.09
Nodes (14): AgentDetector, AgentTable, Date, Int32, TimeInterval, WrapperOptionBehavior, keepScanning, matchValue (+6 more)
...
Cohesion: 0.11
Nodes (11): InlineAICompletionController, HarnessSettings, String, ReconnectLatch, Bool, CGFloat, FormatColor, HarnessSettings (+3 more)
...
Cohesion: 0.10
Nodes (16): TerminalModes, InputEncoder, KeyEventType, press, release, `repeat`, KeyModifiers, MouseEventKind (+8 more)
...
Cohesion: 0.09
Nodes (12): HarnessPillButton, Kind, primary, secondary, SoftIconButton, NSButton, NSEvent, NSImage (+4 more)
...
Cohesion: 0.13
Nodes (11): GitResult, Bool, escaping, MainActor, NSEvent, Void, WatcherContext, WorktreeEntry (+3 more)
...
Cohesion: 0.09
Nodes (26): String, CommandPaletteController, PaletteAction, PaletteCommandConfig, PaletteFileEntry, PaletteFooter, PaletteGrepMatch, PaletteItemRow (+18 more)
...
Cohesion: 0.10
Nodes (15): FlippedView, GitPanelView, RepoEntry, Any, NSButton, NSColor, NSMenuItem, NSScrollView (+7 more)
...
Cohesion: 0.16
Nodes (5): DetachedPaneOverlay, NSEvent, NSPoint, Sendable, Void
...
### Community 266 - ".path"
Cohesion: 0.19
Nodes (3): NSMenuItem, NSView, SidebarTitlebarHeaderView
...
Cohesion: 0.09
Nodes (13): PaneBorderStatus, Bool, Command, CommandTarget, DispatchWorkItem, HarnessGridTerminal, PaneID, PaneLeaf (+5 more)

### Community 271 - "StatusLineView.swift"
Cohesion: 0.12
Nodes (15): HarnessOptions, StatusLineView, CGFloat, FormatColor, Never, NSAttributedString, NSCoder, NSColor (+7 more)
...
Cohesion: 0.12
Nodes (12): OptionSet, KeySpec, Modifiers, Decoder, String, UInt8, Binding, KeyTable (+4 more)
...
Cohesion: 0.10
Nodes (19): DiffLineType, added, deleted, modified, Notification.Name, Bool, NSCoder, NSEvent (+11 more)
...
Cohesion: 0.25
Nodes (12): CustomStringConvertible, atomicWrite(), backupCorruptFile(), fnv1aHex(), HarnessPathsError, socketPathTooLong, Bool, Data (+4 more)
...
Cohesion: 0.08
Nodes (20): CHarnessSys, RealPty, ScrollbackEntry, ScrollbackReplaySegment, ShellLaunchProfile, Bool, CChar, DaemonSurfaceID (+12 more)
...
Cohesion: 0.13
Nodes (20): AppKit, CoreGraphics, CoreText, HarnessCopyMode, HarnessTerminalEngine, HarnessTerminalRenderer, HarnessTheme, ImageIO (+12 more)
...
Cohesion: 0.05
Nodes (20): HarnessCore, FormatContextBuilder, DaemonSurfaceID, SessionSnapshot, String, Phase67Tests, BellScanTests, Bool (+12 more)
...
Cohesion: 0.11
Nodes (18): Kind, input, metadata, output, resize, RecordingEvent, input, metadata (+10 more)
...
### Community 501 - "Fixed"
Cohesion: 0.10
Nodes (9): PendingMainHop, SurfaceEmulatorState, Data, DispatchQueue, DispatchSemaphore, DispatchWorkItem, T, TerminalEmulator (+1 more)
...
Cohesion: 0.07
Nodes (19): NSCoder, MainActor, Void, SessionDividerRowView, SessionGroupHeaderRowView, SessionWorktreeHeaderRowView, SessionWorktreeRowView, BoardColumnKind (+11 more)
...
Cohesion: 0.22
Nodes (6): DesktopNotifier, HarnessPathDisplay, Bool, MainActor, String, Void
...
Cohesion: 0.07
Nodes (22): Logger, os, OSSignposter, DaemonSessionError, daemonError, unexpectedResponse, DaemonSessionService, LatencyMonitor (+14 more)
...
### Community 598 - ".load"
Cohesion: 0.12
Nodes (10): String, WorkbenchMRU, Foundation, object, HarnessSettings, Bool, Data, HarnessCLI (+2 more)
...
Cohesion: 0.12
Nodes (16): InputGate, Style, detached, reconnectingChip, SurfaceIO, Data, HarnessTerminalSurfaceView, NSCoder (+8 more)
...
Cohesion: 0.06
Nodes (22): DaemonCommandExecutor, Command, BellScanState, esc, normal, stringEsc, PanePipe, SurfaceMonitor (+14 more)
...
- **Why does `Int` connect `Int` to `Changelog Archive`, `ThemeDocument`, `EngineConformanceTests`, `AgentNotchRootView`, `HarnessDaemonTools`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `PasteController`, `VTParser`, `HarnessTerminalSurfaceView`, `Kind`, `MetalRendererTests`, `HarnessChrome`, `UInt32`, `HarnessTerminalSurfaceView`, `.request`, `WorktreeManager`, `SessionGroupHeaderRowView`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `LegacySnapshot`, `DaemonClient`, `.encode`, `TerminalColorGamut`, `HarnessSettings`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `harness.resource`, `RenderSchedulerTests`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `DaemonServer`, `HarnessSplitView`, `TerminalTabBarView.swift`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `PasteBufferStore`, `ViEngine`, `ComposedCell`, `PrefixKeymap`, `.compose`, `worktree_isolation_cli.robot`, `ImportedTerminalConfig`, `[3.8.0] - 2026-06-22`, `OptionStore`, `Endpoint`, `TerminalProtocolCompatibilityTests`, `DaemonSubscription`, `KeyRecorderView.swift`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `.load`, `SessionCoordinator`, `HarnessTerminalSurfaceView`, `.cursorPos`, `WrapperOptionBehavior`, `MenuBarController`, `TerminalModes`, `AttachInputBatcher`, `.testRenderEncodeIncrementalDamage160x48`, `.dispatch`, `MainSplitViewController`, `AnyCodable`, `AgentNotchViewModel`, `NSView`, `DamageTrackingTests`, `[1.3.0-vit] - 2026-06-06`, `.testBuildShiftedMatchesFullBuildAcrossScrollWalk`, `.makeSnapshot`, `HarnessGridTerminal`, `.decodeKeySpec`, `.encode`, `SessionGroup`, `graphify reference: query, path, explain`, `[3.0.0] - 2026-06-15`, `WorkspaceFileTreeView`, `Pipe`, `String`, `HistoryRingBuffer`, `.path`, `GlyphAtlas`, `.agentJSON`, `SwiftUI`, `.write`, `.assertAllPathsAgree`, `AgentHookInstaller`, `stability_release.robot`, `[3.10.0] - 2026-06-27`, `CommandTarget`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `TerminalSelection`, `TerminalHostView`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `NotificationEntry`, `New Tab`, `HarnessDaemonToolsTests`, `CompletionPopupView`, `What You Must Do When Invoked`, `PathToken`, `.handle`, `ThaiCombiningMarkTests`, `MatchCategory`, `Toggle Sidebar`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `.detect`, `FilePreviewCoordinator`, `AgentTableEntry`, `HarnessCLI+Workbench.swift`, `URLDetection`, `ReflowCorpusTests`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `.rects`, `VTConformanceCorpusTests`, `GridCompositorTests`, `TerminalScreen`, `.currentSize`, `[2.1.0] - 2026-06-07`, `SessionSnapshot`, `AppDelegate`, `BrowserPaneView`, `ScriptRuntime`, `GlyphRasterizer`, `BinaryInstaller`, `ResizeHUDView`, `.classify`, `BinaryInstallerVersionTests`, `HarnessBrowserTools`, `PaletteModel`, `CopyModeState`, `[3.9.5] - 2026-06-26`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `HarnessCLI`, `PaneTarget`, `.translate`, `CellColorResolverTests`, `GridCompositor`, `ScrollbackFile`, `AgentNotchRowSummary`, `.parse`, `CellColorResolver`, `.resolve`, `HarnessGridTerminalTests`, `CLAUDE.md`, `TextGrid`, `.scan`, `extraction-spec.md`, `TerminalMetalRenderer`, `PaneBorderStatus`, `ThemeDocumentTests`, `DaemonMetrics`, `skill-trigger.py`, `ReflowPreviewTests`, `SessionCoordinator`, `Split Right`, `BoardViewController`, `DaemonSyncService`, `FileEditorView`, `.welcome`, `.apply`, `WindowSession`, `StatusLineView.swift`, `SGRMouseEvent`, `SyntaxTextView`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `TerminalScrollbarView`, `RemoteHostStoreTests`, `FormatColor`, `.apply`, `StatusLineWidthTests`, `Process`, `GitHubCLIClient`, `NotificationBus`, `PaneNode`, `HarnessPaths.swift`, `ThemeDiagnostics`, `.encodeMouse`, `TargetSpec`, `skipUnlessLiveDaemonTests`, `.compute`, `Send Ex Command`, `AgentSnapshot`, `FormatColor`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `RealPty`, `ImageProtocolTests.swift`, `CSIParams`, `Foundation`, `Page`, `.moveSelection`, `DaemonLifecycleTests`, `.clampedBlur`, `.init`, `.moveActiveSession`, `.setCellPixelSize`, `DaemonStats`, `Tab`, `[2.2.4] - 2026-06-11`, `DynamicInstanceBuffer`, `.run`, `Identifiable`, `SurfaceProgressTrackerTests.swift`, `PromptQueue`, `ThaiClusterRenderTests`, `.selectAdjacentSession`, `HarnessCLITests`, `.moveActiveSession`, `.cursorBackwardTabs`, `.navigateCurrentFile`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `CopyModeLine`, `HarnessCore`, `.initialState`, `WaitForRegistry`, `SessionEditor`, `.init`, `Section`, `RecordSession`, `FormatContext`, `RecordingEvent`, `ReflowFastPathTests`, `HarnessOnboarding`, `.steps`, `ScrollbackTests`, `terminal-cheat-sheet.html`, `release.yml`, `Fixed`, `ThaiClusterCopyTests.swift`?**
  _High betweenness centrality (0.262) - this node is a cross-community bridge._
- **Why does `HarnessCore` connect `HarnessCore` to `graphify reference: extra exports and benchmark`, `AgentNotchRootView`, `PasteController`, `ShellCompletionInstallerTests`, `HarnessSettingsTests.swift`, `Kind`, `MetalRendererTests`, `OnboardingEnvironment`, `SplitPaneCoordinator`, `.request`, `TabAlertTests`, `WorktreeManager`, `RGBColor`, `SessionGroupHeaderRowView`, `.parse`, `.addTab`, `Equatable`, `LegacySnapshot`, `MenuTarget`, `NSObject`, `.encode`, `DaemonClient`, `DesktopNotifier`, `[3.12.0] - 2026-06-30`, `CodingKeys`, `.normalizedKey`, `HookEvent`, `DaemonServer`, `HarnessSplitView`, `TabCell`, `NSPanel`, `TerminalTabBarView.swift`, `CommandHistorySearchController`, `BellScanState`, `ViEngine`, `FrecencyDirectoryStore`, `PasteBufferStore`, `HarnessCLI+Server.swift`, `.text`, `ShellIntegration`, `worktree_isolation_cli.robot`, `ScriptSnapshotModels.swift`, `.parse`, `Endpoint`, `HarnessDesign`, `DaemonSubscription`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `.load`, `HarnessPaths`, `MenuBarController`, `AttachInputBatcher`, `PaneContainerView`, `DaemonLauncher`, `MainSplitViewController`, `Recipe`, `AgentNotchViewModel`, `NSView`, `ViEngine`, `[1.3.0-vit] - 2026-06-06`, `.decodeKeySpec`, `.makeSnapshot`, `NotificationCoordinator`, `[3.0.0] - 2026-06-15`, `WorkspaceFileTreeView`, `ViEngine`, `Pipe`, `String`, `SwiftUI`, `.write`, `ToolRegistry.swift`, `stability_release.robot`, `.load`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `TerminalHostView`, `CopyModeGridSource`, `.decode`, `TriState`, `NotificationEntry`, `EnvironmentStore`, `.evaluate`, `[3.1.2] - 2026-06-16`, `What You Must Do When Invoked`, `.handle`, `[3.3.0] - 2026-06-18`, `HarnessDaemonToolsTests`, `MatchCategory`, `AgentKind`, `What You Must Do When Invoked`, `TerminalFindBar`, `[3.11.6] - 2026-06-29`, `CommandPromptController`, `ActiveTabCloseDisposition`, `LiveSession`, `AgentTableEntry`, `[3.5.0] - 2026-06-20`, `HarnessCLI+Workbench.swift`, `.status`, `BinaryRefresherTests`, `.hold`, `.rects`, `GridCompositorTests`, `Error`, `AppDelegate`, `ScrollbackFile.swift`, `ScriptRuntime`, `[2.5.1] - 2026-06-12`, `[3.2.0] - 2026-06-16`, `AgentSessionSummary`, `MainWindowController`, `FileTabManager`, `.classify`, `HarnessBrowserTools`, `PaletteModel`, `HarnessCLI`, `[2.4.0] - 2026-06-12`, `SettingsRemoteView`, `PaneDropZoneOverlay`, `NotchLayoutMetrics`, `GridCompositor`, `Section`, `AgentNotchRowSummary`, `ANSIPalette`, `SSHTunnelManagerTests`, `ExternalOpenKind`, `.make`, `graphify reference: commit hook and native CLAUDE.md integration`, `AgentBridge`, `FileNode`, `SessionCoordinator`, `NSViewRepresentable`, `BoardViewController`, `DaemonSyncService`, `.install`, `HarnessSidebarPanelViewController`, `StatusLineView.swift`, `SGRMouseEvent`, `KeySpec`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `[1.5.1] - 2026-06-06`, `.run`, `.menu`, `RemoteHostStoreTests`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `AgentApprovalBar`, `settings.json`, `jobs`, `.parse`, `.terminalHost`, `RegressionBugFixTests`, `.script`, `skipUnlessLiveDaemonTests`, `AgentSnapshot`, `WorkspaceSymbolIndex`, `FloatingPaneController`, `worktree_isolation.robot`, `.theme`, `RealPty`, `Foundation`, `Page`, `DaemonLifecycleTests`, `[3.2.0] - 2026-06-16`, `.deepMerge`, `SurfaceProgressTracker`, `State`, `DaemonStats`, `.encode`, `.run`, `.install`, `Identifiable`, `PromptQueue`, `HarnessCLITests`, `FilePreviewCoordinatorTabScopeTests`, `AgentVectorIcon`, `.initialState`, `.run`, `RecordSession`, `FormatContext`, `StartupMetrics`, `.encode`, `PaneLabelDaemonTests`, `HarnessOnboarding`, `.steps`, `AgentHookInstallerTests.swift`, `CommandIPCTranslatorTests.swift`, `CommandParserTests.swift`, `SystemdUserInstaller`, `ThaiClusterCopyTests.swift`, `graphify reference: extra exports and benchmark`, `State`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `AppKit` connect `Foundation` to `CodingKey`, `graphify reference: extra exports and benchmark`, `AgentNotchRootView`, `PasteController`, `HarnessChrome`, `HarnessTerminalSurfaceView`, `OnboardingEnvironment`, `SplitPaneCoordinator`, `SessionGroupHeaderRowView`, `RGBColor`, `MenuTarget`, `NSObject`, `DesktopNotifier`, `GlassEffectView`, `.keyEvent`, `HarnessSplitView`, `TabCell`, `NSPanel`, `TerminalTabBarView.swift`, `CommandHistorySearchController`, `ViEngine`, `HarnessDesign`, `.cgPath`, `MenuBarController`, `PaneContainerView`, `ScriptRuntime.swift`, `MainSplitViewController`, `AgentNotchViewModel`, `NSView`, `ViEngine`, `NotificationCoordinator`, `[3.0.0] - 2026-06-15`, `WorkspaceFileTreeView`, `ViEngine`, `Pipe`, `.path`, `ActivePaneService`, `TerminalHostView`, `DecodedImage`, `NotificationEntry`, `CompletionPopupView`, `What You Must Do When Invoked`, `[3.8.0] - 2026-06-22`, `TerminalFindBar`, `CommandPromptController`, `ActiveTabCloseDisposition`, `InlineAICompletionView`, `AppDelegate`, `BinaryInstaller`, `AgentSessionSummary`, `MainWindowController`, `FileTabManager`, `PaletteModel`, `SettingsRemoteView`, `PaneDropZoneOverlay`, `NotchLayoutMetrics`, `.lines`, `TerminalServicesProvider`, `ExternalOpenKind`, `SparkleUpdater.swift`, `.make`, `FileNode`, `SessionCoordinator`, `NSViewRepresentable`, `BoardViewController`, `DaemonSyncService`, `SelectionGranularity`, `WindowTitleStripView`, `.apply`, `.performInstall`, `StatusLineView.swift`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `[1.5.1] - 2026-06-06`, `.menu`, `TerminalScrollbarView`, `.apply`, `AgentApprovalBar`, `settings.json`, `jobs`, `Send Ex Command`, `WorkspaceSymbolIndex`, `FloatingPaneController`, `ImmersivePalette.swift`, `.drawGlyph`, `main.swift`, `Page`, `[3.5.1] - 2026-06-20`, `State`, `.install`, `Identifiable`, `PromptQueue`, `View`, `HintModeOverlay`, `.delay`, `BlockContextMenuTests`, `.handleViMode`, `ComposerPanel`?**
