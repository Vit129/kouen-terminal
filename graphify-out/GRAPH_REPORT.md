...
## Summary
- 19432 nodes · 51640 edges · 2173 communities (596 shown, 1577 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 7613 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31243430`
...
1. `SessionCoordinator` - bridges 60 areas (231 edges)
2. `KouenPaths` - bridges 56 areas (135 edges)
3. `AgentKind` - bridges 46 areas (129 edges)
4. `SessionSnapshot` - bridges 44 areas (167 edges)
5. `SurfaceRegistry` - bridges 40 areas (200 edges)
6. `Process` - bridges 39 areas (89 edges)
7. `i()` - bridges 36 areas (321 edges)
8. `MenuTarget` - bridges 36 areas (68 edges)
9. `Notification` - bridges 36 areas (63 edges)
10. `t()` - bridges 35 areas (253 edges)
...
## Communities (2173 total, 1577 thin omitted)
...
Cohesion: 0.08
Nodes (21): DaemonClient, ClaudeCodeHarnessIPCTests, String, URL, DaemonBrowserRoutingTests, String, URL, ConcurrentIndexSet (+13 more)
...
Cohesion: 0.06
Nodes (45): AnyTransition, AnyView, AgentNotchPeekEvent, AgentNotchRootView, .body, .bottomRadius, .closedAccessibilityLabel, .closedTransition (+37 more)
...
Cohesion: 0.13
Nodes (11): .addSurface(tabID:paneID:), .tab(containingPaneID:), .tab(forSurfaceKey:), .tabIndex(surfaceKey:), .tabIndex(workspaceID:tabID:), Bool, Date, String (+3 more)
...
Cohesion: 0.05
Nodes (39): RGBColor, TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid (+31 more)
...
Cohesion: 0.03
Nodes (89): _1t(), a0(), a4e(), Ac(), agn(), agt(), b6n(), bce() (+81 more)

### Community 16 - ".applyPreedit"
Cohesion: 0.07
Nodes (43): aR(), cKt(), copy(), cYt(), dC(), DGt(), dje(), dm() (+35 more)
...
Cohesion: 0.05
Nodes (47): .init(entry:), AgentChipView, .init(coder:), .intrinsicContentSize, .init(coder:), ChromeRole, sidebar, tabBar (+39 more)

### Community 22 - "CopyModeAction"
Cohesion: 0.01
Nodes (474): _0t(), _5e(), _5n(), _6e(), _9e(), a2n(), a2t(), a3n() (+466 more)
...
Cohesion: 0.07
Nodes (21): .tab(for:), DaemonCommandExecutor, Command, BellScanState, esc, normal, string, stringEsc (+13 more)
...
Cohesion: 0.07
Nodes (32): CKouenSys, ClientRecord, CountBox, DaemonError, alreadyRunning, bindFailed, .description, listenFailed (+24 more)
...
Cohesion: 0.06
Nodes (65): aat(), AS(), cc(), d2(), d6(), dce(), dU(), e6() (+57 more)
...
Cohesion: 0.09
Nodes (14): SessionGroup, String, KouenSidebarPanelViewController, NSMenuItem, NSView, SessionGroup, String, NSMenu (+6 more)
...
Cohesion: 0.02
Nodes (259): f(), V, em(), _6n(), _9n(), Af(), aIn(), aln() (+251 more)
...
Cohesion: 0.07
Nodes (20): NSCursor, KouenTerminalSurfaceView, .receive(_:), CGFloat, DispatchSemaphore, DispatchWorkItem, String, TerminalGridSnapshot (+12 more)
...
Cohesion: 0.05
Nodes (57): a6e(), adn(), ake(), b6(), c8e(), Cf(), cg(), ch() (+49 more)
...
Cohesion: 0.16
Nodes (11): calculate(), constructor(), l2t(), mBt, mce(), nf(), oce(), pat() (+3 more)

### Community 108 - ".resolve"
Cohesion: 0.02
Nodes (263): r, X(), A(), blockquote(), code(), R(), _1n(), a() (+255 more)
...
Cohesion: 0.11
Nodes (16): String, AgentRoutingRule, Kind, path, stack, Bool, Date, UUID (+8 more)
...
### Community 133 - ".load"
Cohesion: 0.24
Nodes (5): NodeRow, .body, Error, String, Void
...
Cohesion: 0.07
Nodes (30): BrowserPaneRegistry, BrowserPaneView, .activeTab, .init(url:paneID:), .init(url:paneID:webView:), .webView(_:createWebViewWith:for:windowFeatures:), .webView(_:didCommit:), .webView(_:didFail:withError:) (+22 more)
...
Cohesion: 0.05
Nodes (40): Logger, os, OSSignposter, Phase, daemonConnected, firstDrawablePresented, firstSnapshot, firstSurfaceAttached (+32 more)
...
Cohesion: 0.14
Nodes (12): String, SidebarBadgeLabel, .body, SidebarSessionItemRow, .body, .waitingNotificationText, .body, Bool (+4 more)
...
Cohesion: 0.11
Nodes (16): BranchSwitchHelper, FileTreeNode, FileTreeSwiftUIView, .body, .filteredNodes, .rootPath, .scanOptions, .sessionID (+8 more)

### Community 148 - "TriState"
Cohesion: 0.07
Nodes (21): .init(coder:), BrowserProgressLine, .init(coder:), .init(frame:), .init(coder:), .init(title:isActive:onSelect:onClose:), DesignModeElementInfo, DesignModePopoverViewController (+13 more)
...
Cohesion: 0.07
Nodes (36): a6(), eJ(), EUe(), eYt(), fme(), gC(), gKt(), gUe() (+28 more)
...
Cohesion: 0.12
Nodes (22): ChecksStatus, fail, none, pass, pending, CIRun, GitHubCLIClient, IssueInfo (+14 more)
...
### Community 176 - "Added"
Cohesion: 0.01
Nodes (289): _3n(), _4e(), _4n(), _7n(), _8n(), a7e(), a8n(), a9e() (+281 more)
...
Cohesion: 0.09
Nodes (18): FileHandle, CodingKeys, error, id, jsonrpc, method, params, result (+10 more)
...
Cohesion: 0.08
Nodes (19): BrowserTabButton, SelectAllOnClickTextField, NSEvent, NSStackView, NSTextField, Selector, Kind, primary (+11 more)
...
Cohesion: 0.04
Nodes (50): DecodedImage, .byteCount, UInt8, TerminalColorRole, background, cursor, foreground, palette (+42 more)
...
### Community 215 - ".lines"
Cohesion: 0.03
Nodes (85): a0n(), aA(), abt(), avt(), bI(), c6e(), c6n(), cV() (+77 more)
...
Cohesion: 0.05
Nodes (51): .notchSection, .notifySection, SettingsAppearanceView, .autoTheme, .body, .themeSection, SliderRow, .body (+43 more)
...
Cohesion: 0.08
Nodes (33): a2(), akn(), bEn(), bln(), bwt(), bYe(), cIn(), fun() (+25 more)
...
### Community 298 - "jobs"
Cohesion: 0.06
Nodes (84): Ame(), aQt(), aXt(), AYt(), Cme(), Cqt(), CUe(), cXt() (+76 more)
...
Cohesion: 0.12
Nodes (19): _3e(), aHt(), d2t(), dTn(), ixn(), m1t(), m3e(), np() (+11 more)
...
Cohesion: 0.22
Nodes (10): SettingsAdvancedView, .body, Bool, String, KeyRecorderRepresentable, SettingsKeysView, .body, String (+2 more)

### Community 310 - "FrameSignposter"
Cohesion: 0.22
Nodes (6): .removeWorktreeAction(path:), GitResult, Bool, String, ValidateOutcome, WorktreeEntry
...
Cohesion: 0.07
Nodes (34): AppKit, CoreGraphics, CoreText, KouenCopyMode, KouenTerminalEngine, KouenTerminalKit, KouenTerminalRenderer, KouenTheme (+26 more)
...
Cohesion: 0.14
Nodes (5): GitPanelView, .isHidden, Any, DispatchWorkItem, NSMenuItem
...
Cohesion: 0.18
Nodes (8): .rowList, AgentNotchViewModel, .visibleRows, .waitingCount, Bool, CGFloat, Duration, String
...
Cohesion: 0.11
Nodes (18): InputGate, .siblings, ReconnectLatch, .isTripped, Bool, CGFloat, FormatColor, KouenSettings (+10 more)
...
Cohesion: 0.20
Nodes (11): Notification.Name, NSCoder, NSRect, NSTextView, SyntaxLineNumberGutterView, .init(coder:), .init(frame:), .isFlipped (+3 more)
...
Cohesion: 0.05
Nodes (22): CGImage, ImageIO, TerminalGridCell, ImageLimits, Bool, ImageDecoder, Bool, NSDraggingInfo (+14 more)
...
Cohesion: 0.07
Nodes (23): OverlayBackground, Context, InlineFilePreview, Context, OverlayBackground, Context, .init(frame:), ChromeBackdrop (+15 more)
...
Cohesion: 0.22
Nodes (13): aJ(), bXt(), cJ(), F0(), fXt(), Ime(), mXt(), qXt() (+5 more)
...
Cohesion: 0.10
Nodes (25): ast(), B1(), cle(), D1(), d4n(), dOn(), g3e(), hfn() (+17 more)
...
Cohesion: 0.06
Nodes (20): .event(_:), .interval(_:_:), StaticString, T, .gridOriginPointsX, .gridOriginPointsY, .init(themeName:fontFamily:fontSize:vivid:colorRendering:colorGamut:offMainParserFramePipeline:liveResizeReflow:), .testingPendingResize (+12 more)

### Community 450 - "SessionCoordinator.swift"
Cohesion: 0.08
Nodes (19): Group, ParsedShortcut, .displayString, PrefixCheatsheetWindow, .groups, PrefixIndicatorWindow, PrefixKeymap, Any (+11 more)
...
Cohesion: 0.12
Nodes (14): FlippedView, .isFlipped, .removeWorktreeAction(_:), HunkActionButton, NSButton, NSColor, NSRect, NSScrollView (+6 more)
...
Cohesion: 0.02
Nodes (134): a(), b(), c(), d(), e(), g(), h(), I() (+126 more)

### Community 499 - ".routingRuleList"
Cohesion: 0.05
Nodes (58): _2t(), al(), ayn(), b2t(), bdn(), bIn(), Cp(), d7e() (+50 more)
...
Cohesion: 0.05
Nodes (69): z(), A1(), aw(), awt(), b2(), b2n(), bMt(), bw() (+61 more)
...
Cohesion: 0.10
Nodes (21): SessionDividerRowView, .init(coder:), .init(frame:), SessionGroupHeaderRowView, .init(coder:), .init(frame:), .init(coder:), .init(frame:) (+13 more)
...
Cohesion: 0.08
Nodes (20): Tab, AnyObject, TimeInterval, ZombieHoldRegistry, BrowserIntegrationController, NSView, PaneID, PaneContainerView (+12 more)
...
Cohesion: 0.04
Nodes (28): NSRangePointer, NSEvent, String, Any, NSMenu, NSMenuItem, Any, Bool (+20 more)
...
Cohesion: 0.08
Nodes (22): MainSplitViewController, .setSidebarVisible(_:), .setSidebarVisible(_:animated:), SplitChromeDelegate, .splitView(_:constrainMaxCoordinate:ofSubviewAt:), .splitView(_:constrainMinCoordinate:ofSubviewAt:), .splitView(_:effectiveRect:forDrawnRect:ofDividerAt:), .splitView(_:shouldAdjustSizeOfSubview:) (+14 more)
...
### Community 704 - "oh"
Cohesion: 0.07
Nodes (13): KouenDaemonCore, IPCCodecInvariantTests, RawSocketError, connectFailed, writeFailed, FormatContextDaemonTests, PaneID, String (+5 more)
...
Cohesion: 0.10
Nodes (18): DataBox, .init(coder:), .init(frame:), .init(coder:), .init(title:onClick:), StageToggleButton, .init(coder:), .init(frame:) (+10 more)
...
Cohesion: 0.14
Nodes (13): .exit, String, KouenCLI, SessionID, String, Bool, Int32, String (+5 more)
...
## Knowledge Gaps
- **3515 isolated node(s):** `AppIntents`, `noActivePane`, `.localizedStringResource`, `horizontal`, `vertical` (+3510 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1577 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `code:bash (# Terminal 1: Create workspace with long-running job)` to `Changelog Archive`, `ThemeDocument`, `graphify reference: extra exports and benchmark`, `callingPaneTarget`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `VTParser`, `MetalRendererTests`, `HarnessUILibrary`, `.recordReapedGenerationForTesting`, `HarnessChrome`, `SplitPaneCoordinator`, `.readGrid(scrollbackOffset:)`, `WorktreeManager`, `Harness tmux-style capabilities`, `RGBColor`, `.parse`, `.init`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `.bufferLine`, `MenuTarget`, `.characterIndex`, `Task Ledger Archive (Tasks 1–50)`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `FileTreeKeyboardNavigator`, `.buildCommand`, `.sendInput`, `DaemonServer`, `BrowserResponsePayload`, `.keyEvent`, `HarnessSplitView`, `TabCell`, `KouenOverlayBackground`, `CommandHistorySearchController`, `[1.3.0-vit] - 2026-06-06`, `PasteBufferStore`, `FrecencyDirectoryStore`, `generate-release-notes.swift`, `HarnessCLI+Server.swift`, `Completed Plans Archive`, `.compose`, `worktree_isolation_cli.robot`, `.configureEnvironment`, `.parse`, `Endpoint`, `HarnessDesign`, `.firstMatch`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `GroupedSessionDaemonTests`, `HarnessTerminalSurfaceView`, `TerminalModes`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `WorktreeInfoSummary`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `AnyCodable`, `domain-design.md`, `DamageTrackingTests`, `SoftIconButton`, `code:text (:workbench start swift)`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `SessionGroup`, `graphify reference: query, path, explain`, `WorkspaceFileTreeView`, `one`, `String`, `HistoryRingBuffer`, `GlyphAtlas`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `.startWatching`, `PtyDrainCeilingBenchmark`, `User Story Mapping (MANDATORY)`, `CopyModeGridSource`, `How to use Harness from the terminal only (no GUI)`, `PaneStyleSet`, `AsciiFastPathTests`, `Community None`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `MatchCategory`, `What You Must Do When Invoked`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `ActiveTabCloseDisposition`, `ReplayStep`, `URLDetection`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `.showFind`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `VTConformanceCorpusTests`, `GridCompositorTests`, `P25 — iOS/iPadOS Support`, `LSPServerRegistry`, `SessionSnapshot`, `AppDelegate`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `AsyncCLIResultBox`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `.apply`, `.classify`, `MCP Server (harness-mcp)`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `.testDataFrameEncodeVsJSONBase64Output`, `PaneTarget`, `.apply`, `GridCompositor`, `.selectAdjacentSession`, `ScrollbackFile`, `Prompt`, `TerminalServicesProvider`, `SSHTunnelManagerTests`, `ExternalOpenKind`, `P10 Task: Lazy Scrollback Reflow`, `WorkbenchCommand`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `Experience modes`, `ReflowPreviewTests`, `workspace`, `release-hotfix.sh`, `WindowTitleStripView`, `ThemeFileServiceTests`, `.install`, `HarnessSidebarPanelViewController`, `.path`, `DefaultTerminalManager`, `WindowSession`, `StatusLineView.swift`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `Fixes Applied (layered)`, `GitHubCLIClient`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `.encodeMouse`, `FrameSignposter`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `DesktopNotifier`, `LayoutNode`, `worktree_isolation.robot`, `.theme`, `README.md`, `.drawGlyph`, `ImageProtocolTests.swift`, `CommandExecutionError`, `Foundation`, `Contents.json`, `GPU Animation Pattern — Layout Once, GPU Paints`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.handleCat`, `[3.5.1] - 2026-06-20`, `FormatStyledSegment.swift`, `RGBColor`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `Git Panel`, `SurfaceProgressTrackerTests.swift`, `MCPServer`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `HarnessCLITests`, `PresentAttempt`, `main.swift`, `Fixed`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `markdown.json`, `.refreshSurfaceMetadata`, `rust.json`, `yaml.json`, `FilePreviewCoordinatorTabScopeTests`, `Case: cwd "bleed" — session worktree jumps to wrong dir during builds`, `PathToken`, `.init`, `WaitForRegistry`, `LegacySnapshot`, `GroupedSessionDaemonTests`, `Section`, `Modifiers`, `PresentAttempt`, `TerminalModes`, `.deinit`, `DirectionalAxis`, `ReflowFastPathTests`, `HarnessOnboarding`, `.hitTest`, `.endFind`, `Added`, `ScrollbackTests`, `.resolve`, `ccRunGet`, `Added`, `ccRuns`, `.testProceduralBoxAndBlockCellsDoNotEnterShapedRunCache`, `.json`, `WindowBorderOverlayView`, `.panePathLookup`?**
  _High betweenness centrality (0.230) - this node is a cross-community bridge._
- **Why does `AgentSessionSummary` connect `Terminal AI Chat (⌘I inline overlay)` to `rust.json`, `String`, `ScriptRuntime.swift`, `[3.5.1] - 2026-06-20`, `Changelog`, `MCP Server (harness-mcp)`, `PaneNode`, `Consumers`, `DaemonSubscription`, `Project History`, `LSPDiagnostic`, `PaneNode`, `Community None`, `RemoteHostStore`, `code:bash (# Terminal 1: Create workspace with long-running job)`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `fbt()` connect `XCTestCase` to `Added`, `Changelog`, `CopyModeAction`, `.normalizedKey`?**
