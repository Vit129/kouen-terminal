...
10. `DaemonClient` - bridges 34 areas (176 edges)
...
## Communities (2187 total, 1598 thin omitted)
...
Cohesion: 0.06
Nodes (41): AnyTransition, AgentNotchPeekEvent, AgentNotchRootView, .body, .bottomRadius, .closedAccessibilityLabel, .closedTransition, .closedView (+33 more)
...
Cohesion: 0.12
Nodes (11): .tab(containingPaneID:), .tab(forSurfaceKey:), .tabIndex(surfaceKey:), .tabIndex(workspaceID:tabID:), Bool, Date, SessionID, String (+3 more)

### Community 9 - "TerminalEmulator"
Cohesion: 0.12
Nodes (10): PerformanceBenchmarks, SurfaceMainThreadStallSample, SurfaceOffMainStallSample, Bool, Data, Double, String, UInt64 (+2 more)

### Community 10 - "PerformanceBenchmarks"
Cohesion: 0.08
Nodes (24): IndexingIterator, LayoutTemplate, surfaceID, SessionEditor, .addSurface(tabID:paneID:), .addSurface(to:paneID:surfaceID:cwd:), .split(node:targetPaneID:direction:paneCount:before:), .split(node:targetPaneID:with:direction:beforeTarget:) (+16 more)

### Community 11 - "GitPanelView.swift"
Cohesion: 0.10
Nodes (10): Double, PaneID, SurfaceID, TabID, AgentNotchPresentation, closed, open, peek (+2 more)
...
Cohesion: 0.10
Nodes (21): State, csiEntry, csiIgnore, csiIntermediate, csiParam, escape, escapeIntermediate, ground (+13 more)
...
Cohesion: 0.10
Nodes (24): DaemonSubscription, .start(onData:onEnd:buffered:), Bool, Data, UInt16, UInt64, sysClose(), DaemonClientTests (+16 more)

### Community 19 - "SpecialKey"
Cohesion: 0.09
Nodes (25): CodingKeys, error, id, jsonrpc, method, params, result, LSPDiagnostic (+17 more)
...
Cohesion: 0.05
Nodes (59): aR(), Cjt(), cKt(), copy(), cYt(), dC(), DGt(), dje() (+51 more)

### Community 22 - "CopyModeAction"
Cohesion: 0.01
Nodes (555): _0t(), _1n(), _2t(), _3n(), _5n(), _6e(), _9e(), a2n() (+547 more)
...
Cohesion: 0.10
Nodes (9): DaemonCommandExecutor, Command, string, Bool, Int32, SessionID, String, TabID (+1 more)
...
Cohesion: 0.10
Nodes (7): Bool, String, UInt8, TerminalEmulator, .onSetClipboard, ImageProtocolTests, String

### Community 31 - "Sendable"
Cohesion: 0.12
Nodes (13): AppKit, CommandPromptController, .historyEntries, .historyURL, KeyablePanel, .canBecomeKey, Bool, NSControl (+5 more)
...
Cohesion: 0.15
Nodes (15): BrowserOkAck, ConnectionState, .authorized, .browserPaneID, .deviceID, .snapshotSubscription, .subscription, .surfaceID (+7 more)
...
Cohesion: 0.08
Nodes (32): KouenPaths, ClientRecord, CountBox, DaemonError, alreadyRunning, bindFailed, .description, listenFailed (+24 more)
...
Cohesion: 0.15
Nodes (11): Array, GroupHeaderRow, .body, RecipePanel, .canBecomeKey, RecipePickerController, RecipePickerView, .body (+3 more)
...
Cohesion: 0.10
Nodes (25): LinePos, end, firstNonBlank, start, Bool, CGFloat, Character, NSEvent (+17 more)
...
Cohesion: 0.23
Nodes (6): NSEvent, SpecialKeyMappingTests, Bool, NSEvent, String, UInt16
...
### Community 64 - ".text"
Cohesion: 0.25
Nodes (7): NSHostingView, TerminalTabBarView, .delegate, .init(frame:), .leadingInset, .mouseDownCanMoveWindow, .trailingInset
...
Cohesion: 0.02
Nodes (382): l, V, em(), z(), _4n(), _5e(), _6n(), _7n() (+374 more)
...
Cohesion: 0.06
Nodes (30): CaseIterable, LayoutTemplate, evenHorizontal, evenVertical, mainHorizontal, mainVertical, tiled, ExperienceMode (+22 more)
...
Cohesion: 0.25
Nodes (8): NSColor, NSRect, NSScrollView, NSStackView, NSTextField, WorktreeCardView, NSView, agentInfo
...
Cohesion: 0.08
Nodes (25): Error, ExpressibleByStringLiteral, InstallError, unsupported, StringError, .init(_:), .init(stringLiteral:), LSPClient (+17 more)
...
Cohesion: 0.05
Nodes (29): CornerInfo, EditorDividerView, KouenSplitView, .dividerColor, .dividerThickness, .init(coder:), PaneDragGripView, .init(coder:) (+21 more)
...
Cohesion: 0.08
Nodes (30): ast(), b3e(), c6(), d4n(), g3e(), gce(), _gn(), h7e() (+22 more)
...
Cohesion: 0.05
Nodes (40): NSCursor, TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid (+32 more)
...
Cohesion: 0.11
Nodes (23): .color, TaskSummary.Status, .columnKind, SessionGroup, .sessionBoardStatus, BoardCard, BoardColumn, .name (+15 more)
...
Cohesion: 0.06
Nodes (44): a6(), CWt(), dUe(), eJ(), EUe(), EWt(), eYt(), fme() (+36 more)
...
Cohesion: 0.13
Nodes (15): AgentStatusDot, Context, .init(entry:), .init(coder:), KouenMotion, .init(coder:), .init(coder:), .init(coder:) (+7 more)
...
Cohesion: 0.09
Nodes (23): d9n(), e8n(), evt(), ixn(), j0t(), l1t(), l2(), l7n() (+15 more)
...
Cohesion: 0.10
Nodes (8): KouenCLITests, DetachKeys, absent, invalid, parsed, Bool, String, UInt8
...
Cohesion: 0.19
Nodes (7): AnyView, .rowList, AgentNotchViewModel, Bool, CGFloat, String, Duration
...
### Community 176 - "Added"
Cohesion: 0.03
Nodes (88): a0(), a8n(), ax(), b6n(), bce(), bln(), bwn(), bYe() (+80 more)
...
Cohesion: 0.05
Nodes (19): KouenDaemonCore, DaemonBrowserRoutingTests, IPCCodecInvariantTests, String, URL, ConcurrentIndexSet, .count, EndpointClientTests (+11 more)
...
Cohesion: 0.08
Nodes (19): PluginLoader, String, ScriptConfigLocator, Bool, String, ScriptHookCoordinator, Bool, String (+11 more)
...
Cohesion: 0.08
Nodes (49): a1t(), amn(), cg(), ch(), cvt(), dV(), e9n(), eMt() (+41 more)

### Community 196 - "Feature Provenance — harness-terminal"
Cohesion: 0.08
Nodes (17): .init(frame:), Kind, primary, secondary, KouenPillButton, .init(title:kind:), .isHovered, .isPressed (+9 more)

### Community 197 - "AgentSessionSummary"
Cohesion: 0.13
Nodes (6): FlippedView, .isFlipped, Any, NSMenuItem, NSClickGestureRecognizer, NSUserInterfaceItemIdentifier
...
Cohesion: 0.07
Nodes (38): Equatable, DecodedImage, .byteCount, UInt8, KouenGridTerminal, String, BlockSelection, CursorRender (+30 more)
...
Cohesion: 0.12
Nodes (18): CommandPaletteController, PaletteAction, PaletteCommandConfig, PaletteFileEntry, PaletteGrepMatch, PaletteModel, PaletteRow, header (+10 more)
...
### Community 215 - ".lines"
Cohesion: 0.04
Nodes (58): _8n(), a0n(), aA(), bX(), cce(), d0t(), dbt(), dhn() (+50 more)
...
Cohesion: 0.03
Nodes (212): a(), b(), c(), d(), e(), f(), g(), h() (+204 more)
...
Cohesion: 0.09
Nodes (16): SettingsHostingController, .init(coder:), .init(page:), SettingsWindowController, NSCoder, NSWindow, Page, advanced (+8 more)
...
Cohesion: 0.08
Nodes (19): UnsafeBufferPointer, .captureLines(fromLine:toLine:), .captureLines(joinWrapped:), .feed(_:), Bool, Data, String, UInt8 (+11 more)
...
Cohesion: 0.08
Nodes (18): os, DaemonClientActor, TimeInterval, DaemonSessionError, daemonError, .description, unexpectedResponse, DaemonSessionService (+10 more)

### Community 245 - "ThemeDocumentTests"
Cohesion: 0.14
Nodes (14): aJ(), bvt(), hyn(), Ime(), m2t(), QBt(), sO(), sPt() (+6 more)
...
Cohesion: 0.03
Nodes (61): _3e(), _4e(), ag(), bj(), bP(), d2t(), d8n(), d9e() (+53 more)
...
Cohesion: 0.05
Nodes (52): aae(), ake(), ate(), b6(), cvn(), eL(), eoe(), f8n() (+44 more)
...
Cohesion: 0.06
Nodes (42): SettingsAppearanceView, .autoTheme, .body, .themeSection, SliderRow, .body, .displayValue, Bool (+34 more)
...
Cohesion: 0.08
Nodes (26): BrowserPaneView, .init(coder:), BrowserProgressLine, .init(coder:), .init(frame:), BrowserTabButton, .init(coder:), .init(title:isActive:onSelect:onClose:) (+18 more)
...
Cohesion: 0.05
Nodes (72): a2(), a7e(), akn(), al(), b1t(), b9n(), bdn(), bIn() (+64 more)

### Community 286 - "code:bash (harness-cli install-hooks hermes)"
Cohesion: 0.10
Nodes (22): MarkdownPreviewView, .acceptsFirstResponder, .init(coder:), .init(frame:), .isAppearanceDark, .webView(_:decidePolicyFor:decisionHandler:), .webView(_:didFinish:), Any (+14 more)
...
### Community 298 - "jobs"
Cohesion: 0.09
Nodes (58): Ame(), aQt(), AYt(), cJ(), Cme(), CUe(), cXt(), dXt() (+50 more)
...
Cohesion: 0.28
Nodes (6): statusHelp(), SplitDirection, String, TabID, .body, TerminalTabBarDelegate
...
Cohesion: 0.12
Nodes (9): ScriptAPI, Foundation, JavaScriptCore, KouenCore, Mode, compatible, kouen, TerminalIdentity (+1 more)
...
Cohesion: 0.10
Nodes (20): KouenCopyMode, KouenTerminalEngine, KouenTerminalRenderer, KouenTheme, Metal, ImmersiveEffects, CALayer, .currentRawSelection (+12 more)
...
Cohesion: 0.12
Nodes (12): FileViewerViewController, .acceptsFirstResponder, Any, Bool, NSEvent, Set, String, URL (+4 more)
...
Cohesion: 0.04
Nodes (59): A1(), aAn(), aat(), AS(), bhn(), bw(), bwt(), cc() (+51 more)
...
Cohesion: 0.09
Nodes (14): DaemonReconnectPolicy, DetachedPaneOverlay, .init(coder:), .init(frame:style:), Style, detached, reconnectingChip, NSCoder (+6 more)

### Community 366 - "Consumers"
Cohesion: 0.09
Nodes (23): .onSelect, agentDetail(), AgentInboxBody, .body, .needsAttentionCount, AgentInboxPanelView, .init(agents:onSelect:), .init(coder:) (+15 more)
...
### Community 368 - "Tab"
Cohesion: 0.14
Nodes (15): .body, .mcpButton, ConfigError, .errorDescription, unsupportedAgent, writeFailure, MCPConfigWriter, Any (+7 more)
...
Cohesion: 0.18
Nodes (4): SessionID, KouenCommands, KouenIPC, GitPanelViewWorktreeTaskTests
...
Cohesion: 0.09
Nodes (16): SurfaceRegistry, Set, FormatContextDaemonTests, PaneID, String, SurfaceID, URL, SurfaceRegistryTests (+8 more)
...
### Community 402 - "View"
Cohesion: 0.07
Nodes (40): Configuration, TabBarIconButtonStyle, TabBarInlineIconButtonStyle, ButtonStyle, CommandRow, .body, GlassCard, .body (+32 more)
...
Cohesion: 0.06
Nodes (18): TerminalGridCell, Data, Bool, NSDraggingInfo, NSDragOperation, NSPasteboard, String, TerminalGridCell (+10 more)

### Community 409 - "Session/Tab/Pane Hierarchy & Top Bar (CASE-028)"
Cohesion: 0.20
Nodes (13): CustomStringConvertible, atomicWrite(), backupCorruptFile(), fnv1aHex(), KouenPathsError, .description, socketPathTooLong, Bool (+5 more)
...
Cohesion: 0.06
Nodes (36): AgentChipView, .init(coder:), .intrinsicContentSize, ChromeRole, sidebar, tabBar, Collection, .aggregateBoardStatus (+28 more)
...
Cohesion: 0.12
Nodes (15): .activeTab, .init(url:paneID:), .init(url:paneID:webView:), .webView(_:createWebViewWith:for:windowFeatures:), .webView(_:didFinish:), BrowserTab, URL, UUID (+7 more)
...
Cohesion: 0.10
Nodes (27): aXt(), bXt(), Cqt(), Eme(), gXt(), GYt(), H7(), hqt() (+19 more)
...
Cohesion: 0.05
Nodes (36): o, a9e(), AI(), avn(), aXe(), bee(), cy(), d8e() (+28 more)
...
Cohesion: 0.29
Nodes (7): PaletteItemRow, .body, PalettePanel, .canBecomeKey, AttributedString, Bool, NSColor
...
Cohesion: 0.24
Nodes (6): FBe(), Gbe(), handler(), M9(), mUt(), _Q()
...
Cohesion: 0.09
Nodes (16): Tab, AnyObject, TimeInterval, ZombieHoldRegistry, BrowserIntegrationController, NSView, PaneID, HitTestPassthroughView (+8 more)
...
Cohesion: 0.08
Nodes (28): eGt(), en(), fwn(), gk(), GOt(), hhn(), HUe(), Ije() (+20 more)
...
Cohesion: 0.10
Nodes (17): OverlayBackground, Context, OverlayBackground, Context, ChromeBackdrop, .init(role:), KouenDesign, KouenOverlayBackground (+9 more)
...
### Community 579 - "AutomationScheduler"
Cohesion: 0.50
...
Cohesion: 0.03
Nodes (38): NSRangePointer, Bool, CAMetalDrawable, NSEvent, String, Any, NSMenu, NSMenuItem (+30 more)
...
Cohesion: 0.13
Nodes (15): .exit, String, String, KouenCLI, SessionID, String, Bool, Int32 (+7 more)
...
Cohesion: 0.08
Nodes (21): PtyError, launchFailed, RealPty, .init(forTesting:), .init(id:cwd:shell:rows:cols:scrollbackBytes:extraEnvironment:termProgram:termProgramVersion:scrollbackURL:), ScrollbackEntry, ScrollbackReplaySegment, Bool (+13 more)
...
## Knowledge Gaps
- **3494 isolated node(s):** `AppIntents`, `noActivePane`, `.localizedStringResource`, `horizontal`, `vertical` (+3489 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1598 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `code:text (:workbench start swift)` to `Changelog Archive`, `callingPaneTarget`, `graphify reference: extra exports and benchmark`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `RealPtyLifecycleTests`, `VTParser`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `.recordReapedGenerationForTesting`, `SpecialKey`, `HarnessChrome`, `SplitPaneCoordinator`, `.request`, `WorktreeManager`, `Harness tmux-style capabilities`, `SessionGroupHeaderRowView`, `TransportError`, `.init`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `.bufferLine`, `.characterIndex`, `MenuTarget`, `Task Ledger Archive (Tasks 1–50)`, `TerminalColorGamut`, `CodingKeys`, `FileTreeKeyboardNavigator`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `harness.resource`, `.buildCommand`, `.normalizedKey`, `DaemonServer`, `.keyEvent`, `HarnessSplitView`, `TabCell`, `CommandHistorySearchController`, `.withinPixelCap`, `PasteBufferStore`, `FrecencyDirectoryStore`, `HarnessCLI+Server.swift`, `E9`, `worktree_isolation_cli.robot`, `.parse`, `Endpoint`, `HarnessDesign`, `.firstMatch`, `LSPDiagnostic`, `TerminalGridCell`, `HarnessPaths`, `AgentRoutingRuleSummary`, `HarnessTerminalSurfaceView`, `.tomlKouenBlock`, `TerminalModes`, `P2 — Async IPC Refactor: Design Document`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `.dispatch`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `AnyCodable`, `AgentNotchViewModel`, `DamageTrackingTests`, `SoftIconButton`, `[1.3.0-vit] - 2026-06-06`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `WorkspaceFileTreeView`, `ViEngine`, `String`, `HistoryRingBuffer`, `GlyphAtlas`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `PtyDrainCeilingBenchmark`, `.readGrid(scrollbackOffset:)`, `User Story Mapping (MANDATORY)`, `RGBColor`, `CopyModeGridSource`, `How to use Harness from the terminal only (no GUI)`, `PaneStyleSet`, `AsciiFastPathTests`, `Community None`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `Harness Terminal — IDE Sidebar Feature Branch`, `MatchCategory`, `What You Must Do When Invoked`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `AgentTableEntry`, `URLDetection`, `.makeDiffScrollView`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `P25 — iOS/iPadOS Support`, `LSPServerRegistry`, `SessionSnapshot`, `AppDelegate`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `.apply`, `AgentSessionSummary`, `.classify`, `MCP Server (harness-mcp)`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `PaneTarget`, `GridCompositor`, `Prompt`, `TerminalServicesProvider`, `ExternalOpenKind`, `P10 Task: Lazy Scrollback Reflow`, `WorkbenchCommand`, `.make`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `ReflowPreviewTests`, `SessionCoordinator`, `BoardViewController`, `workspace`, `release-hotfix.sh`, `WindowTitleStripView`, `.install`, `HarnessSidebarPanelViewController`, `.path`, `DefaultTerminalManager`, `WindowSession`, `StatusLineView.swift`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `.run`, `BlockTintOverlay`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `JSONDecoder`, `Fixes Applied (layered)`, `GitHubCLIClient`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `ViPathTokenTests`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `DesktopNotifier`, `LayoutNode`, `.theme`, `README.md`, `.drawGlyph`, `CommandExecutionError`, `Foundation`, `FileViewerViewController`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.handleCat`, `FormatStyledSegment.swift`, `[2.2.4] - 2026-06-11`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `Tab`, `P13 — Embedded Browser Pane (cmux parity)`, `SurfaceProgressTrackerTests.swift`, `PromptQueue`, `NSTextField Leak in BoardViewController (P20 Performance)`, `Darwin`, `HarnessCLITests`, `.load`, `Split Panes (NSSplitView)`, `main.swift`, `Fixed`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `json.json`, `markdown.json`, `.refreshSurfaceMetadata`, `rust.json`, `yaml.json`, `Case: cwd "bleed" — session worktree jumps to wrong dir during builds`, `PathToken`, `Project History`, `.init`, `SessionEditor`, `LegacySnapshot`, `GroupedSessionDaemonTests`, `main.swift`, `Modifiers`, `PresentAttempt`, `ComposerPanel`, `TerminalModes`, `.deinit`, `HarnessOnboarding`, `.hitTest`, `.steps`, `.endFind`, `Added`, `ScrollbackTests`, `.resolve`, `ccRunGet`, `Added`, `ccRunStart`, `.json`, `WindowBorderOverlayView`, `PromptQueue`, `.panePathLookup`?**
  _High betweenness centrality (0.252) - this node is a cross-community bridge._
- **Why does `AgentSessionSummary` connect `Terminal AI Chat (⌘I inline overlay)` to `code:block1 (SessionCoordinator.snapshot ──┐)`, `Equatable`, `rust.json`, `AgentHookInstaller`, `AgentTableEntry`, `Changelog`, `MCP Server (harness-mcp)`, `PaneNode`, `Consumers`, `code:text (:workbench start swift)`, `Tab`, `DaemonSubscription`, `SplitPaneCoordinator`, `PaneNode`, `SessionCoordinator`, `Community None`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `fbt()` connect `XCTestCase` to `Changelog`, `SSHTunnelManagerTests`, `code:bash (# Terminal 1: Create workspace with long-running job)`, `CopyModeAction`?**
