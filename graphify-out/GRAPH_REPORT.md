...
## Communities (2106 total, 1481 thin omitted)
...
Cohesion: 0.20
Nodes (5): TerminalDamage, RenderColor, MetalRendererTests, MTLTexture, UInt
...
Cohesion: 0.09
Nodes (15): ConcurrentIndexSet, .count, DaemonContentionTests, SubscriptionBox, .count, String, URL, DaemonRoundTripTests (+7 more)
...
### Community 7 - "Command"
Cohesion: 0.09
Nodes (30): AppEnum, AppIntent, AppIntents, GetTerminalOutputIntent, KouenIntentError, .localizedStringResource, noActivePane, KouenShortcutsProvider (+22 more)

### Community 8 - "LSPMessage"
Cohesion: 0.13
Nodes (15): IndexingIterator, LayoutTemplate, surfaceID, .addSurface(to:paneID:surfaceID:cwd:), .split(node:targetPaneID:direction:paneCount:before:), .split(node:targetPaneID:with:direction:beforeTarget:), .surfaceID(forPaneID:in:), .tabIndex(surfaceID:) (+7 more)
...
Cohesion: 0.12
Nodes (13): .addSurface(tabID:paneID:), .tab(containingPaneID:), .tab(forSurfaceKey:), .tabIndex(surfaceKey:), .tabIndex(workspaceID:tabID:), Bool, Date, SessionID (+5 more)
...
Cohesion: 0.10
Nodes (27): DaemonSubscription, .start(onData:onEnd:buffered:), Bool, UInt64, makeUnixStreamSocket(), setNoSigPipe(), Int32, UnsafeMutableRawPointer (+19 more)
...
Cohesion: 0.09
Nodes (29): aHt(), aVe(), bme(), bYt(), cVe(), fqt(), hVe(), Iin() (+21 more)

### Community 22 - "CopyModeAction"
Cohesion: 0.01
Nodes (611): _0t(), _1n(), _2t(), _3e(), _3n(), _4e(), _5n(), _6e() (+603 more)
...
Cohesion: 0.11
Nodes (30): aJ(), bXt(), cJ(), dXt(), F0(), fXt(), HUe(), Ime() (+22 more)
...
Cohesion: 0.12
Nodes (13): FlippedView, .isFlipped, NSButton, NSColor, NSRect, NSScrollView, NSStackView, NSTextField (+5 more)
...
### Community 28 - ".parse"
Cohesion: 0.02
Nodes (365): pe(), r, X(), A(), code(), R(), a(), aDt() (+357 more)
...
Cohesion: 0.06
Nodes (36): _5e(), _8n(), bd(), cae(), cmn(), d_n(), e2t(), e3n() (+28 more)
...
Cohesion: 0.10
Nodes (18): BranchSwitchHelper, FileTreeNode, FileTreeSwiftUIView, .body, .filteredNodes, .rootPath, .sessionID, .taskID (+10 more)
...
Cohesion: 0.04
Nodes (62): a4e(), ast(), B1(), c8e(), c_n(), Cf(), cle(), D1() (+54 more)
...
Cohesion: 0.06
Nodes (38): TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid, String (+30 more)
...
### Community 64 - ".text"
Cohesion: 0.13
Nodes (9): TerminalGridCell, String, TerminalGridCell, PasteController, Bool, NSPasteboard, String, TimeInterval (+1 more)
...
Cohesion: 0.09
Nodes (6): String, UInt8, TerminalEmulator, .captureLines(fromLine:toLine:), ImageProtocolTests, String
...
Cohesion: 0.02
Nodes (198): l, _6n(), a0(), a5n(), a7e(), abt(), adn(), ah() (+190 more)
...
Cohesion: 0.09
Nodes (10): .receive(_:), FluidityBenchmarks, NSWindow, String, UInt64, KouenTerminalSurfaceWorkerTests, LiveResizeTests, NSWindow (+2 more)
...
Cohesion: 0.04
Nodes (66): a0n(), aA(), avt(), d9e(), dbt(), dl(), dyn(), e9n() (+58 more)
...
Cohesion: 0.14
Nodes (14): Equatable, LSPDiagnostic, LSPDiagnosticSeverity, error, hint, information, warning, LSPHover (+6 more)
...
Cohesion: 0.13
Nodes (18): CUe(), cXt(), Eme(), GYt(), H7(), IYt(), kCn(), kUe() (+10 more)
...
Cohesion: 0.08
Nodes (15): Int, SemanticMark, HistoryLine, ImagePlacement, Pen, RewrapResult, SavedCursor, Bool (+7 more)
...
Cohesion: 0.07
Nodes (25): Notification.Name, Logger, os, OSSignposter, DaemonSessionError, .description, unexpectedResponse, LatencyMonitor (+17 more)
...
Cohesion: 0.09
Nodes (18): Selector, Kind, primary, secondary, KouenDesign, KouenPillButton, .init(title:kind:), .isHovered (+10 more)
...
Cohesion: 0.11
Nodes (12): GitPanelView, .isHidden, .removeWorktreeAction(_:), .removeWorktreeAction(path:), GitResult, Bool, DispatchWorkItem, String (+4 more)
...
Cohesion: 0.07
Nodes (17): LinePos, end, firstNonBlank, start, ViDiagnosticNavigator, ViMode, insert, normal (+9 more)
...
Cohesion: 0.07
Nodes (21): EditorDividerView, HitTestPassthroughView, .init(coder:), .init(node:cwd:themeName:existingHosts:existingBrowserPanes:), PaneDragGripView, .init(coder:), .init(paneID:), PaneHoverButton (+13 more)
...
Cohesion: 0.11
Nodes (15): AppKit, AboutPanelController, AboutView, .body, MonoPillButtonStyle, Configuration, NSWindow, GlassEffectView (+7 more)
...
Cohesion: 0.08
Nodes (26): GitDiffGutter, String, DiffLineType, added, deleted, modified, Notification.Name, Bool (+18 more)
...
Cohesion: 0.10
Nodes (20): AgentSessionHistoryModel, .filteredRecords, .hasMoreToLoad, .minimumWindowStart, .searchQuery, .selectedScope, .windowedRecords, AgentSessionHistoryView (+12 more)

### Community 245 - "ThemeDocumentTests"
Cohesion: 0.16
Nodes (24): Ame(), aUe(), aze(), Cqt(), eXt(), gXt(), hqt(), HYt() (+16 more)
...
Cohesion: 0.01
Nodes (400): V, em(), _4n(), _7n(), a1t(), a2(), a8n(), a9n() (+392 more)
...
Cohesion: 0.07
Nodes (38): CustomStringConvertible, Darwin, Foundation, Glibc, KouenCore, DaemonClientError, connectionFailed, .description (+30 more)
...
Cohesion: 0.08
Nodes (14): pipe, PaneBorderStatus, Bool, Command, DispatchWorkItem, PaneID, PaneLeaf, PaneNode (+6 more)
...
Cohesion: 0.06
Nodes (47): Ac(), al(), ayn(), bdn(), bIn(), cht(), Cp(), d7e() (+39 more)
...
Cohesion: 0.06
Nodes (13): workspaceNotFound, SessionCoordinator, .selectWorkspace(_:), Bool, Double, PaneID, PaneNode, SplitDirection (+5 more)
...
### Community 301 - ".parse"
Cohesion: 0.16
Nodes (13): .groupedRecords, .body, Group, ParsedShortcut, .displayString, PrefixCheatsheetWindow, .groups, PrefixIndicatorWindow (+5 more)
...
Cohesion: 0.06
Nodes (27): o, a9e(), aXe(), bee(), Da(), dH(), eie(), eZ() (+19 more)
...
Cohesion: 0.22
Nodes (6): RenderedFixture, Bool, StaticString, String, TerminalGridSnapshot, UInt8
...
Cohesion: 0.10
Nodes (23): CoreGraphics, CoreText, ImageIO, KouenCopyMode, KouenTerminalEngine, KouenTerminalRenderer, KouenTheme, Metal (+15 more)
...
### Community 360 - "State"
Cohesion: 0.08
Nodes (30): A1(), aat(), bEn(), bln(), bw(), bwt(), c5n(), d6() (+22 more)
...
Cohesion: 0.11
Nodes (27): aQt(), aXt(), AYt(), Cme(), DYt(), een(), eVe(), hXt() (+19 more)
...
Cohesion: 0.11
Nodes (9): NSEvent, NSPopover, .lspPosition(for:), .onCurrentCWD, .onCurrentFile, Bool, NSString, NSTextView (+1 more)
...
### Community 402 - "View"
Cohesion: 0.06
Nodes (39): ButtonStyle, CommandRow, .body, GlassCard, .body, GlassPrimaryButtonStyle, GlassSecondaryButtonStyle, GlassStatusButtonStyle (+31 more)
...
Cohesion: 0.15
Nodes (11): .encode(_:modifiers:event:modes:), MouseButton, left, middle, right, wheelDown, wheelLeft, wheelRight (+3 more)
...
### Community 435 - ".init"
Cohesion: 0.16
Nodes (12): a6(), dme(), h2(), N$e(), pme(), pR(), QHe(), VWt() (+4 more)
...
Cohesion: 0.22
Nodes (5): UnsafeBufferPointer, TerminalCellWidth, UnsafeBufferPointer, .cursorVisible, UInt32
...
Cohesion: 0.07
Nodes (21): TerminalColorRole, background, cursor, foreground, palette, .event(_:), .interval(_:_:), StaticString (+13 more)
...
Cohesion: 0.10
Nodes (21): AgentRow, .agentColor, .executables, .hookButton, .hookButtonTitle, HookState, failed, idle (+13 more)

### Community 454 - ".recordReapedGenerationForTesting"
Cohesion: 0.14
Nodes (23): ch(), cvt(), dV(), e0n(), ew(), ik(), iPt(), kb() (+15 more)
...
Cohesion: 0.16
Nodes (8): .start(onResponse:onEnd:), Int32, TimeInterval, UUID, Void, .onResponse, AtomicCounter, .value
...
Cohesion: 0.21
Nodes (12): dhn(), fhn(), ghn(), iXt(), jUe(), jXt(), kr(), Mme() (+4 more)
...
Cohesion: 0.05
Nodes (40): .init(entry:), AgentChipView, .intrinsicContentSize, ChromeRole, sidebar, tabBar, FontSize, IconSize (+32 more)
...
Cohesion: 0.08
Nodes (26): OverlayBackground, Context, OverlayBackground, Context, .init(coder:), .init(frame:), ChromeBackdrop, .init(coder:) (+18 more)
...
Cohesion: 0.22
Nodes (10): b5e(), d9n(), ixn(), jpt(), lw(), np(), ob(), oxn() (+2 more)
...
Cohesion: 0.03
Nodes (37): NSCursor, NSRangePointer, NSEvent, String, Any, NSDraggingInfo, NSDragOperation, NSMenu (+29 more)
...
Cohesion: 0.10
Nodes (15): Tab, AnyObject, TimeInterval, ZombieHoldRegistry, PaneContainerView, SurfaceID, PaneLifecycleManager, Bool (+7 more)
...
### Community 782 - "qk"
Cohesion: 0.02
Nodes (247): a(), b(), c(), d(), e(), f(), g(), h() (+239 more)
...
- **1481 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
